// ════════════════════════════════════════════════════════════════════════════
// DRAFT v2 — P+63 · All Saints of Russia (Russian-usage OPTION on the 2nd
// Sunday after Pentecost). Marker convention applied: St. Sergius * / ** were
// normalized at encode to OCA | (line end) and // (penultimate). [brackets]
// reserved for director emphasis (none present in 100.pdf). Single marked
// string is the source of truth; strip-at-render for forward-facing text.
// Source: 100.pdf. Schema mirrors P+56. For review; not integrated/pushed.
// Canon troparia + Ikos + readings are markerless in 100.pdf (Tier-1 plain).
// ════════════════════════════════════════════════════════════════════════════
