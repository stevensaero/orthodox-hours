...
export default [
  ...
  // ── tone-4 pairs (differential-scan session, byte-verified July 7 2026) ────
  { a: 'tone4.nocturns.canon.odes.1.irmos', b: 'tone4.matins.canon.odes.1.irmos',
    relation: 'identical', note: 'Tone-4 Nocturns shares Odes 1/7/8 irmoi with the Matins Resurrection canon (tone 2: 1/6; tone 3: 1/3/9 — the sharing PATTERN is per-tone).' },
  { a: 'tone4.nocturns.canon.odes.7.irmos', b: 'tone4.matins.canon.odes.7.irmos',
    relation: 'identical', note: 'See odes.1 entry.' },
  { a: 'tone4.nocturns.canon.odes.8.irmos', b: 'tone4.matins.canon.odes.8.irmos',
    relation: 'identical', note: 'See odes.1 entry.' },
  { a: 'tone4.little_vespers.lic[0]', b: 'tone4.little_vespers.lic[1]',
    relation: 'identical', note: 'LV sticheron 1 printed IN FULL twice under verses 1 and 2 (§9.4 full-double-print device) — tone 2 had this, tone 3 did NOT; per-tone device fact.' },
  { a: 'tone4.compline.tue.canon.odes.3.irmos', b: 'tone4.matins_weekday.fri.canons[0].odes.3.irmos',
    relation: 'identical', note: '"O Theotokos, thou living and plentiful fount" irmos re-rendered byte-identically at the 4-4 Tue-night Compline and 4-6 Friday Matins prints — INCLUDING the "crowns of glory.." doubled period at both sites (the "O Christ,?" true-dup class; both sic-registered).' },
  { a: 'tone4.vespers_weekday.sun.aposticha_theotokion', b: 'theotokia.doxasticon_theotokia.4.sun_eve_aposticha',
    relation: 'variant', note: 'CROSS-CORPUS: the tone-IV Sun-eve aposticha theotokion ("Rejoice, O cloud of Light!") prints in 4-2 with "bridal-chamber" where Theotokia.pdf prints "bridalchamber" — wording and pointing otherwise agree; glyph/hyphen variance across files per the cont.-4 ruling.' },
  { a: 'tone4.vespers_weekday.fri.aposticha.verses[0]', b: 'shared.weekday_aposticha_verses.sets.departed_vespers[0]',
    relation: 'variant', note: '§5 divergence: final period present in 4-7, absent in 2-7 — the SAME divergence class as 3-7 (third tone, third print of the pair).' },
  { a: 'tone4.matins_weekday.sat.aposticha.verses[0]', b: 'shared.weekday_aposticha_verses.sets.departed_matins_saturday[0]',
    relation: 'variant', note: '§5 divergence: "they" (4-7) vs "those" (2-7), pointed, final period.' },
  { a: 'tone4.matins_weekday.sat.aposticha.verses[1]', b: 'shared.weekday_aposticha_verses.sets.departed_matins_saturday[1]',
    relation: 'identical', note: 'Bytes MATCH shared — stored per-tone only because the tone-4 print carries a TWO-verse set where 2-7/3-7 print three (§5 structural per-tone set).' },
  { a: 'tone4.liturgy_weekday.thu.prokeimenon.verse', b: 'shared.daily_liturgy_propers.thu.prokeimenon.verse',
    relation: 'variant', note: '§5 divergence: the 4-5 verse prints a * pointing mark absent from the 2-5/shared print.' },
  { a: 'tone4.liturgy_weekday.fri.alleluia.verses[0]', b: 'shared.daily_liturgy_propers.fri.alleluia.verses[0]',
    relation: 'variant', note: '§5 divergence: "ages," (4-6) vs "ages;" (2-6) — the SAME site and class as the 3-6 divergence.' },
  { a: 'tone4.matins_weekday.sat.sessionals[1].verses[0]', b: 'shared.daily_liturgy_propers.sat.alleluia.verses[0]',
    relation: 'variant', note: '"Many are the tribulations" prints POINTED as a 4-7 Saturday Matins sessional verse, UNPOINTED as the Saturday Liturgy Alleluia verse (shared/2-7) — per-tone kathisma sessional verses (§9.9) recombining with the day cycle.' },
  { a: 'tone4.matins_weekday.sat.sessionals[1].verses[1]', b: 'shared.daily_liturgy_propers.sat.alleluia.verses[1]',
    relation: 'variant', note: '"Blessed are they whom Thou hast chosen" prints WITHOUT the "Their memorial" sentence at the 4-7 sessional site; the Liturgy print carries both sentences.' },
  { a: 'tone4.nocturns.gregory_rubric.stanzas[0]', b: 'shared.gregory_sinaite_hymn.stanzas[0]',
    relation: 'identical', note: 'Byte-verified identical to the shared table; stored per-tone because stanza 1 diverges (§5 whole-print-site rule).' },
  { a: 'tone4.nocturns.gregory_rubric.stanzas[1]', b: 'shared.gregory_sinaite_hymn.stanzas[1]',
    relation: 'variant', note: 'stanzas[1] (print stanza 2) word-order divergence: "the one Might in three Hypostases, the Sovereignty" (4-1) vs "the Might in three Hypostases, the one Sovereignty" (shared/2-1) — the §5 falsifier that moved the whole tone-4 hymn per-tone. 3-1 prints the SAME variant (two tones against the 2-1 reading; tone3.js retro-fixed per the July 8 2026 ruling: per-tone everywhere).' },
  { a: 'tone4.nocturns.gregory_rubric.stanzas[2]', b: 'shared.gregory_sinaite_hymn.stanzas[2]',
    relation: 'identical', note: 'Byte-verified identical to the shared table; stored per-tone because stanza 1 diverges (§5 whole-print-site rule).' },
  { a: 'tone4.nocturns.gregory_rubric.stanzas[3]', b: 'shared.gregory_sinaite_hymn.stanzas[3]',
    relation: 'identical', note: 'Byte-verified identical to the shared table; stored per-tone because stanza 1 diverges (§5 whole-print-site rule).' },
  { a: 'tone4.nocturns.gregory_rubric.stanzas[4]', b: 'shared.gregory_sinaite_hymn.stanzas[4]',
    relation: 'identical', note: 'Byte-verified identical to the shared table; stored per-tone because stanza 1 diverges (§5 whole-print-site rule).' },
  { a: 'tone4.nocturns.gregory_rubric.stanzas[5]', b: 'shared.gregory_sinaite_hymn.stanzas[5]',
    relation: 'identical', note: 'Byte-verified identical to the shared table; stored per-tone because stanza 1 diverges (§5 whole-print-site rule).' },
  { a: 'tone4.nocturns.gregory_rubric.stanzas[6]', b: 'shared.gregory_sinaite_hymn.stanzas[6]',
    relation: 'identical', note: 'Byte-verified identical to the shared table; stored per-tone because stanza 1 diverges (§5 whole-print-site rule).' },

  // ── tone-5 pairs (differential-scan session, byte-verified July 8 2026) ────
  { a: 'tone5.nocturns.canon.odes.1.irmos', b: 'tone5.matins.canon.odes.1.irmos',
    relation: 'identical', note: 'Tone-5 Nocturns shares ALL EIGHT ode irmoi with the Matins Resurrection canon (tone 2: 1/6; tone 3: 1/3/9; tone 4: 1/7/8 — fourth distinct per-tone pattern).' },
  { a: 'tone5.nocturns.canon.odes.3.irmos', b: 'tone5.matins.canon.odes.3.irmos',
    relation: 'identical', note: 'See odes.1 entry.' },
  { a: 'tone5.nocturns.canon.odes.4.irmos', b: 'tone5.matins.canon.odes.4.irmos',
    relation: 'identical', note: 'See odes.1 entry.' },
  { a: 'tone5.nocturns.canon.odes.5.irmos', b: 'tone5.matins.canon.odes.5.irmos',
    relation: 'identical', note: 'See odes.1 entry.' },
  { a: 'tone5.nocturns.canon.odes.6.irmos', b: 'tone5.matins.canon.odes.6.irmos',
    relation: 'identical', note: 'See odes.1 entry.' },
  { a: 'tone5.nocturns.canon.odes.7.irmos', b: 'tone5.matins.canon.odes.7.irmos',
    relation: 'identical', note: 'See odes.1 entry.' },
  { a: 'tone5.nocturns.canon.odes.8.irmos', b: 'tone5.matins.canon.odes.8.irmos',
    relation: 'identical', note: 'See odes.1 entry.' },
  { a: 'tone5.nocturns.canon.odes.9.irmos', b: 'tone5.matins.canon.odes.9.irmos',
    relation: 'identical', note: 'See odes.1 entry.' },
  { a: 'tone5.vespers_weekday.fri.aposticha.verses[0]', b: 'shared.weekday_aposticha_verses.sets.departed_vespers[0]',
    relation: 'variant', note: '§5 divergence: final period present in 5-7, absent in 2-7 — THIRD tone with this divergence (3-7, 4-7, 5-7).' },
  { a: 'tone5.liturgy_weekday.thu.prokeimenon.verse', b: 'shared.daily_liturgy_propers.thu.prokeimenon.verse',
    relation: 'variant', note: '§5 divergence: the 5-5 verse prints a * pointing mark absent from the shared print — 4-5 diverged identically.' },
  { a: 'tone5.vespers_weekday.sun.aposticha.verses[0]', b: 'shared.weekday_aposticha_verses.sets.standard_vespers[0]',
    relation: 'variant', note: '§5 divergence: "her mistress" lowercase (5-2) vs "her Mistress" (shared/2-2).' },
  { a: 'tone5.matins_weekday.sat.aposticha.verses[0]', b: 'shared.weekday_aposticha_verses.sets.departed_matins_saturday[0]',
    relation: 'variant', note: '§5 divergence: "they" (5-7) vs "those" (2-7), pointed, final period — the 4-7 pattern.' },
  { a: 'tone5.matins_weekday.sat.aposticha.verses[1]', b: 'shared.weekday_aposticha_verses.sets.departed_matins_saturday[1]',
    relation: 'identical', note: 'Bytes MATCH shared — stored per-tone only because the tone-5 print carries a TWO-verse set (the 4-7 structural pattern).' },
  { a: 'tone5.matins.polyeleos_rubric.verses[0]', b: 'shared.polyeleos.verses[0]',
    relation: 'variant', note: '§5 divergence: the 5-1 Polyeleos prints every select verse WITH a * pointing mark (shared/2-1: unpointed).' },
  { a: 'tone5.matins.polyeleos_rubric.verses[1]', b: 'shared.polyeleos.verses[1]',
    relation: 'variant', note: '§5 divergence: the 5-1 Polyeleos prints every select verse WITH a * pointing mark (shared/2-1: unpointed).' },
  { a: 'tone5.matins.polyeleos_rubric.verses[2]', b: 'shared.polyeleos.verses[2]',
    relation: 'variant', note: '§5 divergence: the 5-1 Polyeleos prints every select verse WITH a * pointing mark (shared/2-1: unpointed).' },
  { a: 'tone5.matins.polyeleos_rubric.verses[3]', b: 'shared.polyeleos.verses[3]',
    relation: 'variant', note: '§5 divergence: the 5-1 Polyeleos prints every select verse WITH a * pointing mark (shared/2-1: unpointed). Verse 4 also reads "God of Heaven" (shared: "of heaven").' },
  { a: 'tone5.great_vespers.vigil_rubric.text', b: 'shared.theotokos_virgin_rejoice.text',
    relation: 'variant', note: '§5 pointing divergence: 5-1 prints a SINGLE * before the final line ("* for thou hast borne") where 2-1 points ** (penultimate marker).' },
  { a: 'tone5.nocturns.gregory_rubric.stanzas[0]', b: 'shared.gregory_sinaite_hymn.stanzas[0]',
    relation: 'identical', note: 'Byte-verified identical to the shared table; stored per-tone per the July 8 2026 Gregory ruling.' },
  { a: 'tone5.nocturns.gregory_rubric.stanzas[1]', b: 'shared.gregory_sinaite_hymn.stanzas[1]',
    relation: 'variant', note: '"in godly manner" (no article) + comma stanza end (5-1) vs shared — NOTE 5-1 sides WITH shared at the stanza-2 "the Might … the one Sovereignty" clause.' },
  { a: 'tone5.nocturns.gregory_rubric.stanzas[2]', b: 'shared.gregory_sinaite_hymn.stanzas[2]',
    relation: 'identical', note: 'Byte-verified identical to the shared table; stored per-tone per the July 8 2026 Gregory ruling.' },
  { a: 'tone5.nocturns.gregory_rubric.stanzas[3]', b: 'shared.gregory_sinaite_hymn.stanzas[3]',
    relation: 'identical', note: 'Byte-verified identical to the shared table; stored per-tone per the July 8 2026 Gregory ruling.' },
  { a: 'tone5.nocturns.gregory_rubric.stanzas[4]', b: 'shared.gregory_sinaite_hymn.stanzas[4]',
    relation: 'identical', note: 'Byte-verified identical to the shared table; stored per-tone per the July 8 2026 Gregory ruling.' },
  { a: 'tone5.nocturns.gregory_rubric.stanzas[5]', b: 'shared.gregory_sinaite_hymn.stanzas[5]',
    relation: 'variant', note: '"unshakable" (5-1) vs "immutable" (shared/2-1).' },
  { a: 'tone5.nocturns.gregory_rubric.stanzas[6]', b: 'shared.gregory_sinaite_hymn.stanzas[6]',
    relation: 'variant', note: '"incarnate from the Virgin" (5-1) vs "of the Virgin" (shared/2-1).' },

  // ── tone-3 Gregory pairs (retro-fix per the July 8 2026 ruling) ────────────
  { a: 'tone3.nocturns.gregory_rubric.stanzas[0]', b: 'shared.gregory_sinaite_hymn.stanzas[0]',
    relation: 'identical', note: 'Byte-verified identical to the shared table; stored per-tone per the July 8 2026 Gregory ruling.' },
  { a: 'tone3.nocturns.gregory_rubric.stanzas[1]', b: 'shared.gregory_sinaite_hymn.stanzas[1]',
    relation: 'variant', note: 'Stanza-2 word order: "the one Might … the Sovereignty" (3-1, the 4-1 variant) vs shared/2-1.' },
  { a: 'tone3.nocturns.gregory_rubric.stanzas[2]', b: 'shared.gregory_sinaite_hymn.stanzas[2]',
    relation: 'identical', note: 'Byte-verified identical to the shared table; stored per-tone per the July 8 2026 Gregory ruling.' },
  { a: 'tone3.nocturns.gregory_rubric.stanzas[3]', b: 'shared.gregory_sinaite_hymn.stanzas[3]',
    relation: 'identical', note: 'Byte-verified identical to the shared table; stored per-tone per the July 8 2026 Gregory ruling.' },
  { a: 'tone3.nocturns.gregory_rubric.stanzas[4]', b: 'shared.gregory_sinaite_hymn.stanzas[4]',
    relation: 'identical', note: 'Byte-verified identical to the shared table; stored per-tone per the July 8 2026 Gregory ruling.' },
  { a: 'tone3.nocturns.gregory_rubric.stanzas[5]', b: 'shared.gregory_sinaite_hymn.stanzas[5]',
    relation: 'identical', note: 'Byte-verified identical to the shared table; stored per-tone per the July 8 2026 Gregory ruling.' },
  { a: 'tone3.nocturns.gregory_rubric.stanzas[6]', b: 'shared.gregory_sinaite_hymn.stanzas[6]',
    relation: 'identical', note: 'Byte-verified identical to the shared table; stored per-tone per the July 8 2026 Gregory ruling.' },
  { a: 'tone5.vespers_weekday.thu.aposticha_theotokion', b: 'tone5.matins_weekday.wed.aposticha_theotokion',
    relation: 'identical', note: 'The "Woe is me, O my Son" stavrotheotokion prints byte-identically at 5-4 Wednesday Matins and 5-6 Thursday-evening Vespers — INCLUDING the straight-doubled quote (\'\'Woe) at both sites (true-dup artifact class; both sic-registered).' },

  // ── tone-6 Gregory pairs (per-tone ruling, from 6-1; §11 tone-6 scan) ──────
  { a: 'tone6.nocturns.gregory_rubric.stanzas[0]', b: 'shared.gregory_sinaite_hymn.stanzas[0]',
    relation: 'identical', note: 'Byte-verified identical to the shared table; stored per-tone per the July 8 2026 Gregory ruling.' },
  { a: 'tone6.nocturns.gregory_rubric.stanzas[1]', b: 'shared.gregory_sinaite_hymn.stanzas[1]',
    relation: 'variant', note: '"in godly manner" (no article) + comma stanza-end (6-1) vs shared — 6-1 sides WITH shared at the stanza-2 "the Might … the one Sovereignty" clause (the 2-1/5-1 word-order side, NOT the 3-1/4-1 side).' },
  { a: 'tone6.nocturns.gregory_rubric.stanzas[2]', b: 'shared.gregory_sinaite_hymn.stanzas[2]',
    relation: 'identical', note: 'Byte-verified identical to the shared table; stored per-tone per the July 8 2026 Gregory ruling.' },
  { a: 'tone6.nocturns.gregory_rubric.stanzas[3]', b: 'shared.gregory_sinaite_hymn.stanzas[3]',
    relation: 'identical', note: 'Byte-verified identical to the shared table; stored per-tone per the July 8 2026 Gregory ruling.' },
  { a: 'tone6.nocturns.gregory_rubric.stanzas[4]', b: 'shared.gregory_sinaite_hymn.stanzas[4]',
    relation: 'identical', note: 'Byte-verified identical to the shared table; stored per-tone per the July 8 2026 Gregory ruling.' },
  { a: 'tone6.nocturns.gregory_rubric.stanzas[5]', b: 'shared.gregory_sinaite_hymn.stanzas[5]',
    relation: 'variant', note: '"unshakable" (6-1) vs "immutable" (shared/2-1).' },
  { a: 'tone6.nocturns.gregory_rubric.stanzas[6]', b: 'shared.gregory_sinaite_hymn.stanzas[6]',
    relation: 'variant', note: '"incarnate from the Virgin" (6-1) vs "of the Virgin" (shared/2-1).' },

  // ── tone-6 §5 per-tone divergence pairs (verify_shared_t6, July 8 2026) ─────
  { a: 'tone6.vespers_weekday.fri.aposticha.verses[0]', b: 'shared.weekday_aposticha_verses.sets.departed_vespers[0]',
    relation: 'variant', note: 'Friday-eve departed verse 1 final period (6-7) vs shared — FOURTH tone running (3-7/4-7/5-7 class).' },
  { a: 'tone6.liturgy_weekday.thu.prokeimenon.verse', b: 'shared.daily_liturgy_propers.thu.prokeimenon.verse',
    relation: 'variant', note: 'Thursday Liturgy prokeimenon verse gains a * (6-5) vs shared — the 4-5/5-5 class.' },
  { a: 'tone6.vespers_weekday.sun.aposticha.verses[0]', b: 'shared.weekday_aposticha_verses.sets.standard_vespers[0]',
    relation: 'variant', note: '"her mistress" lowercase (6-2) vs shared "Mistress" — tone 6 diverges at EVERY weekday evening (tone 5: Sunday only).' },
  { a: 'tone6.vespers_weekday.mon.aposticha.verses[0]', b: 'shared.weekday_aposticha_verses.sets.standard_vespers[0]',
    relation: 'variant', note: '"her mistress" lowercase (6-3) vs shared "Mistress".' },
  { a: 'tone6.vespers_weekday.tue.aposticha.verses[0]', b: 'shared.weekday_aposticha_verses.sets.standard_vespers[0]',
    relation: 'variant', note: '"her mistress" lowercase (6-4) vs shared "Mistress".' },
  { a: 'tone6.vespers_weekday.wed.aposticha.verses[0]', b: 'shared.weekday_aposticha_verses.sets.standard_vespers[0]',
    relation: 'variant', note: '"her mistress" lowercase (6-5) vs shared "Mistress".' },
  { a: 'tone6.vespers_weekday.thu.aposticha.verses[0]', b: 'shared.weekday_aposticha_verses.sets.standard_vespers[0]',
    relation: 'variant', note: '"her mistress" lowercase (6-6) vs shared "Mistress".' },
  { a: 'tone6.matins_weekday.sat.aposticha.verses[0]', b: 'shared.weekday_aposticha_verses.sets.departed_matins_saturday[0]',
    relation: 'variant', note: 'Saturday Matins departed aposticha verse 1 pointed, "they", final period (6-7) — the 4-7/5-7 two-verse pattern.' },
  { a: 'tone6.matins_weekday.sat.aposticha.verses[1]', b: 'shared.weekday_aposticha_verses.sets.departed_matins_saturday[1]',
    relation: 'identical', note: 'Saturday Matins departed aposticha verse 2 byte-matches shared[1]; tone 6 prints only TWO verses (no verse 3) where 2-7/3-7 carry three — the structural per-tone set difference is the MISSING verse, not this one.' },
  { a: 'tone6.matins_weekday.sat.sessionals[1].verses[1]', b: 'shared.daily_liturgy_propers.sat.alleluia.verses[0]',
    relation: 'variant', note: 'Cross-surface: the Saturday Matins sessional verse "Many are the tribulations … * and the Lord" (pointed, "and") vs the Saturday Liturgy Alleluia "but the Lord …" (shared). The Liturgy marker is SHADOWED by this sessional in a flat scan — re-scope with search_after="AT THE LITURGY" (the 4-7 shadowing caution); the Liturgy verse itself byte-matches shared, so its ref stands.' },

  // ── tone-7 Gregory pairs (per-tone ruling, from 7-1; §11 tone-7 scan) ──────
  { a: 'tone7.nocturns.gregory_rubric.stanzas[0]', b: 'shared.gregory_sinaite_hymn.stanzas[0]',
    relation: 'identical', note: 'Byte-verified identical to the shared table; stored per-tone per the July 8 2026 Gregory ruling.' },
  { a: 'tone7.nocturns.gregory_rubric.stanzas[1]', b: 'shared.gregory_sinaite_hymn.stanzas[1]',
    relation: 'variant', note: 'NEW lexical variant: "the one KINGSHIP and Dominion" (7-1) — no prior tone prints "Kingship" (all print "Sovereignty"). Plus "in godly manner" (no article). On the 2-1/5-1 word-order side ("the Might … the one …").' },
  { a: 'tone7.nocturns.gregory_rubric.stanzas[2]', b: 'shared.gregory_sinaite_hymn.stanzas[2]',
    relation: 'identical', note: 'Byte-verified identical to the shared table; stored per-tone per the July 8 2026 Gregory ruling.' },
  { a: 'tone7.nocturns.gregory_rubric.stanzas[3]', b: 'shared.gregory_sinaite_hymn.stanzas[3]',
    relation: 'identical', note: 'Byte-verified identical to the shared table; stored per-tone per the July 8 2026 Gregory ruling.' },
  { a: 'tone7.nocturns.gregory_rubric.stanzas[4]', b: 'shared.gregory_sinaite_hymn.stanzas[4]',
    relation: 'variant', note: '"I worship the beginningless God the Father" word order (7-1) vs shared "I worship God: the beginningless Father".' },
  { a: 'tone7.nocturns.gregory_rubric.stanzas[5]', b: 'shared.gregory_sinaite_hymn.stanzas[5]',
    relation: 'variant', note: '"Thou Creator of all" (7-1) vs shared "Creator of all"; "immutable" matches shared (unlike 5-1/6-1 "unshakable").' },
  { a: 'tone7.nocturns.gregory_rubric.stanzas[6]', b: 'shared.gregory_sinaite_hymn.stanzas[6]',
    relation: 'variant', note: '"Who became ineffably incarnate" word order (7-1) vs shared "Who ineffably became incarnate"; "of the Virgin" matches shared.' },

  // ── tone-7 §5 per-tone divergence pairs (verify_shared_t7) ─────────────────
  { a: 'tone7.matins_weekday.wed.aposticha.verses[0]', b: 'shared.weekday_aposticha_verses.sets.standard_matins[0]',
    relation: 'identical', note: 'Wednesday Matins aposticha verse 1 byte-matches shared; stored with its per-tone verse-2 partner.' },
  { a: 'tone7.matins_weekday.wed.aposticha.verses[1]', b: 'shared.weekday_aposticha_verses.sets.standard_matins[1]',
    relation: 'variant', note: 'Wednesday Matins aposticha verse 2 DROPS the * that shared/2-4 prints ("upon us, yea," for "upon us, * yea,"); §5 per-tone, Wednesday only.' },
  { a: 'tone7.vespers_weekday.fri.aposticha.verses[0]', b: 'shared.weekday_aposticha_verses.sets.departed_vespers[0]',
    relation: 'variant', note: 'Friday-eve departed verse 1 final period (7-7) vs shared — FIFTH tone running (3-7/4-7/5-7/6-7 class).' },
  { a: 'tone7.liturgy_weekday.thu.prokeimenon.verse', b: 'shared.daily_liturgy_propers.thu.prokeimenon.verse',
    relation: 'variant', note: 'Thursday Liturgy prokeimenon verse gains a * (7-5) vs shared — the 4-5/5-5/6-5 class.' },
  { a: 'tone7.liturgy_weekday.tue.prokeimenon.verse', b: 'shared.daily_liturgy_propers.tue.prokeimenon.verse',
    relation: 'variant', note: 'Tuesday Liturgy prokeimenon verse "when I pray unto Thee" (7-3) vs shared "when I make supplication unto Thee" — §5 word divergence.' },
  { a: 'tone7.matins_weekday.sat.aposticha.verses[0]', b: 'shared.weekday_aposticha_verses.sets.departed_matins_saturday[0]',
    relation: 'identical', note: 'Saturday Matins departed aposticha verse 1 byte-matches shared ("those"); tone 7 prints only TWO verses (no verse 3) where 2-7/3-7 carry three — the per-tone difference is the MISSING verse.' },
  { a: 'tone7.matins_weekday.sat.aposticha.verses[1]', b: 'shared.weekday_aposticha_verses.sets.departed_matins_saturday[1]',
    relation: 'identical', note: 'Saturday Matins departed aposticha verse 2 byte-matches shared; the structural per-tone difference is the absent verse 3.' },
  { a: 'tone7.matins_weekday.sat.sessionals[1].verses[1]', b: 'shared.daily_liturgy_propers.sat.alleluia.verses[0]',
    relation: 'variant', note: 'Cross-surface: the Saturday Matins sessional verse "Many are the tribulations … * and the Lord" (pointed, "and") vs the Saturday Liturgy Alleluia "but the Lord …" (shared). The Liturgy marker is SHADOWED by this sessional in a flat scan — re-scope with search_after="AT LITURGY" (the 4-7 caution); the Liturgy verse byte-matches shared, so its ref stands.' },

  // ── tone-8 Gregory pairs (per-tone ruling, from 8-1; §11 tone-8 scan) ──────
  ...
  { a: 'tone8.nocturns.gregory_rubric.stanzas[3]', b: 'shared.gregory_sinaite_hymn.stanzas[3]',
    relation: 'identical', note: 'Byte-verified identical to the shared table; stored per-tone per the July 8 2026 Gregory ruling.' },
  { a: 'tone8.nocturns.gregory_rubric.stanzas[4]', b: 'shared.gregory_sinaite_hymn.stanzas[4]',
    relation: 'variant', note: '"I worship the beginningless God the Father" word order (8-1) vs shared, as tone 7.' },
  { a: 'tone8.nocturns.gregory_rubric.stanzas[5]', b: 'shared.gregory_sinaite_hymn.stanzas[5]',
    relation: 'variant', note: '"Thou Creator of all" (8-1) vs shared "Creator of all"; "immutable" matches shared (as tone 7).' },
  { a: 'tone8.nocturns.gregory_rubric.stanzas[6]', b: 'shared.gregory_sinaite_hymn.stanzas[6]',
    relation: 'variant', note: '"Who became ineffably incarnate" word order (8-1) vs shared "Who ineffably became incarnate"; "of the Virgin" matches shared (as tone 7).' },

  // ── tone-8 §5 per-tone divergence pairs (verify_shared_t8) ─────────────────
  { a: 'tone8.vespers_weekday.tue.aposticha.verses[0]', b: 'shared.weekday_aposticha_verses.sets.standard_vespers[0]',
    relation: 'identical', note: 'Tuesday-eve Vespers aposticha verse 1 byte-matches shared; stored with its per-tone partner.' },
  { a: 'tone8.vespers_weekday.tue.aposticha.verses[1]', b: 'shared.weekday_aposticha_verses.sets.standard_vespers[1]',
    relation: 'variant', note: 'Tuesday-eve Vespers aposticha verse 2 DROPS a comma ("them that" for "them, that"); §5 per-tone.' },
  { a: 'tone8.vespers_weekday.wed.aposticha.verses[0]', b: 'shared.weekday_aposticha_verses.sets.standard_vespers[0]',
    relation: 'variant', note: 'Wednesday-eve Vespers aposticha verse 1 comma for period ("in heaven, Behold" for "in heaven. Behold"); §5 per-tone.' },
  { a: 'tone8.vespers_weekday.wed.aposticha.verses[1]', b: 'shared.weekday_aposticha_verses.sets.standard_vespers[1]',
    relation: 'identical', note: 'Wednesday-eve Vespers aposticha verse 2 byte-matches shared; stored with its per-tone partner.' },
  { a: 'tone8.vespers_weekday.fri.aposticha.verses[0]', b: 'shared.weekday_aposticha_verses.sets.departed_vespers[0]',
    relation: 'variant', note: 'Friday-eve departed verse 1 final period (8-7) — the 3-7/4-7/5-7/6-7/7-7 class.' },
  { a: 'tone8.liturgy_weekday.thu.prokeimenon.verse', b: 'shared.daily_liturgy_propers.thu.prokeimenon.verse',
    relation: 'variant', note: 'Thursday Liturgy prokeimenon verse gains a * (8-5) — the 4-5/5-5/6-5/7-5 class.' },
  { a: 'tone8.liturgy_weekday.tue.prokeimenon.verse', b: 'shared.daily_liturgy_propers.tue.prokeimenon.verse',
    relation: 'variant', note: 'Tuesday Liturgy prokeimenon verse "when I pray unto Thee" (8-3) vs shared "make supplication" — same as tone 7.' },
  { a: 'tone8.liturgy_weekday.fri.alleluia.verses[0]', b: 'shared.daily_liturgy_propers.fri.alleluia.verses[0]',
    relation: 'variant', note: 'Friday Liturgy Alleluia verse "before the ages," (comma, 8-6) where shared prints ";" (semicolon); §5 per-tone.' },
  { a: 'tone8.matins_weekday.sat.aposticha.verses[0]', b: 'shared.weekday_aposticha_verses.sets.departed_matins_saturday[0]',
    relation: 'variant', note: 'Saturday Matins departed verse 1 "they" (8-7) vs shared "those"; §5 per-tone.' },
  { a: 'tone8.matins_weekday.sat.aposticha.verses[1]', b: 'shared.weekday_aposticha_verses.sets.departed_matins_saturday[1]',
    relation: 'identical', note: 'Saturday Matins departed verse 2 byte-matches shared.' },
  { a: 'tone8.matins_weekday.sat.aposticha.verses[2]', b: 'shared.weekday_aposticha_verses.sets.departed_matins_saturday[2]',
    relation: 'variant', note: 'Saturday Matins departed verse 3 "from generation to generation" (8-7) vs shared "unto...and". Tone 8 REVERTS to a THREE-verse set (4-7..7-7 printed two).' },

  // ── tone-1 Gregory pairs (per-tone ruling, from 1-1; §11 tone-1 scan) ──────
  { a: 'tone1.nocturns.gregory_rubric.stanzas[0]', b: 'shared.gregory_sinaite_hymn.stanzas[0]',
    relation: 'identical', note: 'Byte-verified identical to the shared table; stored per-tone per the July 8 2026 Gregory ruling.' },
  { a: 'tone1.nocturns.gregory_rubric.stanzas[1]', b: 'shared.gregory_sinaite_hymn.stanzas[1]',
    relation: 'variant', note: '"in godly manner" (no article) + comma stanza-end (1-1); "the one Sovereignty and Dominion" (NOT tone-7/8 "Kingship"). 2-1/5-1 word-order side.' },
  { a: 'tone1.nocturns.gregory_rubric.stanzas[2]', b: 'shared.gregory_sinaite_hymn.stanzas[2]',
    relation: 'identical', note: 'Byte-verified identical to the shared table; stored per-tone per the July 8 2026 Gregory ruling.' },
  { a: 'tone1.nocturns.gregory_rubric.stanzas[3]', b: 'shared.gregory_sinaite_hymn.stanzas[3]',
    relation: 'identical', note: 'Byte-verified identical to the shared table; stored per-tone per the July 8 2026 Gregory ruling.' },
  { a: 'tone1.nocturns.gregory_rubric.stanzas[4]', b: 'shared.gregory_sinaite_hymn.stanzas[4]',
    relation: 'identical', note: 'Byte-verified identical to the shared table (1-1 keeps "I worship God: the beginningless Father" — unlike tone 7/8).' },
  { a: 'tone1.nocturns.gregory_rubric.stanzas[5]', b: 'shared.gregory_sinaite_hymn.stanzas[5]',
    relation: 'variant', note: '"unshakable" (1-1) vs shared "immutable" (as tones 5/6).' },
  { a: 'tone1.nocturns.gregory_rubric.stanzas[6]', b: 'shared.gregory_sinaite_hymn.stanzas[6]',
    relation: 'variant', note: '"incarnate from the Virgin" (1-1) vs shared "of the Virgin" (as tones 5/6).' },

  // ── tone-1 §5 per-tone divergence pairs (verify_shared_t1) ─────────────────
  { a: 'tone1.vespers_weekday.thu.aposticha.verses[0]', b: 'shared.weekday_aposticha_verses.sets.standard_vespers[0]',
    relation: 'variant', note: 'Thursday-eve Vespers aposticha verse 1 stray period ("dwellest. in heaven"); §5 per-tone.' },
  { a: 'tone1.vespers_weekday.thu.aposticha.verses[1]', b: 'shared.weekday_aposticha_verses.sets.standard_vespers[1]',
    relation: 'identical', note: 'Thursday-eve Vespers aposticha verse 2 byte-matches shared; stored with its per-tone partner.' },
  { a: 'tone1.vespers_weekday.fri.aposticha.verses[0]', b: 'shared.weekday_aposticha_verses.sets.departed_vespers[0]',
    relation: 'variant', note: 'Friday-eve departed verse 1 final period (1-7) — the 3-7..8-7 class.' },
  { a: 'tone1.liturgy_weekday.fri.alleluia.verses[0]', b: 'shared.daily_liturgy_propers.fri.alleluia.verses[0]',
    relation: 'variant', note: 'Friday Liturgy Alleluia verse "before the ages," (comma, 1-6) where shared prints ";" (as tone 8); §5 per-tone.' },
  { a: 'tone1.matins_weekday.sat.aposticha.verses[0]', b: 'shared.weekday_aposticha_verses.sets.departed_matins_saturday[0]',
    relation: 'variant', note: 'Saturday Matins departed verse 1 "they" (1-7) vs shared "those"; §5 per-tone.' },
  { a: 'tone1.matins_weekday.sat.aposticha.verses[1]', b: 'shared.weekday_aposticha_verses.sets.departed_matins_saturday[1]',
    relation: 'identical', note: 'Saturday Matins departed verse 2 byte-matches shared.' },
  { a: 'tone1.matins_weekday.sat.aposticha.verses[2]', b: 'shared.weekday_aposticha_verses.sets.departed_matins_saturday[2]',
    relation: 'variant', note: 'Saturday Matins departed verse 3 "from generation to generation" (1-7) vs shared "unto...and". THREE-verse set (as tone 8).' },
];
