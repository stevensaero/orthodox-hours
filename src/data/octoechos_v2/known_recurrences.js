...
export default [
  ...
  { a: 'theotokia.doxasticon_theotokia', b: 'tone2.vespers_weekday.wed.aposticha_theotokion',
    relation: 'identical', approx: true,
  ...
  { a: 'theotokia.doxasticon_theotokia', b: 'tone2.vespers_weekday.fri.aposticha_theotokion',
    relation: 'identical', approx: true,
    note: '"Save from misfortunes" = Fri-eve aposticha closer — identical print (2-7 / Theotokia.pdf).' },
  { a: 'theotokia.doxasticon_theotokia', b: 'tone2.matins_weekday.thu.sessionals[1].closer',
    relation: 'identical', approx: true,
    note: '"Through thee, O Ever-virgin Theotokos" = Thu Matins set-2 closer — identical print.' },
  { a: 'theotokia.doxasticon_theotokia', b: 'tone2.matins_weekday.wed.sessionals[0].closer',
    relation: 'identical', approx: true,
    note: '"cloud of the unwaning Light" = Wed Matins set-1 closer — identical print.' },

  // ── Theotokia.pdf ↔ chapter closers: re-renderings ─────────────────────────
  { a: 'theotokia.doxasticon_theotokia.thu_praises', b: 'tone2.vespers_weekday.mon.aposticha_theotokion',
    relation: 'variant', approx: true,
  ...
  { a: 'theotokia.doxasticon_theotokia.mon_praises', b: 'tone2.matins_weekday.mon.aposticha_theotokion',
    relation: 'variant', approx: true,
  ...
  { a: 'theotokia.dismissal_theotokia_annual', b: 'tone2.compline.sun.after_ode6.sessional',
    relation: 'variant', approx: true,
  ...
  { a: 'theotokia.doxasticon_theotokia.sat_praises', b: 'tone2.matins_weekday.sat.praises.theotokion',
    relation: 'variant', approx: true,
  ...
  { a: 'theotokia.doxasticon_theotokia.sun_eve_aposticha', b: 'theotokia.doxasticon_theotokia.tue_praises',
    relation: 'variant', approx: true,
  ...
  { a: 'theotokia.dismissal_theotokia_annual', b: 'tone2.matins_weekday.tue.sessionals[0].closer',
    relation: 'family', approx: true,
