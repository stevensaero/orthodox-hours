...
const NN = 'Nuns.pdf';
const [nn2, nn1] = mk(NN);
const HM = 'Hieromartyr.pdf';
const [hm2, hm1] = mk(HM);
const HX = 'Heiromartyrs.pdf';
const [hx2, hx1] = mk(HX);
const HC = 'HieroConfessor.pdf';
const [hc2, hc1] = mk(HC);
const MY = 'MonasticMartyr.pdf';
...
const GENERAL = {
  ...
  // ─────────────────────────────────────────────────────────────────────────
  // Nun.pdf — 14pp, (name) ×41. Extraction proven by ten byte-matches; one
  // OODDEE II residue (transcribed correctly, not registered); markers
  // stripped at flatten.
  //
  //  • A SECOND CROSS-BOOK PAIR: the Tone II dogmatic ("The shadow of the
  //    law") is TWO BYTES off the Octoechos tone-2 Great Vespers copy — the
  //    Tone VI class exactly, third dogmatic family in the book.
  //  • "Let every breath" is GENUINELY ABSENT — after eight census absences
  //    that were spellings, the ninth is real: the Matins gospel follows the
  //    prokeimenon verse directly. Declared absent, close read.
  //  • The idiomelon Glory reprints BYTE-IDENTICALLY as the post-Psalm-50
  //    sessional — including "thou dist water" at both sites (sic ×2): the
  //    Martyress pattern, exact instead of re-set.
  //  • The aposticha stav is Heirarchs' dogmatic stav byte-for-byte — the
  //    "diest?," defect's THIRD file. The LIC stav is Heirarch's aposticha
  //    stav ONE WORD off ("redeemed OF all" — sic AND variant). The true
  //    vine gains a FOURTH form ("with the venerable (name)").
  //  • Beatitudes seven of seven — ELEVEN files identical, two variant —
  //    with "comliest" copied canon→Beatitude (seventh transmission file).
  Nun: {
    title: nu1("THE GENERAL VIGIL SERVICE TO A NUN.", "p1 title"),
    troparion: nu2("In thee, O mother, the image of God was preserved, * for taking up thy cross, thou didst follow after Christ; * by activity thou didst learn to disdain the flesh, as something transient, * but to care for thy soul as something immortal. ** Wherefore, with the angels thy spirit doth rejoice, O venerable (name).", "p4 Troparion", { sourceLabel: "Troparion of the venerable mother, in Tone VIII", tone: 8, verified_sites: [{"locus": "p4 Vespers dismissal", "tone": 8}, {"locus": "p5 God is the Lord", "tone": 8, "repeat": 2}, {"locus": "p12 after Our Father", "tone": 8}, {"locus": "p13 AT THE LITURGY", "tone": 8}] }),
    kontakion: nu2("Having discarded a bed for rest, * for the sake of thy love for God, * O Mother (name), * and illuminating thy spirit with fasting, * thou hast completely vanquished thine enemies; * and by thine intercessions ** destroyed the evil machinations of our adversaries.", "p9 Kontakion after Ode VI", { sourceLabel: "Kontakion of the venerable mother, in Tone II", spec_mel: "Having received the grace ...", tone: 2, verified_sites: [{"locus": "p9 after Ode VI", "tone": 2}, {"locus": "p13 AT THE LITURGY", "tone": 2}] }),
    ikos: nu1("O my God, fashion my mind and bless my tongue, and grant me streams of fair speech, that I may hymn thy lamb whom Thou hast crowned with Thy grace. For if words worthy of her praise are not imparted to me, wretch that I am, how can I offer worthy gifts unto her, who is exceedingly rich both in words and deeds? Wherefore grant me the wisdom to declare unto all the glory of her ascetic struggles in vanquishing the noetic beasts, and by her fervent intercessions destroy the machinations of our adversaries.", "p9 Ikos", { sourceLabel: "The Ikos", label_inline: true }),
    ...
    vespers: {
      order: ['lic_rubric', 'lic', 'lic_closer', 'lic_stavrotheotokion',
              ...
              'aposticha_glory', 'aposticha_closer', 'aposticha_stavrotheotokion',
              'troparion_rubric', 'troparion', 'closer', 'closing_rubric'],
      lic_rubric: nu1("On “Lord, I have cried ...,” these Stichera, in Tone VIII:", "p1 LIC rubric"),
      lic: [
        nu2("Enduring the labors of asceticism, * O honored mother (name), * thou hast obtained the grace to cleanse diseases * of both soul and body, * to vanquish unclean spirits by the spirit, * and to be a patron of the afflicted; * wherefore we beseech thee, that by thy prayers ** we be granted healing and great mercy.", "p1 LIC 1", { spec_mel: "Thy Martyrs, O Lord ...", label: "plain" }),
        nu2("The shrine of thy relics * poureth forth recovery of sight to the blind, * and cures for all the infirm who approach them with faith * and implore thy visitation, * O right wondrous venerable mother (name); * wherefore we beseech thee, that by thy prayers ** we be granted healing and great mercy.", "p1 LIC 2", { spec_mel: "Thy Martyrs, O Lord ...", label: "plain" }),
        nu2("Having acquired mercy towards thy neighbor, * and Orthodox faith and love towards God, * O God-blessed, honored (name); * the spiritual grace of God rested upon thee, * O venerable mother; * wherefore we beseech thee, that by thy prayers ** those who bless thee may be preserved in the faith.", "p1 LIC 3", { spec_mel: "Thy Martyrs, O Lord ...", label: "plain" }),
      ],
      lic_closer: nu2("O most pure one, held fast by our many afflictions * we entreat thee our intercessor; * forsake us not, that thy servants be not utterly ruined; * but do thou hasten to deliver us from every wrath and necessity, * O most holy tabernacle of God, ** for thou art an impregnable rampart and succor.", "p1 LIC closer", { sourceLabel: "Glory ..., Both now ..., Theotokion, in Tone VIII", tone: 8, type: "theotokion", label: ["glory", "both_now", "theotokion"] }),
      // Heirarch's aposticha stavrotheotokion ONE WORD OFF — "Thou hast
      // redeemed OF all from corruption" for "redeemed all" (sic AND
      // registered variant).
      lic_stavrotheotokion: nu2("Beholding Thee O Lord Jesus, * nailed upon the cross and voluntarily accepting the passion, * the Virgin Mother cried aloud: * Woe is me, O my sweet Child! * how dost Thou wrongfully endure such wounds? * O compassionate Physician and healer of the infirmities of mankind, * Thou hast redeemed of all from corruption ** by Thy tender compassion.", "p1 LIC Stavrotheotokion", { sourceLabel: "Stavrotheotokion", type: "stavrotheotokion", label: "stavrotheotokion", label_inline: true }),
      idiomelon_rubric: nu1("If an Idiomelon be appointed, Glory ..., in Tone II:", "p1 idiomelon rubric"),
      // Reprinted BYTE-IDENTICALLY as the post-Psalm-50 sessional (p7) —
      // "thou dist water" included at both sites (sic ×2, registered).
      lic_glory: nu2("Having cut down spiritual snares and bodily passions * with the sword of abstinence, * and having vanquished sinful thoughts with silence and fasting, * thou dist water the noetic desert * with the streams of thy tears, * blossoming forth the fruits of repentance; * wherefore we celebrate, O venerable one, ** thy sacred memory.", "p1 Glory idiomelon", { sourceLabel: "If an Idiomelon be appointed, Glory ..., in Tone II", tone: 2, label: "glory" }),
      dogmatikon_rubric: nu1("If the Celebration be with a Polyeleos, and not a Resurrection Service, chant the following Dogmatic in Tone II (If the service is a Resurrection service chant the Dogmatic of the Tone for that service ):", "p1 dogmatikon rubric"),
      // THE SECOND CROSS-BOOK PAIR (§10.4): TWO BYTES off the Octoechos
      // tone-2 Great Vespers copy ("the Bush" capitalised here, one more at
      // offset 168). The Tone VI class exactly — the Menaion's dogmatic
      // copies diverge from the Octoechos only in capitals. Registered.
      dogmatikon: nu2("The shadow of the law hath passed now that grace hath come, * for as the Bush wrapped in flame was not consumed, * so didst thou bear a Child O Virgin * and remained a Virgin; * in place of a pillar of fire, the Sun of righteousness hath dawned, * instead of Moses, Christ is come, ** the salvation of our souls.", "p1 Both now dogmatic", { sourceLabel: "Both now ..., in Tone II", tone: 2, type: "dogmatic_theotokion", label: "both_now" }),
      dogmatikon_alternate: nu2("Save thy servants from harm, * O Theotokos, * for all we after God, ** flee unto thee, as to an unassailable wall and intercessor.", "p2 Otherwise Theotokion", { sourceLabel: "Otherwise, Theotokion", type: "theotokion", label: "theotokion", label_inline: true }),
      // A Spec. Mel. ON a stavrotheotokion — first in thirteen files — and
      // the hymn is the Martyresses praises-stav family in ANOTHER rendering
      // (registered).
      dogmatikon_stavrotheotokion: nu2("Upon beholding her Lamb led of His own will to the slaughter as a man, * the unblemished ewe-lamb, * cried aloud weeping: * “Dost Thou now hasten to leave childless, * the one who gave Thee birth, O Christ? * What is this that Thou hast done, O Redeemer of all? * Even so I will hymn and glorify Thine extreme goodness * which passeth understanding and all telling, ** O Lover of mankind!”", "p2 Stavrotheotokion", { sourceLabel: "Stavrotheotokion", spec_mel: "When from the tree ...", type: "stavrotheotokion", label: "stavrotheotokion", label_inline: true }),
      entrance_rubric: nu1("The Entrance. The Prokeimenon of the day. The Three Lessons, if appointed.", "p2 entrance rubric"),
      // Wisdom ×3, ALL under "A READING FROM" — the first uniform
      // indefinite-article set. Lesson 3 is the "die early" rendering that
      // runs INTO WISDOM 5 — a different pericope from Monastic's third
      // lesson. Lesson 2 carries the "sin Tone bow" body corruption shared
      // with Martyress/Martyresses; lesson 3 prints "bath not illumined"
      // (unstored body text).
      readings: [
        { heading: 'A READING FROM THE WISDOM OF SOLOMON',
          src: { file: NU, locus: 'p2 Lesson 1' },
          citation: { book: 'Wisdom of Solomon', chapter: 3, verses: '3:1-3:9' },
          citation_basis: 'identified',
          provenance_note: 'The "souls of the righteous" lesson, derived at 3:1-9 in Monastic. Identified; confirm against the page.' },
        { heading: 'A READING FROM THE WISDOM OF SOLOMON',
          src: { file: NU, locus: 'p2 Lesson 2' },
          citation: { book: 'Wisdom of Solomon', chapter: 5, verses: '5:15-6:3' },
          citation_basis: 'identified',
          provenance_note: 'The "righteous live unto the ages" rendering, with the "cast as out of a sin Tone bow" body corruption shared byte-for-byte with Martyress and Martyresses. Identified; confirm against the page.' },
        { heading: 'A READING FROM THE WISDOM OF SOLOMON',
          src: { file: NU, locus: 'p3 Lesson 3' },
          citation: { book: 'Wisdom of Solomon', chapter: 4, verses: '4:7, 4:16-5:7' },
          citation_basis: 'identified',
          provenance_note: 'Opens "The righteous man if he happen to die early" (4:7) and runs THROUGH the judgment scene into Wisdom 5 ("Then the righteous man will stand up in great boldness", 5:1) — a DIFFERENT and longer pericope than Monastic\'s third lesson (derived 4:7-14). Composite; identified; confirm span against the page. Body prints "bath not illumined" for "hath".' },
      ],
      aposticha_rubric: nu1("On the Aposticha, these Stichera, in Tone I:", "p3 Aposticha rubric"),
      aposticha: [
        nu2("Having true adoration for the splendor of the fathers, * and having loved incorruptible glory; * thou didst reject the delight of temporal things, O (name), * giving thy body over to a multitude of labors, * and now having obtained the reward of thy struggles, ** thou dost reign together with Christ.", "p3 Aposticha 1", { spec_mel: "Joy of the ranks of heaven ...", tone: 1, label: "plain" }),
        nu2("Wondrous is God in His saints, * the God of Israel.", "p3 Aposticha verse 1", { sourceLabel: "Verse", label: "refrain" }),
        nu2("Desiring the fair beauty of the Bridegroom Christ, * and striving to betroth thyself to Him, * thou didst adorn thyself * with the labors of asceticism, * and with a multitude of good deeds O (name), ** wherefore thou dost now reign with Him in paradise.", "p3 Aposticha 2", { spec_mel: "Joy of the ranks of heaven ...", label: "plain" }),
        nu2("In the Congregations bless ye God, * the Lord, from the wellsprings of Israel.", "p3 Aposticha verse 2", { sourceLabel: "Verse", label: "refrain" }),
        nu2("Setting course for the divine haven, * thou hast calmly traversed the seas of worldly distractions, * piloting the ship of thy soul, * keeping it safe from foundering * on the shoals of temporal pleasures, ** and filling it with secret treasures.", "p3 Aposticha 3", { spec_mel: "Joy of the ranks of heaven ...", label: "plain" }),
      ],
      // Reprinted byte-for-byte as the Doxasticon (p12) — eighth file with
      // the pattern.
      aposticha_glory: nu2("Thy sacred celebration * hath today shone forth * more brilliantly than the sun, * illumining those in darkness, * and vanquishing the gloomy mist of the demons, ** O right wondrous one.", "p3 Aposticha Glory", { sourceLabel: "Glory ..., in Tone VI", tone: 6, label: "glory" }),
      // A FOURTH FORM of the true vine — "Pray thou, O Lady, with the
      // venerable (name)" for "with the holy apostles" — the general theotokion
      // ADAPTED to its saint type, with (name) inside a THEOTOKION for the
      // first time. No Polyeleos conditional and no alternates at this
      // aposticha (registered as a variant of the family).
      aposticha_closer: nu2("O Theotokos, thou art the true vine * that hast budded forth for us the Fruit of life. * Thee do we entreat: * Pray thou, O Lady, with the venerable (name), that He have mercy upon our souls.", "p4 Aposticha Both now", { sourceLabel: "Both now ..., Theotokion in Tone VI", tone: 6, type: "theotokion", label: ["both_now", "theotokion"] }),
      // Heirarchs' dogmatic stav BYTE-FOR-BYTE — "O my Son How is it that
      // Thou diest?," included: the defect's THIRD file (sic register).
      aposticha_stavrotheotokion: nu2("Upon seeing Thee crucified, O Christ, * she who gaveth birth to Thee cried aloud: * “What is this strange mystery that I see, * O my Son How is it that Thou diest?, * suspended upon the Tree, ** O Bestower of life?”", "p4 Stavrotheotokion", { sourceLabel: "Stavrotheotokion", type: "stavrotheotokion", label: "stavrotheotokion", label_inline: true }),
      // "but, if there be none, chant THIS:" — a TENTH wording of the
      // conditional.
      troparion_rubric: nu1("The Troparion from the Typicon; but, if there be none, chant this:", "p4 troparion rubric"),
      closer: { absent: true, reason: "not_printed_in_source", basis: "close_reading", note: "Slot printed as “Glory ..., Both now ..., Theotokion or Stavrotheotokion.” — with a FULL STOP where twelve files print a colon — and no text: the conditional closer (§5.8)." },
      closing_rubric: nu1("The Dismissal:", "p4 Dismissal"),
    },
    ...
    matins: {
      order: ['god_is_lord_rubric', 'troparion', 'troparion_closer',
              ...
              'doxology_glory', 'doxology_closer_rubric', 'troparion_rubric',
              'troparion', 'closer', 'closing_rubric'],
      god_is_lord_rubric: nu1("On “God is the Lord ...,” the Troparion, in Tone VIII:", "p5 God is the Lord rubric"),
      troparion_closer: { absent: true, reason: "not_printed_in_source", basis: "close_reading", note: "Slot printed as “Glory ..., Both now ..., Theotokion or Stavrotheotokion.” — full stop for the colon here too — and no text (§5.8)." },
      sessional_1_rubric: nu1("After the 1st chanting of the Psalter, the Sessional Hymn, in Tone V:", "p5 sessional 1 rubric"),
      sessional_1: nu2("Valiantly enduring the struggles of asceticism, * thou didst overthrow the crafty one, * and having reposed after living a devout life of struggles, * O venerable (name), thou dost now entreat God * on behalf of all who reverently observe thy sacred memory.", "p5 Sessional 1", { spec_mel: "The co-beginningless Word ...", tone: 5, label: "plain", repeat: 2 }),
      sessional_1_closer: nu2("O all-immaculate Virgin Mother! * do thou illumine me with the salvific rays of repentance, * dispelling the mist of my wicked transgressions, ** and expelling from my heart evil thoughts.", "p5 Sessional 1 closer", { sourceLabel: "Glory ..., Both now ..., Theotokion, in Tone V", tone: 5, type: "theotokion", label: ["glory", "both_now", "theotokion"] }),
      sessional_2_rubric: nu1("After the 2nd chanting of the Psalter, the Sessional Hymn, in Tone IV:", "p5 sessional 2 rubric"),
      sessional_2: nu2("Crucifying thy body, with its passions, * O (name), * and yielding all thy love to Christ thine eternal Bridegroom, * thou hast obtained an everlasting crown of glory * and been numbered with the choir of angels; * Fervently entreat Christ on behalf of those who honor Thee, O venerable one.", "p5 Sessional 2", { spec_mel: "Go thou quickly before ...", tone: 4, label: "plain", repeat: 2 }),
      sessional_2_closer: nu2("Tempest tossed by the storm of my many sins, * and the turmoil of my disordered thoughts, * have compassion on me * and extend unto me thy servant thy sovereign right hand * O all-immaculate one, ** that saved, I may magnify thee.", "p5 Sessional 2 closer", { sourceLabel: "Glory ..., Both now ..., Theotokion, in Tone IV", tone: 4, type: "theotokion", label: ["glory", "both_now", "theotokion"] }),
      megalynarion_rubric: nu1("After the Polyeleos, the Megalynarion:", "p5 megalynarion rubric"),
      // "We bless thee … Instructor of Nuns, and converser with the angels"
      // — the MonasticMartyrs "We bless" formula in the singular, sharing its
      // verse byte-for-byte (registered).
      megalynarion: nu1("We bless thee, O Venerable Mother (name), and we honor thy holy memory, Instructor of Nuns, and converser with the angels.", "p5 Megalynarion", { label_inline: true }),
      megalynarion_verse: nu1("With patience I waited patiently for the Lord, and He was attentive unto me, and He hearkened unto my supplication.", "p5 Megalynarion verse", { sourceLabel: "Verse", label: "refrain" }),
      sessional_polyeleos_rubric: nu1("After the Polyeleos, the Sessional Hymn, in Tone VIII:", "p5 post-Polyeleos sessional rubric"),
      sessional_polyeleos: nu2("O venerable mother foreordained by God! * thou hast humbly traversed the stormy sea of life, * and having entered the calm haven of heaven, * thou dost now chant together with the Angels, unto the Redeemer, * ever entreat Christ on our behalf, * that He grant us grace and great mercy, ** and preserve the flock wisely gathered by thee.", "p5 post-Polyeleos Sessional", { spec_mel: "That which was mystically commanded ...", tone: 8, label: "plain", repeat: 2 }),
      sessional_polyeleos_closer: nu2("Rejoice, thou who through the angel * didst receive the joy of the world! * Rejoice, thou that hast given birth unto thy Creator and Lord! ** Rejoice, thou that wast deemed worthy to be the Mother of God!", "p6 post-Polyeleos Sessional closer", { sourceLabel: "Glory ..., Both now ..., Theotokion in Tone VIII", tone: 8, type: "theotokion", label: ["glory", "both_now", "theotokion"] }),
      anabathmoi_rubric: nu1("If of Polyeleos rank, and not a Resurrection Service, chant the following:", "p6 anabathmoi rubric"),
      anabathmoi_intro: nu1("The Song of Ascents: The first antiphon, in Tone IV:", "p6 anabathmoi heading"),
      anabathmoi: [
        nu2("From my youth * do many passions war against me; * but do Thou Thyself defend ** and save me, O my Savior.", "p6 Anabathmoi 1", { label: "plain" }),
        nu2("Ye haters of Zion * shall be shamed by the Lord; * for like grass, by the fire ** shall ye be withered.", "p6 Anabathmoi 2", { label: "plain" }),
      ],
      anabathmoi_closer: nu2("In the Holy Spirit, * every soul is quickened, * and, through cleansing, is exalted ** and made radiant by the Triple Unity in a hidden sacred manner.", "p6 Anabathmoi closer", { sourceLabel: "Glory ..., Both now ...,", type: "plain", label: ["glory", "both_now"] }),
      prokeimenon_rubric: nu1("Prokeimenon, in Tone IV:", "p6 prokeimenon rubric"),
      prokeimenon: nu2("Wondrous is God in His saints, * the God of Israel.", "p6 Prokeimenon", { sourceLabel: "The Prokeimenon", tone: 4, label_inline: true }),
      prokeimenon_verse: nu1("In the Congregations bless ye God, the Lord, from the wellsprings of Israel.", "p6 Prokeimenon verse", { sourceLabel: "Verse", label: "refrain" }),
      // GENUINELY ABSENT — the gospel follows the prokeimenon verse with no
      // "Let every breath" line. After eight census absences that were
      // spellings, the ninth is real. Declared, close read.
      gospel_rubric: { absent: true, reason: "not_printed_in_source", basis: "close_reading", note: "Twelve files print “Let every breath …” (in three punctuations) between the prokeimenon verse and the Gospel; this page prints nothing — the heading follows directly. The first genuine absence at this slot." },
      gospel: { heading: 'THE GOSPEL ACCORDING TO ST. MATTHEW',
        src: { file: NU, locus: 'p6 Matins Gospel' },
        citation_verbatim: '(25, 1-13)',
        citation: { book: 'Matthew', chapter: 25, verses: '1-13' },
        citation_basis: 'printed' },
      psalm50_rubric: nu1("After the 50th Psalm:", "p6 After the 50th Psalm"),
      psalm50_sticheron: nu2("Through the prayers of the venerable mother (name), * O Merciful One, ** blot out the multitude of our transgressions.", "p6 Psalm 50 Glory", { sourceLabel: "Glory ..., in Tone VI", tone: 6, label: "glory" }),
      psalm50_closer: nu2("Through the prayers of the Theotokos, * O Merciful One, ** blot out the multitude of our transgressions.", "p7 Psalm 50 Both now", { sourceLabel: "Both now ...,", type: "theotokion", label: "both_now" }),
      psalm50_verse: nu2("Have mercy on me, O God, * according to Thy great mercy; * and according to the multitude of Thy compassions, ** blot out my transgressions.", "p7 Psalm 50 verse", { label: "refrain" }),
      sessional_post50_rubric: nu1("Then the Sessional Hymn, in Tone II:", "p7 post-Psalm-50 sessional rubric"),
      // The idiomelon Glory, byte-for-byte — "thou dist water" included
      // (registered; sic at both sites).
      sessional_post50: nu2("Having cut down spiritual snares and bodily passions * with the sword of abstinence, * and having vanquished sinful thoughts with silence and fasting, * thou dist water the noetic desert * with the streams of thy tears, * blossoming forth the fruits of repentance; * wherefore we celebrate, O venerable one, ** thy sacred memory.", "p7 post-Psalm-50 Sessional", { tone: 2, label: "plain" }),
      canon_rubric: nu1("The Canon, in Tone VIII:", "p7 Canon rubric"),
      canons: [{
        title: "The Canon, in Tone VIII:", tone: 8,
        odes: {
          1: {
            irmos: nu2("The wonderworking staff of Moses, * striking and dividing the sea in the figure of a cross, * once drowned Pharaoh the pursuing charioteer, * while it saved the fleeing people of Israel * as they fled on foot, * chanting a hymn unto God.", "p7 Ode 1 irmos", { sourceLabel: "Irmos", label_inline: true }),
            refrain: nu1("Venerable mother (name) pray to God for us", "p7 Ode 1 refrain", { sourceLabel: "Refrain", label_inline: true }),
            items: [
              nu1("My soul is disturbed by beguiling thoughts and ever beset by the storm of passions, do thou, O venerable (name), guide me to the calm haven of Christ’s commandments, that I may worthily hymn thee.", "p7 Ode 1 troparion 1", { label: "plain" }),
              nu1("O (name), splendidly illumined with the virtue of virginity O god-blessed one, having lived a life of divine abstinence, thou didst betroth thyself unto the pure Word, following in His life-giving footsteps, and mortifying the passions.", "p7 Ode 1 troparion 2", { label: "plain" }),
              nu1("Following the instructions of the divine fathers and fervently emulating their lives, thou, O glorious (name), hast lived a life of abstinence, purity, virginity and true humility, like that of an earthly angel, O venerable (name).", "p7 Ode 1 troparion 3", { label: "plain" }),
              nu1("Like a divine hearth and table, that hath brought forth the Bread of life, like the un-ploughed land, and like the holy mount, we glorify in hymns the Virgin Mother of God.", "p7 Ode 1 Theotokion", { sourceLabel: "Theotokion", label: "theotokion", label_inline: true }),
            ],
          },
          3: {
            irmos: nu2("O Lord, Creator of the vault of Heaven * and Builder of the Church, * do Thou strengthen me in Thy love, O Summit of desire, * O Support of the faithful, * O only Lover of mankind.", "p7 Ode 3 irmos", { sourceLabel: "Irmos", label_inline: true }),
            items: [
              nu1("Chosen to be a bride of the Almighty, thou hast made thine abode in the glorious heavenly mansions, from whence floweth forth streams of healing O (name), drying up the flow of passions.", "p7 Ode 3 troparion 1", { label: "plain" }),
              nu1("Adorned with the highest devotion to Christ, Who in His compassion, endured the impoverishment of His body, thou didst follow His life-giving words, disdaining the temporal delights of this life.", "p8 Ode 3 troparion 2", { label: "plain" }),
              nu1("Blessed with golden wings of virtue, thou didst soar unto the heavenly heights like an immortal dove, O blessed (name).", "p8 Ode 3 troparion 3", { label: "plain" }),
              nu1("The race of mankind was saved, O Virgin, by the grace of Him Who endured impoverishment of His body, which ineffably came forth from thy womb; wherefore we honor and devoutly bless thee, O most pure Virgin Mother of God.", "p8 Ode 3 Theotokion", { sourceLabel: "Theotokion", label: "theotokion", label_inline: true }),
            ],
          },
          4: {
            irmos: nu2("O Lord, I have heard the mystery of Thy dispensation; * I have considered Thy works, * and I have glorified Thy Divinity.", "p8 Ode 4 irmos", { sourceLabel: "Irmos", label_inline: true }),
            items: [
              nu1("Thy splendid memorial, shining brightly with the light of God’s Spirit, doth illumine the souls of those who in faith hymn thee, O venerable (name).", "p8 Ode 4 troparion 1", { label: "plain" }),
              nu1("By thy divine miracles thou hast brought to the faith those who knew not the Master, turning them from the darkness of ignorance to the knowledge of Him.", "p8 Ode 4 troparion 2", { label: "plain" }),
              nu1("As gifts thou didst bring unto Christ the mortification of thy members and the pangs of abstinence, for which thou didst inherit the Kingdom of heaven and never-ending delight in paradise.", "p8 Ode 4 troparion 3", { label: "plain" }),
              nu1("As one who liveth proudly, humble me and save me, O most pure one, for thou hast given birth unto Him who hath exalted our humbled nature.", "p8 Ode 4 Theotokion", { sourceLabel: "Theotokion", label: "theotokion", label_inline: true }),
            ],
          },
          5: {
            irmos: nu2("Rising early we cry to Thee, O Lord; * save us, for Thou art our God, * and we know none other besides Thee.", "p8 Ode 5 irmos", { sourceLabel: "Irmos", label_inline: true }),
            items: [
              nu1("Raising thine arms unto thy Creator, O mother (name), thou hast subdued the violence of the enemy.", "p9 Ode 5 troparion 1", { label: "plain" }),
              nu1("Holding thee by thy right hand and guiding thee, the Highest hath led thee, O mother, into His heavenly kingdom.", "p9 Ode 5 troparion 2", { label: "plain" }),
              nu1("Passing this life on the narrow path of ascetic struggle, thou, O all-honored (name), hast finished thy course, having reached the fullness of paradise.", "p9 Ode 5 troparion 3", { label: "plain" }),
              nu1("Those who know thee not, O Mother of God, as the Theotokos, shall never behold the Light born from thee, O most pure one.", "p9 Ode 5 Theotokion", { sourceLabel: "Theotokion", label: "theotokion", label_inline: true }),
            ],
          },
          6: {
            irmos: nu2("O Thou that puttest on light as a garment * grant me also a robe of light, * O All-merciful Christ, our God.", "p9 Ode 6 irmos", { sourceLabel: "Irmos", label_inline: true }),
            items: [
              nu1("Having humbled the yearning of the flesh, thou didst become the master of thy passions; and now, O all-honored (name), thou abidest in the passionless calm of heaven.", "p9 Ode 6 troparion 1", { label: "plain" }),
              nu1("Thou, O glorious one, accustomed to adoring the image of the Savior, didst observe His saving teaching in both word and deed.", "p9 Ode 6 troparion 2", { label: "plain" }),
              nu1("Christ hath shown thee, O mother (name), to be a bedewing cloud sprinkling life upon those who in faith ask it of thee, O glorious one.", "p9 Ode 6 troparion 3", { label: "plain" }),
              nu1("Thy Son, O most pure one, in the beauty of His Godhead is the comliest of all mankind, having assumed flesh for our sake.", "p9 Ode 6 Theotokion", { sourceLabel: "Theotokion", label: "theotokion", label_inline: true }),
            ],
          },
          7: {
            irmos: nu2("The Hebrew children in the furnace * boldly trampled upon the flames, * changing the fire into dew, they cried aloud: * “Blessed art Thou, O Lord our God, throughout the ages.”", "p9 Ode 7 irmos", { sourceLabel: "Irmos", label_inline: true }),
            items: [
              nu1("O venerable (name), caring not for corruptible things, thou hast set thy mind on the eternal rewards of heaven, the light and the glory of divine and eternal life, and the beauty of the divine abodes.", "p10 Ode 7 troparion 1", { label: "plain" }),
              nu1("Thou hast exchanged life in this corrupt world for eternal life, fleeting foods for eternal grace, and temporal betrothal for the heavenly Bridegroom, O venerable (name),", "p10 Ode 7 troparion 2", { label: "plain" }),
              nu1("Having acquired the love and understanding of God, O (name), thou didst become like an angel in thy body, fervently keeping vigil with love and chanting: “Blessed art Thou, O Lord our God, throughout the ages.”", "p10 Ode 7 troparion 3", { label: "plain" }),
              nu1("O Maiden, behold the afflictions which the multitude of my evil deeds have brought upon me, and snatch me from the fiery flame of Gehenna, that I may cry aloud: “Blessed art Thou, O Lord our God, throughout the ages.”", "p10 Ode 7 Theotokion", { sourceLabel: "Theotokion", label: "theotokion", label_inline: true }),
            ],
          },
          8: {
            irmos: nu2("Treading down the fiery flame in the furnace, * the divinely eloquent children sang: * “Bless the Lord, ye works of the Lord.”", "p10 Ode 8 irmos", { sourceLabel: "Irmos", label_inline: true }),
            items: [
              nu1("Adorned with the radiance of thy virtues and illumined by the purity of thy life, O mother, thou standest before thy Bridegroom Christ our God.", "p10 Ode 8 troparion 1", { label: "plain" }),
              nu1("Thy holy body, gloriously preserved in thy shrine, doth cure a multitude of diseases and vanquisheth the machinations of evil spirits.", "p10 Ode 8 troparion 2", { label: "plain" }),
              nu1("As a sacred sacrifice, O venerable mother (name), thou wast presented to Christ our God the Master of all, as a fragrant offering of sweet-smelling incense.", "p10 Ode 8 troparion 3", { label: "plain" }),
              nu1("Without corruption and beyond telling thou hast given birth to the Word who hath delivered us from corruption; wherefore in faith we magnify thee, O Virgin.", "p10 Ode 8 Theotokion", { sourceLabel: "Theotokion", label: "theotokion", label_inline: true }),
            ],
          },
          9: {
            irmos: nu2("Heaven was stricken with awe, * and the ends of the earth were filled with amazement, * for God hath appeared in the flesh, * and thy womb was rendered more spacious than the heavens. * Wherefore, the ranks of men and of angels * magnify thee as the Theotokos.", "p10 Ode 9 irmos", { sourceLabel: "Irmos", label_inline: true }),
            items: [
              nu1("Having desired the spiritual beauty of the Bridegroom and loving Him purely thou didst fervently cry to Him. “Where dost Thou take Thy rest O Lord?” “Let me rest with Thee and take delight in Thy serene beauty, that I may magnify Thy loving-kindness.”", "p10 Ode 9 troparion 1", { label: "plain" }),
              nu1("In thy soul thou didst harbor true humility and understanding, divine compassion, undoubting faith, hope, and love for God, drawing close to Him in vigil, thou wast illumined and enlightened by the grace of God, O blessed (name).", "p10 Ode 9 troparion 2", { label: "plain" }),
              nu1("Thy people gather together today with praises magnifying the Lord who hath glorified thy holy solemnity; Standing now before Christ, thy Bridegroom, O venerable and all-honored (name), remember thy people who honor thee.", "p10 Ode 9 troparion 3", { label: "plain" }),
              nu1("O God, who wast born of the Virgin preserving her incorrupt even after child-bearing, overlook the multitude of my evil and wicked sins and spare me, when thou sittest to judge the living and the dead, as thou alone art a gracious God and the Lover of mankind.", "p11 Ode 9 Theotokion", { sourceLabel: "Theotokion", label: "theotokion", label_inline: true }),
            ],
          },
        },
      }],
      sessional_ode3_rubric: nu1("The Sessional Hymn, in Tone IV:", "p8 post-Ode-III sessional rubric"),
      sessional_ode3: nu2("Thou hast been revealed to be an undefiled virgin, * and a bride of Christ * adorned with the beauty of sacred ascetic endeavors. * Entering into the incorruptible chambers with Him, * thou dost now delight in the contemplation of the beauty therein; * entreat Him that we, who hymn thee with love, * be saved from every evil circumstance.", "p8 post-Ode-III Sessional", { spec_mel: "Thou that was lifted up upon the cross ...", tone: 4, label: "plain" }),
      sessional_ode3_closer: nu1("O pure, all-immaculate one who knewest not a man, who alone hast given birth within time to the timeless Son and Word of God, with the holy and honored patriarchs, the martyrs, prophets and the venerable, entreat Him, that He grant us purification and great mercy.", "p8 post-Ode-III Sessional closer", { sourceLabel: "Glory ..., Both now ..., Theotokion, in Tone IV", tone: 4, type: "theotokion", label: ["glory", "both_now", "theotokion"] }),
      sessional_ode3_stavrotheotokion: nu2("O most immaculate Virgin, * Mother of Christ God, * a sword pierced thy most holy soul * when thou didst behold thy Son and God * crucified of His own will. * Him do thou never cease to entreat, O blessed one, ** that He grant us the forgiveness of our transgressions.", "p8 post-Ode-III Stavrotheotokion", { sourceLabel: "Stavrotheotokion", type: "stavrotheotokion", label: "stavrotheotokion", label_inline: true }),
      kontakion_rubric: nu1("The Kontakion from the Typicon; if there be none, chant the following:", "p9 kontakion rubric"),
      exapostilarion_rubric: nu1("Exapostilarion in Tone III:", "p11 exapostilarion rubric"),
      exapostilarion: nu2("Hiding thy shame from the prince of this world * beneath the vesture of thy tonsure, * thou hast in a most wise manner revealed his foolishness, * for though thou wast a Virgin in both soul and body * thou wast most manly in thine understanding and faith, O venerable (name), * thou beauty of chastity, and adornment of the tonsured.", "p11 Exapostilarion", { tone: 3, label: "plain" }),
      exapostilarion_closer: nu2("Do thou, O pure one, illumine my soul * darkened by the multitude of my many transgressions * and through thine intercession deliver me * from the eternal flames and darkness, ** that I may with joy praise thy majesty.", "p11 Exapostilarion closer", { sourceLabel: "Glory ..., Both now ..., Theotokion in Tone III", tone: 3, type: "theotokion", label: ["glory", "both_now", "theotokion"] }),
      praises_rubric: nu1("On the Praises, these Stichera, in Tone IV:", "p11 Praises rubric"),
      praises: [
        nu2("Following Christ, * thou hast made the impulsiveness of the flesh * subject to the spirit, * making thine abode * among the choirs of ascetic women, * by means of fasting, * extinguishing the flames of temporal desire, * with the dew of thy divine tears, ** ever swelling with fervor for thy Creator.", "p11 Praises 1", { spec_mel: "As one valiant among the martyrs ...", tone: 4, label: "plain", repeat: 2 }),
        nu2("Beholding in the purity of thy soul, O all-wise one, * a temple of the Holy Spirit * which thou didst fashion to the glory of God * and for the benefit of many, * guiding souls * to the profitable labors of abstinence, * saving them and presenting them * like a precious dowry unto the Master, ** wherefore we, with them, honor thee in faith, O (name).", "p11 Praises 2", { spec_mel: "As one valiant among the martyrs ...", label: "plain" }),
        nu2("Following thine instructions O (name), * thy maidens learned to love their Bridegroom and Lord, * in spirit rebuking the weakness of the flesh * and diligently subduing their passions, * they, together with thee, * were ushered into the heavenly and divine palaces, ** ever rejoicing.", "p11 Praises 3", { spec_mel: "As one valiant among the martyrs ...", label: "plain" }),
      ],
      praises_glory: nu2("O most glorious wonder! * With what fervor thou didst give thyself over to God in ascetic labors and tears? * by abstinence vanquishing bodily passions, * and trampling demons underfoot, * filled with divine love, ** thou wast revealed to be a Bride of the Almighty.", "p11 Praises Glory", { sourceLabel: "Glory ..., in Tone VIII", tone: 8, label: "glory" }),
      praises_closer: nu2("Taking up the cry of the Archangel Gabriel, let us say: * Rejoice, O Mother of God, * who hast given birth unto Christ, ** the bestower of life upon the world!", "p11 Praises Both now", { sourceLabel: "Both now ..., Theotokion in Tone VIII", tone: 8, type: "theotokion", label: ["both_now", "theotokion"] }),
      // The Martyresses dogmatic-stav family in ANOTHER rendering — third
      // form of "When the most pure one beheld Thee" (registered).
      praises_stavrotheotokion: nu2("When the most pure one beheld Thee * hanging upon the Cross in the flesh, * with a broken heart she cried aloud in tears: * “O Word, whither hast Thou gone, * my most beloved Jesus, my Son, and Lord? ** O Christ, leave me not alone, who hath given birth to Thee!”", "p12 Praises Stavrotheotokion", { sourceLabel: "Stavrotheotokion", type: "stavrotheotokion", label: "stavrotheotokion", label_inline: true }),
      great_doxology_rubric: nu1("The great Doxology: If a small Doxology is read, and a Doxasticon is appointed, the following is chanted after the Aposticha:", "p12 great Doxology rubric"),
      doxology_glory: nu2("Thy sacred celebration * hath today shone forth * more brilliantly than the sun, * illumining those in darkness, * and vanquishing the gloomy mist of the demons, ** O right wondrous one.", "p12 Doxology Glory", { sourceLabel: "Glory ..., in Tone VI", tone: 6, label: "glory" }),
      doxology_closer_rubric: nu1("Both now ..., Theotokion or Stavrotheotokion:", "p12 Doxology Both now"),
      troparion_rubric: nu1("After Our Father ..., the Troparion of the venerable mother, in Tone VIII:", "p12 after Our Father"),
      closer: { absent: true, reason: "not_printed_in_source", basis: "close_reading", note: "Slot printed as “Glory ..., Both now ..., Theotokion or Stavrotheotokion:” with no text — the conditional closer (§5.8)." },
      closing_rubric: nu1("The Dismissal:", "p12 Dismissal"),
    },
    ...
    liturgy: {
      order: ['beatitudes_rubric', 'beatitudes', 'propers_rubric', 'troparion',
              'kontakion', 'prokeimenon', 'prokeimenon_verse', 'epistle',
              'alleluia', 'alleluia_verse', 'gospel', 'communion_verse'],
      beatitudes_rubric: nu1("Typika and Beatitudes.", "p13 Typika and Beatitudes"),
      // Seven of seven byte-identical, no (Twice) — ELEVEN files identical,
      // two variant — "comliest" copied canon→Beatitude (sic both sites).
      beatitudes: [
        nu1("Chosen to be a bride of the Almighty, thou hast made thine abode in the glorious heavenly mansions, from whence floweth forth streams of healing O (name), drying up the flow of passions.", "p13 Beatitude 1", { label: "plain" }),
        nu1("Adorned with the highest devotion to Christ, Who in His compassion, endured the impoverishment of His body, thou didst follow His life-giving words, disdaining the temporal delights of this life.", "p13 Beatitude 2", { label: "plain" }),
        nu1("Blessed with golden wings of virtue, thou didst soar unto the heavenly heights like an immortal dove, O blessed (name).", "p13 Beatitude 3", { label: "plain" }),
        nu1("Having humbled the yearning of the flesh, thou didst become the master of thy passions; and now, O all-honored (name), thou abidest in the passionless calm of heaven.", "p13 Beatitude 4", { label: "plain" }),
        nu1("Thou, O glorious one, accustomed to adoring the image of the Savior, didst observe His saving teaching in both word and deed.", "p13 Beatitude 5", { label: "plain" }),
        nu1("Christ hath shown thee, O mother (name), to be a bedewing cloud sprinkling life upon those who in faith ask it of thee, O glorious one.", "p13 Beatitude 6", { label: "plain" }),
        nu1("Thy Son, O most pure one, in the beauty of His Godhead is the comliest of all mankind, having assumed flesh for our sake.", "p13 Beatitude 7", { label: "theotokion", sourceLabel: "Theotokion", label_inline: true }),
      ],
      propers_rubric: nu1("The Troparion and the Kontakion from the Typicon; but if there be none, chant the following:", "p13 propers rubric"),
      prokeimenon: nu2("Wondrous is God in His saints, * the God of Israel.", "p13 Liturgy Prokeimenon", { sourceLabel: "The Prokeimenon", tone: 4, label_inline: true }),
      prokeimenon_verse: nu1("In the Congregations bless ye God, the Lord, from the wellsprings of Israel.", "p13 Liturgy Prokeimenon verse", { sourceLabel: "Verse", label: "refrain" }),
      // "(GAL. 3:23-29)" — the abbreviation-inside-the-reference class.
      epistle: { heading: 'THE EPISTLE TO THE GALATIANS',
        src: { file: NU, locus: 'p14 Epistle' },
        citation_verbatim: '(GAL. 3:23-29)',
        citation: { book: 'Galatians', chapter: 3, verses: '23-29' },
        citation_basis: 'printed' },
      alleluia: nu2("I waited patiently for the Lord, and He was attentive unto me, * and hearkened unto my supplication.", "p14 Alleluia", { sourceLabel: "Alleluia, in Tone I", tone: 1, label_inline: true }),
      alleluia_verse: nu1("And he brought me out of the pit of misery, out of the mire of clay.", "p14 Alleluia verse", { sourceLabel: "Verse", label: "refrain" }),
      // "ST. LUKE:" — the colon-in-heading sic, THIRD file, new evangelist:
      // the defect belongs to the setting shop, not to a pair.
      gospel: { heading: 'THE GOSPEL ACCORDING TO ST. LUKE:',
        src: { file: NU, locus: 'p14 Liturgy Gospel' },
        citation_verbatim: '(7:36-50)',
        citation: { book: 'Luke', chapter: 7, verses: '36-50' },
        citation_basis: 'printed' },
      // A FOURTH form of the martyric-class communion verse — comma AND a
      // final stop (registered against Martyress's stop-less form).
      communion_verse: nu1("Rejoice in the Lord, O ye righteous, praise is meet for the upright.", "p14 Communion Verse", { sourceLabel: "Communion Verse", label_inline: true }),
    },
  },

  // ─────────────────────────────────────────────────────────────────────────
  // Nuns.pdf — 16pp. (name) ×2 and (names) ×1 — the both-forms plural
  // GENERAL_TAKES_NAME attests, and BOTH (name) sites sit in PLURAL contexts
  // ("Venerable Mothers (name)"): the singular token under a plural noun,
  // captured verbatim. Extraction proven by twelve byte-matches; one
  // OODDEE VVII residue; the corpus's SECOND AND THIRD Cyrillic О homoglyphs
  // (both in the LIC stavrotheotokion), normalized and logged per §2.13.
  //
  //  • THE RUBRIC ANNOUNCES TONE II; THE PAGE PRINTS TONE VIII — the
  //    dogmatic rubric says "the following Dogmatic in Tone II" and the
  //    dogmatic that follows is the Tone VIII family under a Tone VIII
  //    label (sic). A rubric-tone/printed-tone mismatch, first of its kind.
  //  • THE TROPARION IS BYTE-IDENTICAL AT ALL FOUR SITES AND DECLARED AT
  //    TWO TONES — II at Vespers and the Liturgy, VIII at God-is-the-Lord.
  //    The Martyr IV/III class, second instance; tones per site (R-1).
  //  • "Let every breath" genuinely absent AGAIN — the slot's second real
  //    absence, and it pairs with Nun: an absence travelling with a pair.
  //  • Beatitudes seven of seven — TWELVE files identical, two variant.
  Nuns: {
    title: nn1("THE GENERAL VIGIL SERVICE TO TWO OR MORE NUNS.", "p1 title"),
    troparion: nn2("O ye who are beautiful in soul and glorious in Christ, * having betrothed yourselves to the true desire, * and spurned the betrothal of temporal bridegrooms, * ye attained maturity in deeds of virtue, * and were thereby raised to the heights of incorruption, * abounding in riches, ye became the pillars and rule for monastic women. ** Wherefore cease ye never to pray for us who with love celebrate your memory.", "p4 Troparion", { sourceLabel: "Troparion of the venerable mothers, in Tone II", verified_sites: [{"locus": "p4 Vespers dismissal", "tone": 2}, {"locus": "p5 God is the Lord", "tone": 8, "repeat": 2}, {"locus": "p13 after Our Father", "tone": 2}, {"locus": "p14 AT THE LITURGY", "tone": 2}] }),
    kontakion: nn2("Having emaciated your bodies by fasting, * and with ceaseless prayers entreated the Creator, * that ye might obtain * the forgiveness of your sins, * which ye received from God, * attaining thereby the Kingdom of heaven; ** intercede before Christ God for us all.", "p10 Kontakion after Ode VI", { sourceLabel: "Kontakion of the venerable mothers, in Tone II", spec_mel: "Having received the grace ...", tone: 2, verified_sites: [{"locus": "p10 after Ode VI", "tone": 2}, {"locus": "p14 AT THE LITURGY", "tone": 2}] }),
    ikos: nn1("O God, Thou Who dost close and open the abyss, bringing water up into the clouds, and sending rain to water the face of the earth. Grant also my barren soul, and open mine unworthy mouth, and my stuttering tongue, that I may utter worthy words, and hymn Thy venerable ones, whom Thou Thyself hast glorified, in so far as they despised the sweet things of this world, and for Thy sake emaciated their bodies; that by Thy might they might vanquish the devil, wherefore they received from Thee crowns of endurance; and now, standing before Thee in the heavens with all the saints, they unceasingly intercede for us all.", "p10 Ikos", { sourceLabel: "Ikos", label_inline: true }),

    vespers: {
      order: ['lic_rubric', 'lic', 'lic_closer', 'lic_stavrotheotokion',
              'idiomelon_rubric', 'lic_glory', 'dogmatikon_rubric', 'dogmatikon',
              'dogmatikon_alternate',
              'entrance_rubric', 'readings', 'aposticha_rubric', 'aposticha',
              'aposticha_glory', 'aposticha_closer', 'aposticha_stavrotheotokion',
              'troparion_rubric', 'troparion', 'closer', 'closing_rubric'],
      lic_rubric: nn1("On “Lord, I have cried ...,” these Stichera, in Tone I:", "p1 LIC rubric"),
      lic: [
        nn2("Like effulgent beams of light from the heights, * ye enlighten the world with your noetic rays, * driving away the gloom * of the hordes of evil demons; * wherefore we celebrate ** your light-bearing and divine festival.", "p1 LIC 1", { spec_mel: "Joy of the ranks of heaven ...", label: "plain" }),
        nn2("O all-honored ones, having beheld the beauties of paradise, * and been abundantly filled therewith, * ye, have blossomed forth upon the world * like never-fading blooms of godly-understanding; * partaking thereof today with spiritual love, ** we are satiated with all things good for the soul.", "p1 LIC 2", { spec_mel: "Joy of the ranks of heaven ...", label: "plain" }),
        nn2("Ye have been adorned with your life of struggles * and like the sun having radiated upon all, * in the plenitude of ascetic deeds, * ye have thereby being glorified in them, O most honored ones, * taking delight in divine glory ** and praying that we all be saved.", "p1 LIC 3", { spec_mel: "Joy of the ranks of heaven ...", label: "plain" }),
      ],
      lic_closer: nn2("Tempest-tossed on the abyss of transgressions, * fleeing to the calm haven * of thy most pure supplication, * I cry out to thee, O Birthgiver of God: ** Save me, O all-immaculate one, extending thy mighty right hand unto thy servant!", "p1 LIC closer", { sourceLabel: "Glory ..., Both now ..., Theotokion in Tone I", tone: 1, type: "theotokion", label: ["glory", "both_now", "theotokion"] }),
      // TWO Cyrillic О homoglyphs (U+041E), both in this one hymn —
      // normalized per §2.13, logged. Prose on the page — Tier 1.
      lic_stavrotheotokion: nn1("Of old, when thou didst behold thy Son and Master stretching forth His hands upon the Cross, His side pierced by the spear, O pure Mother, thou didst cry out, lamenting: “Woe is me! How is it that Thou sufferest, ridding men of their suffering, O Lover of mankind?”", "p1 LIC Stavrotheotokion", { sourceLabel: "Stavrotheotokion", type: "stavrotheotokion", label: "stavrotheotokion", label_inline: true, homoglyph_log: ["U+041E CYRILLIC CAPITAL O normalized to Latin O twice — at “О pure Mother” and “О Lover of mankind” (p1)"] }),
      idiomelon_rubric: nn1("If an Idiomelon be appointed, Glory ..., in Tone VIII:", "p1 idiomelon rubric"),
      // "who honour you" — British spelling in an American-spelling corpus
      // (sic); reprinted byte-for-byte as the post-Psalm-50 sessional.
      lic_glory: nn2("With the outpouring of tears * ye extinguished the fire of the passions of the flesh, * and having kindled the desire for things divine * and the love of Christ the King, * ye were dispassionately united to Him; * wherefore, having entered now into the noetic palaces, * intercede for those who honour you, ** before the Benefactor.", "p1 Glory idiomelon", { sourceLabel: "If an Idiomelon be appointed, Glory ..., in Tone VIII", tone: 8, label: "glory" }),
      // THE RUBRIC SAYS TONE II; THE PAGE PRINTS THE TONE VIII DOGMATIC
      // under a Tone VIII label. A rubric-tone/printed-tone mismatch — first
      // of its kind in fourteen files (sic register).
      dogmatikon_rubric: nn1("If the Celebration be with a Polyeleos, and not a Resurrection Service, chant the following Dogmatic in Tone II (If the service is a Resurrection service chant the Dogmatic in the Tone for that service ):", "p1 dogmatikon rubric"),
      dogmatikon: nn2("In His love for mankind, the King of heaven appeared on earth * and dwelt among men; * for He Who received flesh from the pure Virgin * and cameth forth from her having received human nature, * is the only Son of God, * twofold in nature but not Hypostasis. * Therefore, proclaiming Him to be truly perfect God and perfect man, * we confess Christ our God. * Him do thou beseech, O unwedded Mother, ** that our souls find mercy!", "p1 Both now dogmatic", { sourceLabel: "Both now ..., in Tone VIII", tone: 8, type: "dogmatic_theotokion", label: "both_now" }),
      // FIFTH site of the Tone VIII dogmatic; the Otherwise is the
      // "O Sovereign lady" of Heirarch/Martyresses, third file. NO
      // stavrotheotokion printed at this block.
      dogmatikon_alternate: nn2("O Sovereign lady, * accept the supplications of thy servants, ** and deliver us from all want and grief.", "p2 Otherwise Theotokion", { sourceLabel: "Otherwise, Theotokion", type: "theotokion", label: "theotokion", label_inline: true }),
      entrance_rubric: nn1("The Entrance. The Prokeimenon of the day. The Three Lessons, if appointed.", "p2 entrance rubric"),
      // Isaiah + Wisdom ×2 under uniform "THE READING IS FROM" headings.
      // Lesson 1 prints "or let them hear" where Nun/Martyress print "our" —
      // even the body defects vary by file. Lesson 3 is the "die early"
      // composite shared with Nun (its "bath not illumined" included).
      readings: [
        { heading: 'THE READING IS FROM ISAIAH',
          src: { file: NN, locus: 'p2 Lesson 1' },
          citation: { book: 'Isaiah', chapter: 43, verses: '9-14' },
          citation_basis: 'identified',
          provenance_note: 'The Unmercenaries Isaiah lesson. This printing reads "or let them hear" where Nun and Martyress print "our" — the correct word, in the file whose siblings corrupt it. Identified; confirm against the page.' },
        { heading: 'THE READING IS FROM THE WISDOM OF SOLOMON',
          src: { file: NN, locus: 'p2 Lesson 2' },
          citation: { book: 'Wisdom of Solomon', chapter: 3, verses: '3:1-3:9' },
          citation_basis: 'identified',
          provenance_note: 'The "souls of the righteous" lesson, derived at 3:1-9 in Monastic. Identified; confirm against the page.' },
        { heading: 'THE READING IS FROM THE WISDOM OF SOLOMON',
          src: { file: NN, locus: 'p2-p3 Lesson 3' },
          citation: { book: 'Wisdom of Solomon', chapter: 4, verses: '4:7, 4:16-5:7' },
          citation_basis: 'identified',
          provenance_note: 'The "die early" composite shared with Nun, "bath not illumined" included. Identified; confirm span against the page.' },
      ],
      aposticha_rubric: nn1("On the Aposticha, these Stichera, in Tone I:", "p3 Aposticha rubric"),
      aposticha: [
        nn2("Having proceeded along the narrow path * that leadeth unto life, * ye preserved tranquility of spirit along the way, * for being fasters, and the glory of the venerable, * ye mightily overcame the snares of demons; * wherefore ye were deemed worthy to inherit the heavenly Kingdom * and now enjoying the delights thereof ** ye behold the never waning beauty therein.", "p3 Aposticha 1", { spec_mel: "Joy of the ranks of heaven ...", tone: 1, label: "plain" }),
        nn2("Wondrous is God in His saints, * the God of Israel.", "p3 Aposticha verse 1", { sourceLabel: "Verse", label: "refrain" }),
        nn2("Your most splendid life astonished the angels * and clearly frightened the raging demons; * brightly adorning the gatherings of the faithful, * enjoining them to ever continue along the path * that leadeth to the heavenly habitations of Christ; * Him do ye beseech * that those who in faith celebrate your all-honored memory, ** be delivered from corruption and misfortunes.", "p3 Aposticha 2", { spec_mel: "Joy of the ranks of heaven ...", label: "plain" }),
        nn2("Precious in the sight of the Lord * is the death of His saints.", "p3 Aposticha verse 2", { sourceLabel: "Verse", label: "refrain" }),
        nn2("Offering daily hymns and praise to Christ, * while dwelling in the desert O venerable ones, * ye gave your souls and thoughts * entirely to God alone, * and like the great Moses, * entered intractable regions; * wherefore ye obtained victory over the invisible enemy ** and become pure receptacles of the divine Spirit.", "p3 Aposticha 3", { spec_mel: "Joy of the ranks of heaven ...", label: "plain" }),
      ],
      // Reprinted byte-for-byte as the Doxasticon — ninth file with the
      // pattern.
      aposticha_glory: nn2("Having loved the Lord and Bridegroom, * and in obedience to His teaching, * the maidens disdained bodily weakness, * and with a pious and fervent spirit, * subdued their passions, * and were thereby led into the heavenly palace, ** ever rejoicing with ye the venerable.", "p3 Aposticha Glory", { sourceLabel: "Glory ..., in Tone IV", tone: 4, label: "glory" }),
      // The "inextinguishable lamp" — byte-identical to Martyresses' two
      // sites: a theotokion now at FOUR sites across two files (registered).
      aposticha_closer: nn2("O thou inextinguishable lamp, * and throne of righteousness * most pure Sovereign Lady: ** pray thou that our souls be saved.", "p3 Aposticha Both now", { sourceLabel: "Both now ..., Theotokion, in Tone IV", tone: 4, type: "theotokion", label: ["both_now", "theotokion"] }),
      aposticha_stavrotheotokion: nn2("“Lament not for Me, O Mother, * beholding Me thy Son and God hanging upon the Tree, * Who hath suspended the earth upon the waters unsupported, * and hath fashioned all creation; * for I shall arise and be glorified, * and shall crush the kingdoms of Hades with strength; * destroying its power * and delivering those in bondage * from its wickedness, * for I am compassionate; * and I shall bring them to My Father, ** in that I am the Lover of mankind.”", "p4 Stavrotheotokion", { sourceLabel: "Stavrotheotokion", type: "stavrotheotokion", label: "stavrotheotokion", label_inline: true }),
      troparion_rubric: nn1("The Troparion from the Typicon; but, if there be none, chant this:", "p4 troparion rubric"),
      closer: { absent: true, reason: "not_printed_in_source", basis: "close_reading", note: "Slot printed as “Glory ..., Both now ..., Theotokion or Stavrotheotokion.” — full stop for the colon, the Nun setting — and no text (§5.8)." },
      closing_rubric: nn1("The Dismissal:", "p4 Dismissal"),
    },
    ...
    matins: {
      order: ['god_is_lord_rubric', 'troparion', 'troparion_closer',
              ...
              'doxology_glory', 'doxology_closer_rubric', 'troparion_rubric',
              'troparion', 'closer', 'closing_rubric'],
      // TONE VIII here, against Tone II at the troparion's three other
      // sites — the byte-identical text under two declared tones (per-site
      // tones in verified_sites; the R-1 finding fires by design).
      god_is_lord_rubric: nn1("On “God is the Lord ...,” the Troparion, in Tone VIII:", "p5 God is the Lord rubric"),
      troparion_closer: { absent: true, reason: "not_printed_in_source", basis: "close_reading", note: "Slot printed as “Glory ..., Both now ..., Theotokion or Stavrotheotokion.” — full stop for the colon here too — and no text (§5.8)." },
      sessional_1_rubric: nn1("After the 1st chanting of the Psalter, the Sessional Hymn, in Tone III:", "p5 sessional 1 rubric"),
      sessional_1: nn2("Ye forsook the beauty of this world, O venerable ones, * having exchanged perishable riches * for those that never pass away * and are manifestly ever present; * wherefore we glorify you, together with all the saints, * and celebrate your sacred memory, * asking that by your intercessions, * O blessed ones, ** we may obtain great mercy.", "p5 Sessional 1", { spec_mel: "Awed by the beauty of thy virginity ...", tone: 3, label: "plain", repeat: 2 }),
      sessional_1_closer: nn1("Beyond understanding and unapproachable is the dread mystery of God wrought in thee, O divinely joyous sovereign Lady; for having conceived the Infinite One, thou didst give birth to Him, clad in the flesh taken from thy most pure blood. Him do thou ever entreat as thy Son, O pure one, that our souls be saved.", "p5 Sessional 1 closer", { sourceLabel: "Glory ..., Both now ..., Theotokion, in Tone III", tone: 3, type: "theotokion", label: ["glory", "both_now", "theotokion"] }),
      sessional_2_rubric: nn1("After the 2nd chanting of the Psalter, the Sessional Hymn, in Tone V:", "p5 sessional 2 rubric"),
      sessional_2: nn2("Having adorned your life with abstinence, * and mortified the passions of the flesh, * ye obtained victory over the assaults of the enemy, * O venerable ones; * appearing as both desert dwellers, * and rational beacons shining in the world; * wherefore, O ye blessed ones, ** entreat the Lord to have mercy on our souls.", "p5 Sessional 2", { spec_mel: "Go thou quickly before ...", tone: 5, label: "plain", repeat: 2 }),
      sessional_2_closer: nn1("Finding thee to be a haven, a bulwark, a refuge, our hope, protection and fervent help, we, the faithful, hasten to thee and cry out earnestly, exclaiming with faith: Have mercy upon those who place their trust in thee, O Theotokos, and deliver us from transgressions.", "p5 Sessional 2 closer", { sourceLabel: "Glory ..., Both now ..., Theotokion, in Tone V", tone: 5, type: "theotokion", label: ["glory", "both_now", "theotokion"] }),
      megalynarion_rubric: nn1("After the Polyeleos, the Megalynarion:", "p5 megalynarion rubric"),
      // "Venerable MOTHERS (name)" — the SINGULAR token under a PLURAL noun,
      // captured verbatim: one of the two (name) sites GENERAL_TAKES_NAME
      // attests in this file.
      megalynarion: nn1("We bless you, O Venerable Mothers (name), and we honor your holy memory, Instructors of Nuns, and conversers with the angels.", "p5 Megalynarion", { label_inline: true }),
      megalynarion_verse: nn1("With patience I waited patiently for the Lord, and He was attentive unto me, and He hearkened unto my supplication.", "p5 Megalynarion verse", { sourceLabel: "Verse", label: "refrain" }),
      sessional_polyeleos_rubric: nn1("After the Polyeleos, the Sessional Hymn, in Tone VIII:", "p6 post-Polyeleos sessional rubric"),
      sessional_polyeleos: nn2("Keeping vigil in secret prayers * and finding delight in God inspired writings, O blessed ones, * ye took upon your shoulders the cross of the Lord, * and following Him in abstinence, * ye trampled down the deceit of the serpent, * crying out unto Christ: ** O heavenly Bridegroom, be Thou our foundation.", "p6 post-Polyeleos Sessional", { spec_mel: "That which was mystically commanded ...", tone: 8, label: "plain", repeat: 2 }),
      sessional_polyeleos_closer: nn2("O Good One, Who for our sake wast born of the Virgin * and, having endured crucifixion, cast down death by death, * and as God revealed the resurrection: * disdain not that which Thou hast fashioned with Thine own hand. * Show forth Thy love for mankind, O Merciful One; * Accept the supplications of the Theotokos who bore Thee, ** and save Thy despairing people, O our Savior!", "p6 post-Polyeleos Sessional closer", { sourceLabel: "Glory ..., Both now ..., Theotokion, in Tone VIII", tone: 8, type: "theotokion", label: ["glory", "both_now", "theotokion"] }),
      anabathmoi_rubric: nn1("If of Polyeleos rank, and not a Resurrection Service, chant the following:", "p6 anabathmoi rubric"),
      anabathmoi_intro: nn1("The Song of Ascents: The first antiphon, in Tone IV:", "p6 anabathmoi heading"),
      anabathmoi: [
        nn2("From my youth * do many passions war against me; * but do Thou Thyself defend ** and save me, O my Savior.", "p6 Anabathmoi 1", { label: "plain" }),
        nn2("Ye haters of Zion * shall be shamed by the Lord; * for like grass, by the fire ** shall ye be withered.", "p6 Anabathmoi 2", { label: "plain" }),
      ],
      anabathmoi_closer: nn2("In the Holy Spirit, * every soul is quickened, * and, through cleansing, is exalted ** and made radiant by the Triple Unity in a hidden sacred manner.", "p6 Anabathmoi closer", { sourceLabel: "Glory ..., Both now ...,", type: "plain", label: ["glory", "both_now"] }),
      prokeimenon_rubric: nn1("Prokeimenon, in Tone IV:", "p6 prokeimenon rubric"),
      prokeimenon: nn2("Wondrous is God in His saints, * the God of Israel.", "p6 Prokeimenon", { sourceLabel: "The Prokeimenon", tone: 4, label_inline: true }),
      prokeimenon_verse: nn1("In the Congregations bless ye God, the Lord, from the wellsprings of Israel.", "p6 Prokeimenon verse", { sourceLabel: "Verse", label: "refrain" }),
      // Genuinely absent AGAIN — the second real absence at this slot, and
      // it pairs with Nun: an absence that travels with a pair.
      gospel_rubric: { absent: true, reason: "not_printed_in_source", basis: "close_reading", note: "No “Let every breath …” line — the Gospel heading follows the prokeimenon verse directly, as in Nun. The pair share the absence." },
      gospel: { heading: 'THE GOSPEL ACCORDING TO ST. MATTHEW',
        src: { file: NN, locus: 'p6-p7 Matins Gospel' },
        citation_verbatim: '(25, 1-13)',
        citation: { book: 'Matthew', chapter: 25, verses: '1-13' },
        citation_basis: 'printed',
        provenance_note: 'The ten-virgins pericope shared with Nun — but this body opens "The Lord spake a parable saying:" where Nun prints "The Lord said:". Even shared incipits vary (unstored body text).' },
      psalm50_rubric: nn1("After the 50th Psalm:", "p7 After the 50th Psalm"),
      // "the venerable mothers (name)" — the second singular-under-plural
      // site.
      psalm50_sticheron: nn2("Through the prayers of the venerable mothers (name), * O Merciful One, ** blot out the multitude of our transgressions.", "p7 Psalm 50 Glory", { sourceLabel: "Glory ..., in Tone VI", tone: 6, label: "glory" }),
      psalm50_closer: nn2("Through the prayers of the Theotokos, * O Merciful One, ** blot out the multitude of our transgressions.", "p7 Psalm 50 Both now", { sourceLabel: "Both now ...,", type: "theotokion", label: "both_now" }),
      psalm50_verse: nn2("Have mercy on me, O God, * according to Thy great mercy; * and according to the multitude of Thy compassions, ** blot out my transgressions.", "p7 Psalm 50 verse", { label: "refrain" }),
      sessional_post50_rubric: nn1("Then the Sessional Hymn, in Tone II:", "p7 post-Psalm-50 sessional rubric"),
      // The idiomelon Glory byte-for-byte — "who honour you" included
      // (sic at both sites): the Nun pattern, in the pair.
      sessional_post50: nn2("With the outpouring of tears * ye extinguished the fire of the passions of the flesh, * and having kindled the desire for things divine * and the love of Christ the King, * ye were dispassionately united to Him; * wherefore, having entered now into the noetic palaces, * intercede for those who honour you, ** before the Benefactor.", "p7 post-Psalm-50 Sessional", { tone: 2, label: "plain" }),
      canon_rubric: nn1("The Canon, in Tone VIII:", "p7 Canon rubric"),
      canons: [{
        title: "The Canon, in Tone VIII:", tone: 8,
        odes: {
          1: {
            irmos: nn2("The wonderworking staff of Moses, * striking and dividing the sea in the figure of a cross, * once drowned Pharaoh the pursuing charioteer, * while it saved the fleeing people of Israel * as they fled on foot, * chanting a hymn unto God.", "p7 Ode 1 irmos", { sourceLabel: "Irmos", label_inline: true }),
            refrain: nn1("Venerable mothers (names) pray to God for us", "p7 Ode 1 refrain", { sourceLabel: "Refrain", label_inline: true }),
            items: [
              nn1("In bodily weakness, O venerable mothers, ye humbled the powerful enemy and untied yourselves to God, entreat Him to grant strength unto us all.", "p7 Ode 1 troparion 1", { label: "plain" }),
              nn1("Awestruck by the comeliness of the Bridegroom and following Him in accordance with the psalmist, ye followed in His life-bearing footsteps, whereby ye humbled the wicked serpent.", "p7 Ode 1 troparion 2", { label: "plain" }),
              nn1("O venerable ones, ye adorned your souls by withering the fairness of your bodies with labors of abstinence; and have now, together with Christ the Bridegroom, entered the splendid chambers.", "p7 Ode 1 troparion 3", { label: "plain" }),
              nn1("Thy womb, O Virgin, was shown to be a splendid receptacle for the merciful Lord, Who became incarnate from thee, illumining all things with the rays of the knowledge of God.", "p7 Ode 1 Theotokion", { sourceLabel: "Theotokion", label: "theotokion", label_inline: true }),
            ],
          },
          3: {
            irmos: nn2("O Lord, Creator of the vault of Heaven * and Builder of the Church, * do Thou strengthen me in Thy love, O Summit of desire, * O Support of the faithful, * O only Lover of mankind.", "p8 Ode 3 irmos", { sourceLabel: "Irmos", label_inline: true }),
            items: [
              nn1("O most honored ones, despising the fairness of the body, ye counted transitory glory to be but a dream, and with humility and watchfulness, sought and found God, O ye godly blessed ones.", "p8 Ode 3 troparion 1", { label: "plain" }),
              nn1("The sacred relics of the venerable ones radiate cures unto those who approach them with faith, for they draw forth healing from the wellspring of grace, the Savior, Whose voluntary passion they emulated.", "p8 Ode 3 troparion 2", { label: "plain" }),
              nn1("Having rejected the world and fleshly wisdom, and by the pangs of abstinence, acquired Christ the most pure Bridegroom, ye were granted to rejoice in the divine heavenly palaces.", "p8 Ode 3 troparion 3", { label: "plain" }),
              nn1("The sacred clarions of the holy prophets of old, announced beforehand, O most pure Virgin, that thou wouldst give birth unto the Light, as the living book in which the Word, transcending speech, was written without hands.", "p8 Ode 3 Theotokion", { sourceLabel: "Theotokion", label: "theotokion", label_inline: true }),
            ],
          },
          4: {
            irmos: nn2("O Lord, I have heard the mystery of Thy dispensation; * I have considered Thy works, * and I have glorified Thy Divinity.", "p8 Ode 4 irmos", { sourceLabel: "Irmos", label_inline: true }),
            items: [
              nn1("Having withered the beauty of the body by asceticism, the holy women behold now the most pure beauty of their beloved Bridegroom.", "p8 Ode 4 troparion 1", { label: "plain" }),
              nn1("Having put off sleep from the eyelids of your souls, O sacred women, ye have put to sleep the needs of your bodies through abstinence.", "p9 Ode 4 troparion 2", { label: "plain" }),
              nn1("Your radiant festival, beaming with the light of the Divine Spirit, doth illumine the souls of us who in faith honour you, O venerable ones.", "p9 Ode 4 troparion 3", { label: "plain" }),
              nn1("Having conceived abiding love for Thee, O Lord, Who assumed flesh from the most pure Virgin, and moved by divine love, the venerable woman followed in the fragrant wake of Thy myrrh.", "p9 Ode 4 Theotokion", { sourceLabel: "Theotokion", label: "theotokion", label_inline: true }),
            ],
          },
          5: {
            irmos: nn2("O Light never-waning, * why hast Thou turned Thy face from me * and why hath the alien darkness surrounded me, * wretched though I be? * But do Thou guide my steps I implore Thee * and turn me back towards the light of Thy commandments.", "p9 Ode 5 irmos", { sourceLabel: "Irmos", label_inline: true }),
            items: [
              nn1("Dispelling the fog of all sicknesses by the power of the Holy Spirit, O all-honored ones, by the most glorious effulgence of your miracles, ye turn the faithful towards the light of the heavenly Kingdom.", "p9 Ode 5 troparion 1", { label: "plain" }),
              nn1("Having died to the world, and been blessed by God, ye have inherited immortal life and been deemed worthy of the divine bridal chambers, O all-honored ones, since ye preserved your lamps un-extinguished, with the oil of your ascetic struggles.", "p9 Ode 5 troparion 2", { label: "plain" }),
              nn1("Neglecting quickly waning and corruptible life, and being blessed by God, ye abandoned it to those remaining on earth, for having bound yourselves with spiritual love, ye now dwell in the habitations of the righteous.", "p9 Ode 5 troparion 3", { label: "plain" }),
              nn1("God the Word, Who preserved thee a Virgin, O thou who knewest not wedlock, voluntarily made His abode within the womb, and was seen as a man, O most pure one; and desiring Him, the maidens followed Him by the asceticism of their splendid life.", "p9 Ode 5 Theotokion", { sourceLabel: "Theotokion", label: "theotokion", label_inline: true }),
            ],
          },
          6: {
            irmos: nn2("I will pour out my prayer unto the Lord, * and to Him will I proclaim my grief; * for my soul is filled with evils, * and my life unto Hades hath drawn nigh, * and like Jonah I pray unto Thee: * Raise me up from corruption, O God.", "p9 Ode 6 irmos", { sourceLabel: "Irmos", label_inline: true }),
            items: [
              nn1("Abstinent and humble of heart, watchful and merciful, understanding in the faith and full of perfect love, O sacred women, ye became temples of God and a source of inexhaustible healings.", "p9 Ode 6 troparion 1", { label: "plain" }),
              nn1("O honored ones, ye spurned the sweet things of life, and endured the pangs of asceticism for the sake of Him Who descended to earth and for our sake lived without a dwelling-place; wherefore, O right wondrous ones, ye have found a hospitable dwelling-place in the Heavens.", "p9 Ode 6 troparion 2", { label: "plain" }),
              nn1("O all-honored ones, with many vigils ye lulled to sleep the soul-corrupting passions, and now worthily rest with the righteous, making intercession for the world.", "p10 Ode 6 troparion 3", { label: "plain" }),
              nn1("I know thee, O Virgin, to be an intercessor and powerful protector, driving away the temptations, and extinguishing the assaults of the demons; wherefore I ever beseech thee, deliver me from the corruption of my passions.", "p10 Ode 6 Theotokion", { sourceLabel: "Theotokion", label: "theotokion", label_inline: true }),
            ],
          },
          7: {
            irmos: nn2("The Children of Judaea, * who of old came to dwell in Babylon, * trampled underfoot the flame of the furnace * through their faith in the Trinity, * as they sang: “O God of our fathers, blessed art Thou.”", "p10 Ode 7 irmos", { sourceLabel: "Irmos", label_inline: true }),
            items: [
              nn1("By love, the venerable ones transformed perishable glory into incorruptible glory, and delighting, rejoicing, and exulting therein, they chant: “O God of our fathers, blessed art Thou.”", "p10 Ode 7 troparion 1", { label: "plain" }),
              nn1("Ye have been revealed to be multi-lustrous stars, illumining the souls of the faithful with the light of your labors, and teaching them to chant: “O God of our fathers, blessed art Thou.”", "p10 Ode 7 troparion 2", { label: "plain" }),
              nn1("Ye have been revealed to be like a river of healings, drowning the sea of sufferings and saving those who chant: “O God of our fathers, blessed art Thou.”", "p10 Ode 7 troparion 3", { label: "plain" }),
              nn1("Release my wretched soul from the bonds of sin and unite it with the perfect love of God, O Birthgiver of God, that I may glorify thee in faith and hymn thee throughout the ages.", "p10 Ode 7 Theotokion", { sourceLabel: "Theotokion", label: "theotokion", label_inline: true }),
            ],
          },
          8: {
            irmos: nn2("By Thy grace the children became vanquishers * of both the tyrant and the flames, * carefully observing Thy commandments, * wherefore they cried aloud: * Bless the Lord, all ye works of the Lord!", "p10 Ode 8 irmos", { sourceLabel: "Irmos", label_inline: true }),
            items: [
              nn1("The virgins subjected the irrational passions to the mind and noetically united with the Bridegroom and Word, chant: “Bless the Lord, all ye works of the Lord, and supremely exalt Him throughout the ages.”", "p11 Ode 8 troparion 1", { label: "plain" }),
              nn1("Having been crucified unto the world and pierced with divine love, the sacred virgins wounded with the arrows of abstinence, him who wounded Eve through the tasting of the bitter fruit, hymning Christ throughout the ages.", "p11 Ode 8 troparion 2", { label: "plain" }),
              nn1("O venerable ones, ye subjected the irrational lusts to reason, and blamelessly betrothed yourselves, O honored ones, to the Bridegroom and Word, chanting: “Bless the Lord, all ye works of the Lord, and supremely exalt Him throughout the ages.”", "p11 Ode 8 troparion 3", { label: "plain" }),
              nn1("Having from thy pure blood given birth to Jesus in the flesh, O most pure Virgin Mother, thou didst gather together all the virgins and cry aloud with them: “Bless the Lord, all ye works of the Lord, and supremely exalt Him throughout the ages.”", "p11 Ode 8 Theotokion", { sourceLabel: "Theotokion", label: "theotokion", label_inline: true }),
            ],
          },
          9: {
            irmos: nn2("Saved by thee, O pure Virgin, * we confess thee to be truly the Theotokos, * and together with the choirs of the bodiless hosts * thee do we magnify.", "p11 Ode 9 irmos", { sourceLabel: "Irmos", label_inline: true }),
            items: [
              nn1("O ye beautiful and divinely speaking turtle-doves and splendid and pure swallows, ye were brought into the heavenly palaces unto the all-comely Master.", "p11 Ode 9 troparion 1", { label: "plain" }),
              nn1("Numbered with the choirs on high, ye have made your abode among the assemblies of the elect, ever entreating the compassionate and loving God on our behalf.", "p11 Ode 9 troparion 2", { label: "plain" }),
              nn1("The memory of the venerable women hath shone forth throughout the world, enlightening the thoughts of the faithful who ever magnify Christ.", "p11 Ode 9 troparion 3", { label: "plain" }),
              nn1("Being the receptacle of the Light, O Virgin, enlighten my soul, darkened by the passions, that I may be delivered from the outer darkness by thine intercessions.", "p11 Ode 9 Theotokion", { sourceLabel: "Theotokion", label: "theotokion", label_inline: true }),
            ],
          },
        },
      }],
      sessional_ode3_rubric: nn1("The Sessional Hymn, in Tone IV:", "p8 post-Ode-III sessional rubric"),
      sessional_ode3: nn2("Having taken upon your shoulders the cross of Christ, * O all-splendid and venerable ones, * ye have faithfully followed Him in your ascetic endeavors * and been manifest as the rule of women monastics; * and having now inherited the Kingdom on high * by your divine labors, ** unceasingly pray that our souls be saved.", "p8 post-Ode-III Sessional", { tone: 4, label: "plain" }),
      // "The Word of the Father" — Heirarch's "incarnate of thee" form,
      // SIXTH site of the family (registered).
      sessional_ode3_closer: nn2("The Word of the Father, Christ our God, * Who was incarnate of thee, * we have come to know, O Virgin Theotokos, * who alone art pure, who alone art blessed. ** Wherefore, we unceasingly hymn and magnify thee.", "p8 post-Ode-III Sessional closer", { sourceLabel: "Glory ..., Both now ..., Theotokion, in Tone IV", tone: 4, type: "theotokion", label: ["glory", "both_now", "theotokion"] }),
      sessional_ode3_stavrotheotokion: nn2("She who in latter times gave birth to Thee in the flesh, * O Christ Who wast begotten of the beginningless Father, * when she saw Thee hanging upon the Cross, cried out: * “Woe is me, O Jesus most beloved! * How is it that Thou Who art worshipped as God by the angels, * art now crucified by iniquitous men? ** I hymn Thee, O Long-suffering One!”", "p8 post-Ode-III Stavrotheotokion", { sourceLabel: "Stavrotheotokion", type: "stavrotheotokion", label: "stavrotheotokion", label_inline: true }),
      kontakion_rubric: nn1("The Kontakion from the Typicon; if there be none, chant the following:", "p10 kontakion rubric"),
      exapostilarion_rubric: nn1("Exapostilarion in Tone III:", "p11 exapostilarion rubric"),
      exapostilarion: nn1("O venerable and all-honored ones, by your supplications unto God, deliver from every evil circumstance those who with love and gratitude celebrate your memory, and cleanse the defilement of my soul, despite the little I have hymned you.", "p11 Exapostilarion", { tone: 3, label: "plain" }),
      // A BARE "Theotokion:" closer label — no Glory, no Both-now: a new
      // closer-label form at this position.
      exapostilarion_closer: nn1("Cease not, O Virgin, to intercede for us to thy Son and God, the Lover of mankind; for in thee we have placed our hope, and by thine entreaties we who glorify thee in faith, obtain deliverance from every evil circumstance, suffering, transgression, and infirmity.", "p11 Exapostilarion closer", { sourceLabel: "Theotokion:", type: "theotokion", label: "theotokion", label_inline: true }),
      praises_rubric: nn1("On the Praises, these Stichera, in Tone IV:", "p12 Praises rubric"),
      // The Praises are PROSE ON THE PAGE — no pointing marks in any of the
      // three: Tier 1 throughout, first file so printed.
      praises: [
        nn1("Having preserved your virginity inviolate O venerable ones, and led an unspotted and pure life, ye obtained spiritual riches, fulfilling the law of Christ, Whom you followed, leaving the earth and everything that is therein; wherefore Jesus, the Lover of mankind and Savior of our souls, hath granted you heavenly riches and the kingdom of heaven.", "p12 Praises 1", { spec_mel: "Thou hast given a sign ...", tone: 4, label: "plain", repeat: 2 }),
        nn1("As lovers of spiritual wisdom, ye revealed within yourselves the active and immortal aspects of the soul; whereby ye strove to spurn the bonds of the flesh and remain free from every pollution of sin and from every impurity, that without spot or wrinkle, O ye god-pleasing women, ye may stand before your Bridegroom pure and undefiled.", "p12 Praises 2", { spec_mel: "Thou hast given a sign ...", label: "plain" }),
        nn1("Your radiant countenances were effulgently illumined upon your repose, O all-famed ones, for Christ glorified you as His godly-spoken, holy, compassionate, and venerable ones; having lived on earth the life of angels, and pleased God with the splendor of your life.", "p12 Praises 3", { spec_mel: "Thou hast given a sign ...", label: "plain" }),
      ],
      // "Glory ..., Tone I:" — the label MISSING its "in": a new label form
      // (stored verbatim).
      praises_glory: nn1("Through abstinence and labors ye laid aside all fleshly cares, O ye venerable ones, and hastening up to the heavenly habitations, ye now enjoy the ineffable goodness beloved by you.", "p12 Praises Glory", { sourceLabel: "Glory ..., Tone I", tone: 1, label: "glory" }),
      praises_closer: nn2("Rejoice, O holy Virgin Theotokos * who art one of us, * thou pure vessel of all the world, * inextinguishable lamp, * dwelling-place of the Boundless One, * indestructible temple! * Rejoice, thou from whom the Lamb of God was born, ** who taketh away the sins of all the world.", "p12 Praises Both now", { sourceLabel: "Both now ..., Theotokion in Tone I", tone: 1, type: "theotokion", label: ["both_now", "theotokion"] }),
      praises_stavrotheotokion: nn2("Upon beholding the Lamb * lifted up upon the Cross, * the immaculate Virgin cried aloud, weeping: * “O my Child most sweet, * what is this new and most glorious sight? * How is it that Thou Who holdest all things in Thy hand ** hast been nailed to the Tree in the flesh?”", "p12 Praises Stavrotheotokion", { sourceLabel: "Stavrotheotokion", type: "stavrotheotokion", label: "stavrotheotokion", label_inline: true }),
      great_doxology_rubric: nn1("The great Doxology: If a small Doxology is read, and a Doxasticon is appointed, the following is chanted after the Aposticha:", "p12 great Doxology rubric"),
      doxology_glory: nn2("Having loved the Lord and Bridegroom, * and in obedience to His teaching, * the maidens disdained bodily weakness, * and with a pious and fervent spirit, * subdued their passions, * and were thereby led into the heavenly palace, ** ever rejoicing with ye the venerable.", "p12 Doxology Glory", { sourceLabel: "Glory ..., in Tone IV", tone: 4, label: "glory" }),
      doxology_closer_rubric: nn1("Both now ..., Theotokion or Stavrotheotokion:", "p12 Doxology Both now"),
      troparion_rubric: nn1("After Our Father ..., the Troparion of the venerable mothers, in Tone II:", "p13 after Our Father"),
      closer: { absent: true, reason: "not_printed_in_source", basis: "close_reading", note: "Slot printed as “Glory ..., Both now ..., Theotokion or Stavrotheotokion:” with no text — the conditional closer (§5.8)." },
      closing_rubric: nn1("The Dismissal:", "p13 Dismissal"),
    },
    ...
    liturgy: {
      order: ['beatitudes_rubric', 'beatitudes', 'propers_rubric', 'troparion',
              'kontakion', 'prokeimenon', 'prokeimenon_verse', 'epistle',
              'alleluia', 'alleluia_verse', 'gospel', 'communion_verse'],
      beatitudes_rubric: nn1("Typika and Beatitudes.", "p14 Typika and Beatitudes"),
      // Seven of seven byte-identical, no (Twice) — TWELVE files identical,
      // two variant.
      beatitudes: [
        nn1("O most honored ones, despising the fairness of the body, ye counted transitory glory to be but a dream, and with humility and watchfulness, sought and found God, O ye godly blessed ones.", "p14 Beatitude 1", { label: "plain" }),
        nn1("The sacred relics of the venerable ones radiate cures unto those who approach them with faith, for they draw forth healing from the wellspring of grace, the Savior, Whose voluntary passion they emulated.", "p14 Beatitude 2", { label: "plain" }),
        nn1("Having rejected the world and fleshly wisdom, and by the pangs of abstinence, acquired Christ the most pure Bridegroom, ye were granted to rejoice in the divine heavenly palaces.", "p14 Beatitude 3", { label: "plain" }),
        nn1("Abstinent and humble of heart, watchful and merciful, understanding in the faith and full of perfect love, O sacred women, ye became temples of God and a source of inexhaustible healings.", "p14 Beatitude 4", { label: "plain" }),
        nn1("O honored ones, ye spurned the sweet things of life, and endured the pangs of asceticism for the sake of Him Who descended to earth and for our sake lived without a dwelling-place; wherefore, O right wondrous ones, ye have found a hospitable dwelling-place in the Heavens.", "p14 Beatitude 5", { label: "plain" }),
        nn1("O all-honored ones, with many vigils ye lulled to sleep the soul-corrupting passions, and now worthily rest with the righteous, making intercession for the world.", "p14 Beatitude 6", { label: "plain" }),
        nn1("I know thee, O Virgin, to be an intercessor and powerful protector, driving away the temptations, and extinguishing the assaults of the demons; wherefore I ever beseech thee, deliver me from the corruption of my passions.", "p14 Beatitude 7", { label: "theotokion", sourceLabel: "Theotokion", label_inline: true }),
      ],
      propers_rubric: nn1("The Troparion and Kontakion from the Typicon; but if there be none chant the following:", "p14 propers rubric"),
      prokeimenon: nn2("Wondrous is God in His saints, * the God of Israel.", "p15 Liturgy Prokeimenon", { sourceLabel: "The Prokeimenon", tone: 4, label_inline: true }),
      prokeimenon_verse: nn1("In the Congregations bless ye God, the Lord, from the wellsprings of Israel.", "p15 Liturgy Prokeimenon verse", { sourceLabel: "Verse", label: "refrain" }),
      epistle: { heading: 'THE EPISTLE TO THE GALATIANS',
        src: { file: NN, locus: 'p15 Epistle' },
        citation_verbatim: '(GAL. 3:23-29)',
        citation: { book: 'Galatians', chapter: 3, verses: '23-29' },
        citation_basis: 'printed',
        provenance_note: 'Heading, reference format and lesson shared byte-for-byte with Nun — the pair share their epistle setting.' },
      alleluia: nn2("I waited patiently for the Lord, and He was attentive unto me, * and hearkened unto my supplication.", "p15 Alleluia", { sourceLabel: "Alleluia, in Tone I", tone: 1, label_inline: true }),
      alleluia_verse: nn1("And he brought me out of the pit of misery, out of the mire of clay.", "p15 Alleluia verse", { sourceLabel: "Verse", label: "refrain" }),
      gospel: { heading: 'THE GOSPEL ACCORDING TO ST. LUKE:',
        src: { file: NN, locus: 'p15-p16 Liturgy Gospel' },
        citation_verbatim: '(7:36-50)',
        citation: { book: 'Luke', chapter: 7, verses: '36-50' },
        citation_basis: 'printed',
        provenance_note: 'The ST. LUKE: colon heading — the sic\'s FOURTH file.' },
      // Back to the SEMICOLON-AND-CAPITAL form ("righteous be; He") — the
      // Martyr/Heirarchs-class communion verse, not the martyric-female one
      // (registered).
      communion_verse: nn1("In everlasting remembrance shall the righteous be; He shall not be afraid of evil tidings.", "p16 Communion Verse", { sourceLabel: "Communion Verse", label_inline: true }),
    },
  },
  Hieromartyr: {
    title: hm1("THE GENERAL VIGIL SERVICE TO ONE HIEROMARTYR", 'p1 title'),

    // Printed byte-identically at FOUR sites (verified by the generator),
    // all Tone IV — but the LABEL capitalisation varies: p4 and p13 print
    // "In Tone IV" with a capital I (see the sIn-Tone find-replace note in
    // the readings). One stored field per R-1; tone per site.
    troparion: hm2("As thou didst share in the ways of the apostles * and didst occupy their throne, * thou didst find thine activity to be a passage to divine vision, * O divinely inspired one. * Wherefore, ordering the word of truth, * thou didst suffer for the Faith even to the shedding of thy blood, ** O Hieromartyr (name), entreat Christ God, that our souls be saved.", "p4 Troparion", { sourceLabel: "Troparion, In Tone IV", verified_sites: [{"locus": "p4 Vespers dismissal", "tone": 4}, {"locus": "p5 God is the Lord", "tone": 4, "repeat": 2}, {"locus": "p12 after Our Father", "tone": 4}, {"locus": "p13 AT THE LITURGY", "tone": 4}] }),
    kontakion: hm2("As one who lived piously among hierarchs and who underwent martyrdom, * thou, O divinely-wise one, hast extinguished the sacrifices of idolatry * and shown thyself to be a protector of thy flock. * Wherefore, in honor we fervently cry out unto thee: * Do thou, through thine intercessions, * ever deliver us from all misfortunes, ** O (name), our Father.", "p9 Kontakion after Ode VI", { sourceLabel: "Kontakion of the Hieromartyr, in Tone IV", spec_mel: "Having been lifted up ...", tone: 4, verified_sites: [{"locus": "p9 after Ode VI", "tone": 4}, {"locus": "p13 AT THE LITURGY", "tone": 4}] }),
    ikos: hm1("Faithfully and with love we draw together in celebration of the memory of the sacred sufferer (name), let us praise him today in song that we may obtain the enjoyment of his grace, for he, as a martyr and faithful hierarch and champion of the faith, delivereth the souls of those that fervently beseech him, from all passions and pitfalls; wherefore let us cry out unto him: Through thine intercessions do thou ever deliver us from misfortunes, O (name), our Father.", "p9 Ikos", { sourceLabel: "The Ikos", label_inline: true }),
    ...
    vespers: {
      order: ['lic_rubric', 'lic', 'lic_closer', 'lic_stavrotheotokion',
              ...
              'aposticha_closer', 'aposticha_alternate', 'aposticha_stavrotheotokion',
              'troparion_rubric', 'troparion', 'closer', 'closing_rubric'],
      lic_rubric: hm1("On “Lord, I have cried ...,” the Stichera, in Tone I:", 'p1 LIC rubric'),
      lic: [
        hm2("O Divinely-wise, and blessed (name), * brightening thy sacred and divine vestments * with the purple of thy blood, * thou didst ascend * from strength to virtuous strength * and from glory to greater glory; * do thou now entreat the Lord * that peace and great mercy ** may be granted to our souls.", "p1 LIC 1", { spec_mel: "O all-praised Martyrs ...", label: "plain", tone: 1 }),
        hm2("As a truly lawful priest * thou didst first offer unto God * the bloodless sacrifice, * then as a most true Martyr * by the spilling of thy blood * thou didst offer thyself unto Christ * as a whole-burnt and acceptable sacrifice, * O godly-spoken and all-honored one ** entreat Him on behalf of those who hymn thee.", "p1 LIC 2", { spec_mel: "O all-praised Martyrs ...", label: "plain" }),
        hm2("By thy precepts and teaching, * O holy Father, * thou hast brought unto Christ legions of martyrs, * not only by instructing and teaching in word, * but by offering thyself as an example, * O divinely-wise one; * pray together with them * that peace and great mercy ** be granted to our souls.", "p1 LIC 3", { spec_mel: "O all-praised Martyrs ...", label: "plain" }),
      ],
      lic_closer: hm2("Tempest-tossed on the abyss of transgressions, * fleeing to the calm haven * of thy most pure supplication, * I cry out to thee, O Theotokos: ** Save me, O all-immaculate one, extending thy mighty right hand unto thy servant!", "p1 LIC closer", { sourceLabel: "Glory ..., Both now ..., Theotokion, in Tone I", tone: 1, type: "theotokion", label: ["glory", "both_now", "theotokion"] }),
      lic_stavrotheotokion: hm2("Standing at the foot of the Cross * of thy Son and God, * and looking upon His long-suffering, * O pure Mother, * weeping, thou didst say: * “Woe is me, O my sweetest Child! * How is it that Thou sufferest these things unjustly, * O Word of God, ** that Thou mayest save mankind?”", "p1 Stavrotheotokion", { sourceLabel: "Stavrotheotokion", type: "stavrotheotokion", label: "stavrotheotokion", label_inline: true }),
      // “Glory,” with no ellipsis after it — the only idiomelon rubric so far
      // to drop the “...,”.
      idiomelon_rubric: hm1("If an Idiomelon be appointed, Glory, in Tone VI:", 'p1 idiomelon rubric'),
      lic_glory: hm2("O blessed (name), * performing the divine and ineffable mysteries unto the very end * thou didst remain a most lawful vicar of Christ, * thereupon shedding thine own blood for Christ our God, * offering thyself as a sacrifice well pleasing to Him; * wherefore having boldness before Christ, * do thou ever intercede on behalf of those who in faith and with love honor thy most venerable memory, * that they be saved from all dangers, ** misfortunes and attacks of the enemy.", "p1 Glory idiomelon", { sourceLabel: "Glory, in Tone VI", tone: 6, label: "glory" }),
      // The travelling “service ):” space — its FOURTH file.
      dogmatikon_rubric: hm1("If the Celebration be with a Polyeleos, and not a Resurrection Service, sing the following Dogmatic in Tone VI (If the service is a Resurrection service sing the Dogmatic of the Tone for that service ):", 'p1 dogmatikon rubric'),
      dogmatikon: hm2("Who doth not call thee blessed, O most holy Virgin? * Who will not hymn thy most pure birthgiving? * For the only-begotten Son Who hath shone forth timelessly from the Father, * came forth, ineffably incarnate, from thee, O pure one; * By nature he is God, by nature for our sakes, he hath become a man * not divided into two Hypostases, * but known in two natures without commingling. * Him do thou beseech, O pure and most blessed one, ** that our souls find mercy!", "p2 Both now dogmatic", { sourceLabel: "Both now ..., in Tone VI", tone: 6, type: "dogmatic_theotokion", label: "both_now" }),
      dogmatikon_alternate: hm2("We have come to know God * Who was incarnate of thee, * O Virgin Theotokos. ** Him do thou entreat for the salvation of our souls.", "p2 Otherwise Theotokion", { sourceLabel: "Otherwise, Theotokion", type: "theotokion", label: "theotokion", label_inline: true }),
      // “O my Son How is it that Thou diest?,” — the diest-family defect,
      // FOURTH file (sic register).
      dogmatikon_stavrotheotokion: hm2("Upon seeing Thee crucified, O Christ, * she who gaveth birth to Thee cried aloud: * “What is this strange mystery that I see, * O my Son How is it that Thou diest?, * suspended upon the Tree, ** O Bestower of life?”", "p2 Stavrotheotokion", { sourceLabel: "Stavrotheotokion", type: "stavrotheotokion", label: "stavrotheotokion", label_inline: true }),
      entrance_rubric: hm1("The Entrance. The Prokeimenon of the day. The Three Lessons, if appointed.", 'p2 Entrance rubric'),
      // Lesson bodies are not stored (R-4) — but this file's Wisdom 5 body
      // prints the "cast as out of a sIn Tone bow" corruption, the FOURTH site
      // (Martyress, Martyresses, Nun) — and here the etiology shows: the same
      // pass left "Troparion, In Tone IV", "Prokeimenon, In Tone VIII" and
      // "Alleluia, In Tone II" with capital I mid-label. A find-replace on
      // "tone" struck inside "stone". The lessons also print "our let them
      // hear" for "or" (Isaiah), twinned by "our come in the third watch" in
      // the Matins Gospel body.
      readings: [
        { heading: 'THE READING IS FROM ISAIAH',
          src: { file: HM, locus: 'p2 Lesson 1' },
          citation: { book: 'Isaiah', chapter: 43, verses: '43:9-14' },
          citation_basis: 'identified',
          provenance_note: 'The martyric Isaiah ("Ye are my witnesses"), identified from the Martyrs correspondence; confirm against the page.' },
        { heading: 'THE READING IS FROM THE WISDOM OF SOLOMON',
          src: { file: HM, locus: 'p2 Lesson 2' },
          citation: { book: 'Wisdom of Solomon', chapter: 3, verses: '3:1-3:9' },
          citation_basis: 'identified',
          provenance_note: 'The "souls of the righteous" lesson. Identified; confirm against the page.' },
        { heading: 'THE READING IS FROM THE WISDOM OF SOLOMON',
          src: { file: HM, locus: 'p3 Lesson 3' },
          citation: { book: 'Wisdom of Solomon', chapter: 5, verses: '5:15-6:3' },
          citation_basis: 'identified',
          provenance_note: 'The "righteous live unto the ages" rendering, carrying the "sIn Tone bow" body corruption — FOURTH site. Identified; confirm against the page.' },
      ],
      aposticha_rubric: hm1("On the Aposticha, these Stichera, in Tone VI:", 'p3 Aposticha rubric'),
      // “Verse” WITHOUT its colon at both aposticha verses — the megalynarion
      // verse on p5 prints “Verse:” with it.
      aposticha: [
        hm2("Having steeped thy sacred vestments in blood, * O holy and glorious (name), * resplendent in thy Martyrdom thou didst enter the Holy of Holies, * and now adorned with sanctity, * ever enjoyeth participation in a communion purer than that of the Angels; * wherefore we honor thee and lovingly celebrate thy most sacred festival, ** O right blessed (name).", "p3 Aposticha 1", { label: "plain", tone: 6 }),
        hm2("The righteous man shall flourish like a palm-tree; * like a cedar in Lebanon shall he be multiplied.", "p3 Aposticha verse 1", { sourceLabel: "Verse", label: "refrain" }),
        hm2("Bound with irons O holy one, * and adorned with thy precious wounds like precious ornaments * thou didst tread without faltering the path which leadeth unto the heavenly city, * O all-wise (name), * and entering therein as a true vanquisher, invincible martyr and most sacred minister, * thou dost now sing with the angels the divine Trisagion: ** Holy, Holy, Holy art Thou, O Consubstantial Trinity.", "p3 Aposticha 2", { label: "plain" }),
        hm2("They that are planted in the house of the Lord, * in the courts of our God shall they blossom forth.", "p3 Aposticha verse 2", { sourceLabel: "Verse", label: "refrain" }),
        hm2("O Hieromartyr (name), * by thy sacred deeds thou hast established the Church, * preserving her unshaken and unassailable by mighty wolves, * wherefore she rightly proclaimeth thy virtues and magnifieth thy sufferings, ** which thou didst lawfully endure for Christ’s sake, O blessed one.", "p3 Aposticha 3", { label: "plain" }),
      ],
      aposticha_glory: hm2("O blessed and most holy one, * sprinkled with the blood of Martyrdom * thou hast entered the heavenly tabernacle, * and now standing before the Trinity, O spiritually rich hieromartyr, * thou art radiant with the radiance proceeding from God, * wherefore we celebrate today thy radiant memory, O (name), ** enlightening the senses of our souls.", "p4 Aposticha Glory", { sourceLabel: "Glory ..., in Tone IV", tone: 4, label: "glory" }),
      aposticha_closer_label: hm1("Both now ..., in Tone IV:", 'p4 Both now label'),
      aposticha_closer_rubric: hm1("If the Celebration be with a Polyeleos, chant the Resurrection Theotokion:", 'p4 aposticha closer rubric'),
      aposticha_closer: hm2("Mercifully regard the supplications of thy servants, * O all-immaculate one, * quelling the cruel uprisings of the demons against us, * delivering us from every sorrow; * for thee alone do we have as a steadfast and sure confirmation, * and having acquired thine intercession; * let not us who call upon thee be put to shame, * O Sovereign Lady. * Hasten thou to answer the entreaties of those who cry out to thee with faith: * Rejoice, thou help, joy and protection of all, ** and the salvation of our souls!", "p4 Resurrection Theotokion", { tone: 4, type: "theotokion", label: "theotokion" }),
      aposticha_alternate: hm2("Bedew my mind * with showers of the Most holy Spirit, O most pure one, * who ineffably gaveth birth unto Christ * the drop Who with His compassions washeth away * the countless iniquities of mankind; * dry up the upwelling of my passions, * and grant unto me a torrent * of ever-living nourishment, ** by thy supplications.", "p4 Otherwise Theotokion", { sourceLabel: "Otherwise, Theotokion", type: "theotokion", label: "theotokion", label_inline: true }),
      aposticha_stavrotheotokion: hm2("Beholding Thee * nailed to the Cross, O Lord, * the ewe-lamb Thy Mother marveled * and cried out: “What is this that I see, * O my Son most desired? How hast Thou been rewarded by the unfaithful and iniquitous assembly * which hath enjoyed Thy many miracles? ** Yet glory to Thine ineffable condescension, O Master!”", "p4 Stavrotheotokion", { sourceLabel: "Stavrotheotokion", type: "stavrotheotokion", label: "stavrotheotokion", label_inline: true }),
      // “if there be none chant the following” — no comma, no “but”: a third
      // wording of the Typicon-fallback rubric.
      troparion_rubric: hm1("The Troparion from the Typicon; if there be none chant the following:", 'p4 troparion rubric'),
      ...
      closing_rubric: hm1("The Dismissal:", 'p4 Dismissal'),
    },
    ...
    matins: {
      order: ['god_is_lord_rubric', 'troparion', 'troparion_closer',
              ...
              'doxology_glory', 'doxology_closer_rubric', 'troparion_rubric',
              'troparion', 'closer', 'closing_rubric'],
      // “the Troparion in Tone IV” — no comma before the tone: byte-identical
      // with Martyr, Heirarch, Heirarchs and Martyress — the FAMILY form.
      god_is_lord_rubric: hm1("On “God is the Lord ...,” the Troparion in Tone IV:", 'p5 God is the Lord rubric'),
      ...
      sessional_1_rubric: hm1("After the 1st chanting of the Psalter, the Sessional Hymn, in Tone III:", 'p5 sessional 1 rubric'),
      // “O holy Father, (name) entreat” — the comma stranded BEFORE the
      // placeholder instead of after it (sic register).
      sessional_1: hm2("O ocean of confession of Orthodoxy! * Thou didst dispose of the falsehood of heterodoxy, * putting to shame the godlessness of idolatry, * thyself being made a divine whole-burnt offering, * illumining the ends of the world with thy miracles; * O holy Father, (name) entreat Christ God to grant us great mercy.", "p5 Sessional 1", { spec_mel: "Of the divine faith ...", tone: 3, repeat: 2 }),
      sessional_1_closer: hm2("Thou wast the divine tabernacle of the Word, * O only most pure Virgin Mother, * who dost surpass the angels in purity. * With the divine waters of thy supplications * cleanse me, who more than all others * am dust and defiled by carnal transgressions, O pure one, ** and grant me great mercy.", "p5 Sessional 1 Theotokion", { sourceLabel: "Glory ..., Both now ..., Theotokion, in Tone III", tone: 3, type: "theotokion" }),
      sessional_2_rubric: hm1("After the 2nd chanting of the Psalter, the Sessional Hymn, in Tone IV:", 'p5 sessional 2 rubric'),
      sessional_2: hm2("Shining forth as a ray of the sun, * radiating brilliantly unto all the world by thy teachings, * O voice of God, radiant and holy (name), * glory of the Martyrs.", "p5 Sessional 2", { spec_mel: "Thou hast appeared today ...", tone: 4, repeat: 2 }),
      sessional_2_closer: hm2("Stretching forth thy most pure arms, * O Virgin and Mother * shelter those who put their trust in thee * and who call out to thy Son exclaiming: ** O Christ grant unto us all Thy great mercy.", "p5 Sessional 2 Theotokion", { sourceLabel: "Glory ..., Both now ..., Theotokion, in Tone IV", tone: 4, type: "theotokion" }),
      megalynarion_rubric: hm1("After the Polyeleos, the Megalynarion:", 'p5 megalynarion rubric'),
      megalynarion: hm1("We magnify thee, O Hieromartyr (name) and honor thy holy memory, for thou dost supplicate for us Christ our God.", 'p5 Megalynarion'),
      // “inhabit the World” — capital W (sic register).
      megalynarion_verse: hm1("Hear this, all ye nations; give ear, all ye that inhabit the World.", "p5 Megalynarion verse", { sourceLabel: "Verse", label: "refrain" }),
      sessional_polyeleos_rubric: hm1("After the Polyeleos the Sessional Hymn, in Tone VIII:", 'p5 Polyeleos sessional rubric'),
      sessional_polyeleos: hm2("Upon the wings of the Cross and steered by the omnipresent might, * sailing freely across the stormy sea of life * thou didst reach the divine harbor, * having acquired an abundant supply of virtues, * which thou didst present unto the Master of all, hearing from Him: * “Well done, thou good and faithful servant, * enter thou into the joy of the Lord”; * wherefore, O blessed (name), * entreat Christ God to grant remission of sins unto those who with love venerate thy holy memory.", "p5-p6 Polyeleos sessional", { spec_mel: "Of the wisdom ...", tone: 8, repeat: 2 }),
      sessional_polyeleos_closer: hm2("From the snares of enemies visible and invisible, * we have been overcome by the storms of our uncountable sins, * and fleeing unto the safe harbor of thy goodness O pure one, * we have thee as our rampart and sure protection. * Wherefore we thy servants beseech thee * to ceaselessly make fervent supplication, O all-pure one, * unto Him who seedlessly became incarnate from thee, * that those who worthily hymn thee ** may be granted the remission of their sins.", "p6 Polyeleos sessional Theotokion", { sourceLabel: "Glory ..., Both now ..., Theotokion, in Tone VIII", tone: 8, type: "theotokion" }),
      anabathmoi_rubric: hm1("If of Polyeleos rank, and not a Resurrection Service, chant the following:", 'p6 anabathmoi rubric'),
      anabathmoi_intro: hm1("The Song of Ascents: The first antiphon, in Tone IV:", 'p6 anabathmoi heading'),
      anabathmoi: [
        hm2("From my youth * do many passions war against me; * but do Thou Thyself defend ** and save me, O my Savior.", "p6 anabathmoi 1", { label: "plain" }),
        hm2("Ye haters of Zion * shall be shamed by the Lord; * for like grass, by the fire ** shall ye be withered.", "p6 anabathmoi 2", { label: "plain" }),
      ],
      anabathmoi_closer: hm2("In the Holy Spirit, * every soul is quickened, * and, through cleansing, is exalted ** and made radiant by the Triple Unity in a hidden sacred manner.", "p6 anabathmoi Glory Both now", { sourceLabel: "Glory ..., Both now ...,", label: ["glory", "both_now"] }),
      prokeimenon_rubric: hm1("Prokeimenon, in Tone IV:", 'p6 prokeimenon rubric'),
      prokeimenon: hm2("Precious in the sight of the Lord * is the death of His saints.", "p6 Prokeimenon", { sourceLabel: "Prokeimenon, in Tone IV", tone: 4, label_inline: true }),
      prokeimenon_verse: hm1("What shall I render unto the Lord for all that He hath rendered unto me?", "p6 Prokeimenon verse", { sourceLabel: "Verse", label: "refrain" }),
      gospel_rubric: hm1("Let every breath ...,", 'p6 Let every breath'),
      // "(12. 32-40)" — full stop where every sibling prints a colon or comma
      // in the citation.
      gospel: { heading: 'THE HOLY GOSPEL ACCORDING TO ST. LUKE',
        src: { file: HM, locus: 'p6 Matins Gospel' },
        citation_verbatim: '(12. 32-40)',
        citation: { book: 'Luke', chapter: 12, verses: '32-40' },
        citation_basis: 'printed' },
      psalm50_rubric: hm1("After the 50th Psalm:", 'p6 After the 50th Psalm'),
      psalm50_sticheron: hm2("Through the prayers of Hieromartyr (name), * O Merciful One, ** blot out the multitude of our transgressions.", "p7 Psalm 50 Glory", { sourceLabel: "Glory ..., in Tone VI", tone: 6, label: "glory" }),
      psalm50_closer: hm2("Through the prayers of the Theotokos, * O Merciful One, ** blot out the multitude of our transgressions.", "p7 Psalm 50 Both now", { sourceLabel: "Both now ...,", type: "theotokion", label: "both_now" }),
      psalm50_verse: hm2("Have mercy on me, O God, * according to Thy great mercy; * and according to the multitude of Thy compassions, ** blot out my transgressions.", "p7 Psalm 50 verse", { label: "refrain" }),
      sessional_post50_rubric: hm1("Then the Sessional Hymn, in Tone IV:", 'p7 post-Psalm-50 sessional rubric'),
      sessional_post50: hm2("Cleansing thy soul from passions O holy one, * and becoming a sacred vessel of the Holy Spirit, * thou didst receive from Christ the divine and holy unction, * consecrated a Hierarch and counselor of the divinely-wise people * and an invincible Martyr of Him Who for our sake endured the passion ** from whence flows dispassion, O holy sufferer (name).", "p7 post-Psalm-50 Sessional", { tone: 4 }),
      canon_rubric: hm1("The Canon, in Tone II:", 'p7 Canon rubric'),
      canons: [{
        title: "The Canon, in Tone II:", tone: 2,
        odes: {
          1: {
            irmos: hm2("Come, O ye people, * let us sing a song to Christ our God, * Who divided the sea, * and made a way for the nation * which He had brought up out of the bondage of Egypt; * for He hath been glorified.", "p7 Ode 1 irmos", { sourceLabel: "Irmos", label_inline: true }),
            refrain: hm1("Holy Hieromartyr (name) pray to God for us", "p7 Ode 1 refrain", { sourceLabel: "Refrain", label_inline: true }),
            items: [
              hm1("Enlightened by the light of Christ, do thou, O glorious Hieromartyr (name), enlighten by thine intercessions my darkened soul, that I may hymn thee, O most blessed one.", "p7 Ode 1 troparion 1", { label: "plain" }),
              hm1("Thy pure heart like an untarnished mirror reflecting the rays of divine enlightenment emitteth knowledge upon all through thy salutary preaching, O blessed Father.", "p7 Ode 1 troparion 2", { label: "plain" }),
              hm1("By fasting, thou didst subdue the activity of the passions, by abstinence thou didst transform thy desire, and by manifold ascetic exploits thou didst attain to the height of dispassion.", "p7 Ode 1 troparion 3", { label: "plain" }),
              hm1("God who existed before all ages and before the creation of every creature, became incarnate from thee without seed or the confused desire of man; Him we have come to know, wherefore we hymn thee as the true Theotokos .", "p7 Ode 1 Theotokion", { sourceLabel: "Theotokion", label: "theotokion", label_inline: true }),
            ],
          },
          3: {
            irmos: hm2("O Lord, who didst slay sin upon the tree, * firmly establish us in Thee, * and in the hearts of us who hymn Thee * plant the fear of Thee.", "p7-p8 Ode 3 irmos", { sourceLabel: "Irmos", label_inline: true }),
            items: [
              hm1("With the conscience of a Martyr, as one who suffered in the ascetic life, thou hast presented thyself unto Christ through Martyrdom as an all-perfect living sacrifice.", "p7-p8 Ode 3 troparion 1", { label: "plain" }),
              hm1("By thy sacred life, through thy divine words and with thy divine deeds didst thou make ascent in thy heart attaining to the true contemplation of God.", "p7-p8 Ode 3 troparion 2", { label: "plain" }),
              hm1("In a divinely-wise manner didst thou direct thy words in accordance with the commandments of the Savior, wherefore thou wast revealed to be an invincible defender of the faith.", "p7-p8 Ode 3 troparion 3", { label: "plain" }),
              hm1("By giving birth to Immortality thou hast relieved our minds of the thought of our mortality, and with thy birth-giving O Virgin thou hast woven for us a vesture of incorruption.", "p7-p8 Ode 3 Theotokion", { sourceLabel: "Theotokion", label: "theotokion", label_inline: true }),
            ],
          },
          4: {
            irmos: hm2("I have heard report of Thy dispensation, O Lord, * and have glorified Thee * Who alone lovest mankind.", "p8 Ode 4 irmos", { sourceLabel: "Irmos", label_inline: true }),
            items: [
              hm1("As a divine whole burnt-offering and a pure sacrifice thou wast brought before the Savior of all, O most wise Hierarch.", "p8 Ode 4 troparion 1", { label: "plain" }),
              hm1("Instructing the flock of Christ in the light of the knowledge of God, thou hast driven away the darkness of godlessness.", "p8 Ode 4 troparion 2", { label: "plain" }),
              hm1("With the streams of thy sweat, O Father and Hierarch, thou hast dried up the depths of godlessness.", "p8 Ode 4 troparion 3", { label: "plain" }),
              hm1("With thy light do thou, O most pure one, enlighten my darkened soul, since thou hast given birth unto the One Hypostatic Light.", "p8 Ode 4 Theotokion", { sourceLabel: "Theotokion", label: "theotokion", label_inline: true }),
            ],
          },
          5: {
            irmos: hm2("O Lord, Bestower of light and Creator of the ages: * guide us in the light of Thy commandments, * for we know none other God than Thee.", "p8-p9 Ode 5 irmos", { sourceLabel: "Irmos", label_inline: true }),
            items: [
              hm1("Christ, the true wisdom, seeing Thine exceeding love for Him, hath granted thee O blessed one, both riches and glory, length of days, and eternal life.", "p8-p9 Ode 5 troparion 1", { label: "plain" }),
              hm1("With the staff of faith thou didst drive away the snares of heresies and uniting thy flock in the bonds of love, thou hast, by love and faith preserved it unharmed.", "p8-p9 Ode 5 troparion 2", { label: "plain" }),
              hm1("By thy strict ascetic life, refusing temporal food, thou hast satisfied the needs of thy soul with the food of unceasing prayer, instruction, and humility by which one is raised on high to God.", "p8-p9 Ode 5 troparion 3", { label: "plain" }),
              hm1("We have acquired in thee, O pure one, our protection, a sure hope, a mighty shelter, a wall of refuge, and a bridge that leadeth into the Kingdom of heaven.", "p8-p9 Ode 5 Theotokion", { sourceLabel: "Theotokion", label: "theotokion", label_inline: true }),
            ],
          },
          6: {
            irmos: hm2("Whirled about in the abyss of sin, * I appeal to the unfathomable abyss of Thy compassion: * Raise me up from corruption, O God.", "p9 Ode 6 irmos", { sourceLabel: "Irmos", label_inline: true }),
            items: [
              hm1("Both a sacrifice and a priest, thou hast wholly given thyself unto God for the sake of the faith, and thus preserved undefiled the fulfillment of thy ministry unto Him.", "p9 Ode 6 troparion 1", { label: "plain" }),
              hm1("A spectacle seen as slain by the world, yet remaining alive in God, thou O godly-spoken one, passed over to Christ enriched by the life of incorruption.", "p9 Ode 6 troparion 2", { label: "plain" }),
              hm1("Passing from earthly life into the never-waning glory, do thou, O holy one, by thy supplications fervently heal and cleanse my soul savaged by the passions.", "p9 Ode 6 troparion 3", { label: "plain" }),
              hm1("O most pure and all-immaculate one, who didst conceive Christ, Who taketh away the sins of the world, cease not to entreat Him that remission of sins be granted unto thy servants.", "p9 Ode 6 Theotokion", { sourceLabel: "Theotokion", label: "theotokion", label_inline: true }),
            ],
          },
          7: {
            irmos: hm2("The wise children did not adore the golden idol in the plain of Dura, * but went themselves into the flame and defied the pagan gods. * They prayed in the midst of the flame, * and an Angel bedewed them saying: * “The prayer of your lips hath been heard.”", "p9-p10 Ode 7 irmos", { sourceLabel: "Irmos", label_inline: true }),
            items: [
              hm1("Appearing unto all as a wellspring of wisdom full of virtue, by thy preaching and sublime life thou hast gathered thy flock, O divinely-wise one, and having well tended it, together with them, thou dost cry out: “Blessed is the God of our Fathers.”", "p9-p10 Ode 7 troparion 1", { label: "plain" }),
              hm1("O Father thou hast passed over from this temporal life and entered into the temples and habitations of honor, and now dwelling with the Angels therein thou rejoiceth with them; wherefore honoring thee, O most blessed one, we with boldness cry aloud: “Blessed is the God of our Fathers.”", "p9-p10 Ode 7 troparion 2", { label: "plain" }),
              hm1("Blessed art thou and well it is with thee, for now, in thy heavenly dwelling where the legions of the righteous, the multitude of the Martyrs and the choirs of the most wise Apostles abide, thou dost with them cry aloud: “Blessed is the God of our Fathers.”", "p9-p10 Ode 7 troparion 3", { label: "plain" }),
              hm1("Thou alone, O most pure Virgin, hath become known as a Mother who knew not wedlock, and the Mother of Him Who created everything in His wisdom; wherefore we fervently call unto thee, saying: “Blessed art thou who hast given birth to God in the flesh.”", "p9-p10 Ode 7 Theotokion", { sourceLabel: "Theotokion", label: "theotokion", label_inline: true }),
            ],
          },
          8: {
            irmos: hm2("God Who descended into the fiery furnace * with the Hebrew children, * and transformed the flame into dew, * do ye works hymn, * and supremely exalt as Lord throughout all ages.", "p10 Ode 8 irmos", { sourceLabel: "Irmos", label_inline: true }),
            items: [
              hm1("With fervor didst thou execute the ministry of the mysteries of Christ, and like a spiritual lamb offered thyself unto Him as an acceptable and well-pleasing sacrifice, perfected with the spilling of thy blood, O most blessed one.", "p10 Ode 8 troparion 1", { label: "plain" }),
              hm1("Adorning thy Hierarchical vestments with virtues, O most wise one, thou didst manifest thyself as a guardian of chastity, a partaker of the true food of abstinence, a teacher of prayer, and an instructor of repentance and law, unto eternal life.", "p10 Ode 8 troparion 2", { label: "plain" }),
              hm1("At the time of our oblation, let us always bring forth fruit worthy of repentance, since the barren fig-tree lives ever threatened of being cut off; Fear such a curse O my soul, and worthily receive Christ, the abundant fruit of virtue.", "p10 Ode 8 troparion 3", { label: "plain" }),
              hm1("O most venerated defender of Christian peoples, do not despise the voice of us thy servants and deliver us, O holy Virgin, from every danger and from every cruel advance of the enemy, for thy motherly intercessions ever incline God to mercy.", "p10 Ode 8 Theotokion", { sourceLabel: "Theotokion", label: "theotokion", label_inline: true }),
            ],
          },
          9: {
            irmos: hm2("The Son of the Beginningless Father, God and Lord, * hath appeared to us incarnate of a Virgin, * to enlighten those in darkness, * and to gather the dispersed; * therefore the all-hymned Theotokos do we magnify", "p10-p11 Ode 9 irmos", { sourceLabel: "Irmos", label_inline: true }),
            items: [
              hm1("Thou, O Father, hast destroyed the many and varied arrows of the enemy by the fire of abstinence, burning up the corruption of the flesh with the coals of chastity, wherefore thou wast gloriously deemed worthy of the true purity that exists on high.", "p10-p11 Ode 9 troparion 1", { label: "plain" }),
              hm1("Thy radiant memory, O Father, hath shone forth, illuminating the souls of those who reverently celebrate it, rendering them, O right wondrous one, partakers of the divine light; wherefore we offer thee hymns, O divinely-wise one.", "p10-p11 Ode 9 troparion 2", { label: "plain" }),
              hm1("Thou, O Father, having received from the right hand of God the reward of thy victory art now adorned with the crown of martyrdom, for finishing thine exploits and resplendent with the divine light, we the faithful now offer thee unto Christ as our fervent intercessor.", "p10-p11 Ode 9 troparion 3", { label: "plain" }),
              hm1("O Virgin and Mother of the Word, the true Theotokos, our mediatrix, thou hast brought forth unto us the eternal Life of God and the Sun of righteousness, Whom we the faithful with one mind magnify in spiritual songs.", "p10-p11 Ode 9 Theotokion", { sourceLabel: "Theotokion", label: "theotokion", label_inline: true }),
            ],
          },
        },
      }],
      sessional_ode3_rubric: hm1("The Sessional Hymn, in Tone III:", 'p8 post-Ode-III sessional rubric'),
      sessional_ode3: hm2("O Hieromartyr (name), * enlightened by the Divine Spirit and through thy great wisdom and pastoral boldness * putting to shame the ferocity of Godless tyrants, * thou didst traverse the abyss of temporal life, * reaching the divine refuge. * O holy Father (name) ** entreat Christ our God to grant us His great mercy.", "p8 post-Ode-III Sessional", { tone: 3 }),
      sessional_ode3_closer: hm2("Whither doth each one who is saved, * rightly have recourse; * and to what other such refuge can there be * which doth protect our souls like thee, ** O Theotokos?", "p8 post-Ode-III Theotokion", { sourceLabel: "Glory ..., Both now ..., Theotokion, in Tone III", tone: 3, type: "theotokion" }),
      sessional_ode3_stavrotheotokion: hm2("Having obtained the Cross of thy Son as a staff of strength, * O Theotokos, * therewith we cast down the arrogance of the enemy, ** and with love unceasingly magnify thee.", "p8 post-Ode-III Stavrotheotokion", { sourceLabel: "Stavrotheotokion", type: "stavrotheotokion", label: "stavrotheotokion", label_inline: true }),
      kontakion_rubric: hm1("The Kontakion from the Typicon; but if there be none, chant the following:", 'p9 Kontakion rubric'),
      exapostilarion_rubric: hm1("Exapostilarion in Tone III:", 'p11 exapostilarion rubric'),
      exapostilarion: hm2("As a Hieromartyr with power to bind and to loose, * do thou, O blessed one, * loose the bonds of my evil deeds * and with those beloved of God do thou number me * and through thine intercessions make me * a partaker of the Kingdom of God.", "p11 Exapostilarion", { spec_mel: "The heaven with stars ...", tone: 3, repeat: 2 }),
      // Byte-identical with Nun's exapostilarion closer (register).
      exapostilarion_closer: hm2("Do thou, O pure one, illumine my soul * darkened by the multitude of my many transgressions * and through thine intercession deliver me * from the eternal flames and darkness, ** that I may with joy praise thy majesty.", "p11 Exapostilarion Theotokion", { sourceLabel: "Glory ..., Both now ..., Theotokion in Tone III", tone: 3, type: "theotokion" }),
      praises_rubric: hm1("On the Praises, these Stichera, in Tone IV:", 'p11 Praises rubric'),
      praises: [
        hm2("Spiritual grace shining forth upon thee, * O Father (name), * greatly illumined thee; * wherefore the night of passion was quickened within thee * and within thee the daylight of passionlessness dawned * wherefore thou wast united with the divine Light; * and abiding therein, forget not, * O divinely eloquent Hieromartyr, ** those who with faith hymn thy memory.", "p11 Praises 1", { spec_mel: "Thou hast given a sign ...", label: "plain", tone: 4, repeat: 2 }),
        hm2("As one possessing heavenly grace, * thou O Hieromartyr (name), * abandoned earthly possessions; * and like an angel * desired the enjoyment of eternal spiritual food, * wherefore O god-pleasing one, * choosing a life of suffering * and drying up the troubled sources of the passions by thy tears, ** thou didst fill thy soul with spiritual food.", "p11 Praises 2", { spec_mel: "Thou hast given a sign ...", label: "plain" }),
        hm2("Giving thy body, * covered with wounds from beatings and exposure to fire, * over to insults, * but preserving thy mind * with an invincible desire * to behold the beauty of the divine Bestower, * thou didst become an embellishment of the martyrs, * and an adornment of Hierarchs, ** O martyr (name), friend of the angels.", "p11 Praises 3", { spec_mel: "Thou hast given a sign ...", label: "plain" }),
      ],
      praises_glory: hm2("Like a newly planted, fertile olive tree * thou wast set in the house of God. * Like a good son who walked in the ways of the Lord, * the Lord blessed thee, * and for the sake of thy martyrdom, granted thee to behold the blessedness of the heavenly kingdom. * Wherefore, taking delight in the divine joys together with all the saints, * O worthily hymned Hieromartyr (name), * we beseech thee that through thine intercessions we also may be made partakers ** of the heavenly kingdom.", "p12 Praises Glory", { sourceLabel: "Glory ..., in Tone IV", tone: 4, label: "glory" }),
      // “Theotokion in Tone IV” — the comma before the tone dropped here and
      // at the exapostilarion closer.
      praises_closer: hm2("O Theotokos, Queen of all, * thou praise of the Orthodox: * cast down the proud arrogance of the heretics, * and put to shame the countenances of those * who neither bow down before nor honor thy precious image, ** O most pure one.", "p12 Praises Both now", { sourceLabel: "Both now ..., Theotokion in Tone IV", tone: 4, type: "theotokion", label: "both_now" }),
      // “O my Son ?” and “unto them ?” — spaced question marks (sic register);
      // and the Mother's lament veers into the first person (“my child-
      // lessness”) — captured verbatim.
      praises_stavrotheotokion: hm2("Seeing Christ, the Lover of mankind, * crucified and with His side pierced with a lance, * the most pure one lamented, crying aloud: * “What is this, O my Son ? * What have the ungrateful people rendered unto Thee * in return for all the good things Thou hast rendered unto them ?” * And yet thou dost show thy tender compassion for me, * that I may endure my childlessness. ** I stand in awe, O Compassionate One, at Thy voluntary crucifixion.", "p12 Stavrotheotokion", { sourceLabel: "Stavrotheotokion", type: "stavrotheotokion", label: "stavrotheotokion", label_inline: true }),
      great_doxology_rubric: hm1("The great Doxology: If a small Doxology is read, and a Doxasticon is appointed, the following is chanted after the Aposticha:", 'p12 great Doxology rubric'),
      doxology_glory: hm2("O blessed and most holy one, * sprinkled with the blood of Martyrdom * thou hast entered the heavenly tabernacle, * and now standing before the Trinity, O spiritually rich hieromartyr, * thou art radiant with the radiance proceeding from God, * wherefore we celebrate today thy radiant memory, O (name), ** enlightening the senses of our souls.", "p12 Doxology Glory", { sourceLabel: "Glory ..., in Tone IV", tone: 4, label: "glory" }),
      // Printed WITHOUT the “Both now ...,” prefix every sibling carries.
      doxology_closer_rubric: hm1("Theotokion or Stavrotheotokion:", 'p12 Doxology closer rubric'),
      troparion_rubric: hm1("After Our Father ..., the Troparion, in Tone IV:", 'p12 after Our Father rubric'),
      ...
      closing_rubric: hm1("The Dismissal:", 'p12 Dismissal'),
    },
    ...
    liturgy: {
      order: ['beatitudes_rubric', 'beatitudes', 'propers_rubric', 'troparion',
              'kontakion', 'prokeimenon', 'prokeimenon_verse', 'epistle',
              'alleluia', 'alleluia_verse', 'gospel', 'communion_verse'],
      beatitudes_rubric: hm1("Typika and Beatitudes.", 'p13 Typika and Beatitudes'),
      beatitudes: [
        hm1("With the conscience of a Martyr, as one who suffered in the ascetic life, thou hast presented thyself unto Christ through Martyrdom as an all-perfect living sacrifice.", "p13 Beatitude 1", { label: "plain" }),
        hm1("By thy sacred life, through thy divine words and with thy divine deeds didst thou make ascent in thy heart attaining to the true contemplation of God.", "p13 Beatitude 2", { label: "plain" }),
        hm1("In a divinely-wise manner didst thou direct thy words in accordance with the commandments of the Savior, wherefore thou wast revealed to be an invincible defender of the faith.", "p13 Beatitude 3", { label: "plain" }),
        hm1("Both a sacrifice and a priest, thou hast wholly given thyself unto God for the sake of the faith, and thus preserved undefiled the fulfillment of thy ministry unto Him.", "p13 Beatitude 4", { label: "plain" }),
        hm1("A spectacle seen as slain by the world, yet remaining alive in God, thou O godly-spoken one, passed over to Christ enriched by the life of incorruption.", "p13 Beatitude 5", { label: "plain" }),
        hm1("Passing from earthly life into the never-waning glory, do thou, O holy one, by thy supplications fervently heal and cleanse my soul savaged by the passions.", "p13 Beatitude 6", { label: "plain" }),
        hm1("O most pure and all-immaculate one, who didst conceive Christ, Who taketh away the sins of the world, cease not to entreat Him that remission of sins be granted unto thy servants.", "p13 Beatitude 7", { sourceLabel: "Theotokion", label: "theotokion", label_inline: true }),
      ],
      propers_rubric: hm1("The Troparion and Kontakion from the Typicon; if there be none, chant the following:", 'p13 Liturgy propers rubric'),
      prokeimenon: hm2("The saints shall boast in glory * and they shall rejoice upon their beds.", "p13 Liturgy Prokeimenon", { sourceLabel: "Prokeimenon, In Tone VIII", tone: 8, label_inline: true }),
      prokeimenon_verse: hm1("Sing unto the Lord a new song, His praise is in the Church of His saints.", "p13 Liturgy Prokeimenon verse", { sourceLabel: "Verse", label: "refrain" }),
      epistle: { heading: 'THE EPISTLE TO THE HEBREWS',
        src: { file: HM, locus: 'p14 Epistle' },
        citation_verbatim: '(13: 7-16)',
        citation: { book: 'Hebrews', chapter: 13, verses: '7-16' },
        citation_basis: 'printed' },
      // “Alleluia, In Tone II” — the third capital-I label in the file.
      alleluia: hm1("Thy priests shall be clothed with righteousness, and thy righteous shall rejoice.", "p14 Alleluia", { sourceLabel: "Alleluia, In Tone II", tone: 2, label_inline: true }),
      alleluia_verse: hm1("For the Lord hath elected Zion; He hath chosen Her to be a habitation for Himself.", "p14 Alleluia verse", { sourceLabel: "Verse", label: "refrain" }),
      gospel: { heading: 'THE GOSPEL ACCORDING TO ST. LUKE',
        src: { file: HM, locus: 'p14 Liturgy Gospel' },
        citation_verbatim: '(12:2-12)',
        citation: { book: 'Luke', chapter: 12, verses: '2-12' },
        citation_basis: 'printed' },
      // The SEMICOLON form of the righteous communion verse.
      communion_verse: hm1("Rejoice in the Lord, O ye righteous; praise is meet for the upright.", "p14 Communion verse", { sourceLabel: "Communion Verse", label_inline: true }),
    },
  },
  Heiromartyrs: {
    // The FILENAME flips its own spelling across the pair: the singular is
    // Hieromartyr.pdf, this plural Heiromartyrs.pdf (the Heirarch family
    // spelling). Keys follow filenames per R-9.
    title: hx1("THE GENERAL VIGIL SERVICE TO TWO OR MORE HIEROMARTYRS.", 'p1 title'),

    // "O God of our fathers" — byte-identical at FOUR sites here (generator-
    // verified) and already the canonical troparion of Monastics, Heirarchs
    // and MonasticMartyrs: ONE troparion serves four plural files.
    troparion: hx2("O God of our fathers, * ever deal with us according to Thy meekness. * Take not Thy mercy from us, * but by the prayers of these saints ** direct our life in peace.", "p4 Troparion", { sourceLabel: "Troparion, in Tone IV", verified_sites: [{"locus": "p4 Vespers dismissal", "tone": 4}, {"locus": "p5 God is the Lord", "tone": 4, "repeat": 2}, {"locus": "p12 after Our Father", "tone": 4}, {"locus": "p13 AT LITURGY", "tone": 4}] }),
    // THE KONTAKION'S TWO SITES DIFFER BY ONE WORD — p9 ends "those who
    // fast", p13 "those that fast": the FIRST canonical proper in seventeen
    // files whose sites refuse R-1 byte-identity. The p9 copy is canonical;
    // the p13 copy is stored AT ITS SITE in liturgy.kontakion (the renderer
    // prefers a section-local node over the entry fallback). And a fasting
    // formula ("foundations of those who fast") under HIEROMARTYRS is a
    // monastic kontakion's refrain wearing the wrong subject — flagged.
    kontakion: hx2("We who have assembled today, * praise you in song as never-waning lights of the noetic Sun; * for having shone forth unto those in the darkness of ignorance, * ye called all to the heights of piety, * O holy Hieromartyrs. * Wherefore we cry unto you: ** Rejoice, O ye foundations of those who fast.", "p9 Kontakion after Ode VI", { sourceLabel: "Kontakion In Tone III", spec_mel: "Today the Virgin ...", tone: 3, verified_sites: [{"locus": "p9 after Ode VI", "tone": 3}] }),
    ikos: hx1("Pour forth unto me thine uncreated grace, O Jesus the giver of life, that I may worthily hymn Thy Hierarchs who strove to emulate Thee, even unto death, mightily overcoming the forces of the enemy, and by power of Thy Cross, exposing the wickedness of the impious; wherefore they have been deemed worthy to be glorified by Thee, O Christ, and we cry unto them: Rejoice, O ye foundations of all those who fast.", "p10 Ikos", { sourceLabel: "The Ikos", label_inline: true }),
    ...
    vespers: {
      order: ['lic_rubric', 'lic', 'lic_closer', 'lic_stavrotheotokion',
              ...
              'aposticha_closer', 'aposticha_alternate', 'aposticha_stavrotheotokion',
              'troparion_rubric', 'troparion', 'closer', 'closing_rubric'],
      lic_rubric: hx1("On “Lord, I have cried ...,” these Stichera, in Tone I:", 'p1 LIC rubric'),
      // The Spec. Mel. prints lowercase — “O all-praised martyrs” — where the
      // singular capitalises Martyrs. Sticheron 3 slides person mid-clause:
      // “ye have delivered THY flock”.
      lic: [
        hx2("In truth brightly adorning your Hierarchical vestments * with the blood of Martyrdom, * you presented yourselves unto the Creator * together with the Angels, * radiantly illumined * in both soul and body, * Entreat Him O ye glorious saints, * to grant peace and great mercy ** unto our souls.", "p1 LIC 1", { spec_mel: "O all-praised martyrs ...", label: "plain", tone: 1 }),
        hx2("You have been revealed to us * as truly God-inspired vessels; * proclaiming the unspeakable mysteries of God * hidden in the divine scriptures, * thereby confirming the foolishness * of idol-worship, * whereby you brought all unto Christ; * entreat Him to grant peace and great mercy ** unto our souls.", "p1 LIC 2", { spec_mel: "O all-praised martyrs ...", label: "plain" }),
        hx2("With the word of God’s understanding, * O most wise ones, * ye have delivered thy flock from ignorance, * and having saved them, * ye brought them unto Christ the Word * Who hath shone forth, * begotten of the Father our God; * Entreat Him to grant peace and great mercy ** unto our souls.", "p1 LIC 3", { spec_mel: "O all-praised martyrs ...", label: "plain" }),
      ],
      // Ends WITHOUT a full stop — the page runs straight to the
      // Stavrotheotokion label (sic register).
      lic_closer: hx2("O all-hymned Virgin, * in whom Moses beheld a mystery with prophetic eyes * the bush that burned yet remained unconsumed; * for the fire of the Godhead did not burn thy womb, O pure one. * Wherefore, we beseech thee, as the Mother of our God: ** beg thou peace and great mercy for the world", "p1 LIC closer", { sourceLabel: "Glory ..., Both now ..., Theotokion, in Tone I", tone: 1, type: "theotokion", label: ["glory", "both_now", "theotokion"] }),
      // The SAME hymn the singular prints as “Standing at the foot of the
      // Cross” — a second rendering (register: variant).
      lic_stavrotheotokion: hx2("Standing before the Cross of thy Son and God, * and beholding His long-suffering, O pure Mother, * thou didst say, weeping: * “Woe is me, O my most sweet Child! * How is it that Thou dost unjustly suffer, O Word of God, ** that Thou mightest save mankind?”", "p1 Stavrotheotokion", { sourceLabel: "Stavrotheotokion", type: "stavrotheotokion", label: "stavrotheotokion", label_inline: true }),
      idiomelon_rubric: hx1("If an Idiomelon be appointed, Glory ..., in Tone VIII:", 'p1 idiomelon rubric'),
      lic_glory: hx2("Ye have passed from this temporal world, * O godly called Hierarchs, * after enduring the most severe beatings, * being cut asunder and even crucified * for the sake of Christ, * but neither fire, nor wounds, nor instruments of torture, * could weaken the resolve of your souls, * wherefore having trampled underfoot the might of demons, * O glorious Hieromartyrs; ** we beseech you to pray Christ God that He save our souls.", "p1 Glory idiomelon", { sourceLabel: "Glory ..., in Tone VIII", tone: 8, label: "glory" }),
      // “Dogmatic In Tone VIII” — capital I (the sIn-Tone find-replace class,
      // first of FOUR in this file) — and the travelling “service ):” space,
      // FIFTH file.
      dogmatikon_rubric: hx1("If the Celebration be with a Polyeleos, and not a Resurrection Service, sing the following Dogmatic In Tone VIII (If the service is a Resurrection service sing the Dogmatic of the Tone for that service ):", 'p1 dogmatikon rubric'),
      dogmatikon: hx2("In His love for mankind, the King of heaven appeared on earth * and dwelt among men; * for He Who received flesh from the pure Virgin * and cameth forth from her having received human nature, * is the only Son of God, * twofold in nature but not Hypostasis. * Therefore, proclaiming Him to be truly perfect God and perfect man, * we confess Christ our God. * Him do thou beseech, O unwedded Mother, ** that our souls find mercy!", "p2 Both now dogmatic", { sourceLabel: "Both now ..., in Tone VIII", tone: 8, type: "dogmatic_theotokion", label: "both_now" }),
      dogmatikon_alternate: hx2("I flee to thy protection, O holy Virgin Theotokos, * for I know that through thee I shall obtain salvation; ** for thou art able to help me, O pure one.", "p2 Otherwise Theotokion", { sourceLabel: "Otherwise, Theotokion", type: "theotokion", label: "theotokion", label_inline: true }),
      // A THIRD rendering of the Beholding-Thee hymn — “accepting suffering,
      // O Jesus … delivering all from corruption in Thy tender compassion?”
      // against the family's “accepting the passion … Thou hast redeemed
      // all” — and it ends on a question mark.
      dogmatikon_stavrotheotokion: hx2("Beholding Thee nailed to the Cross * and voluntarily accepting suffering, O Jesus, * Thy Virgin Mother, O Master, * cried aloud: Woe is me, my sweet Child! * How is it that Thou dost endure unjustly inflicted wounds, * O Physician Who healeth the infirmities of mankind, * delivering all from corruption ** in Thy tender compassion?", "p2 Stavrotheotokion", { sourceLabel: "Stavrotheotokion", type: "stavrotheotokion", label: "stavrotheotokion", label_inline: true }),
      entrance_rubric: hx1("The Entrance. The Prokeimenon of the day. The Three Lessons if appointed:", 'p2 Entrance rubric'),
      // ALL THREE LESSON CITATIONS PRINTED — and the Isaiah one carries the
      // SAME dangling "; )" Unmercenaries prints, byte-for-byte: the stray
      // semicolon travels between files. This file's Isaiah body prints "or
      // let them hear" CORRECTLY where Hieromartyr, Martyr, Martyrs and
      // Unmercenaries all print "our" — and its Wisdom 5 body still carries
      // the "sIn Tone bow" corruption (FIFTH site) plus "welldrawn" closed
      // up where the singular prints "well-drawn". Bodies unstored per R-4;
      // recorded here.
      readings: [
        { heading: 'THE READING IS FROM ISAIAH',
          src: { file: HX, locus: 'p2 Lesson 1' },
          citation_verbatim: '(43, 9-14; )',
          citation: { book: 'Isaiah', chapter: 43, verses: '9-14' },
          citation_basis: 'printed',
          provenance_note: 'Printed reference with the dangling "; )" — byte-identical with the Unmercenaries citation.' },
        { heading: 'THE READING IS FROM THE WISDOM OF SOLOMON',
          src: { file: HX, locus: 'p2 Lesson 2' },
          citation_verbatim: '(3, 1-9)',
          citation: { book: 'Wisdom of Solomon', chapter: 3, verses: '1-9' },
          citation_basis: 'printed' },
        { heading: 'THE READING IS FROM THE WISDOM OF SOLOMON',
          src: { file: HX, locus: 'p3 Lesson 3' },
          citation_verbatim: '(5, 15-23; 6, 1-3).',
          citation: { book: 'Wisdom of Solomon', chapter: 5, verses: '5:15-23; 6:1-3' },
          citation_basis: 'printed' },
      ],
      aposticha_rubric: hx1("On the Aposticha, these Stichera, in Tone IV:", 'p3 Aposticha rubric'),
      // Verse 1 prints “Thy priests BE clothed” — the Alleluia text with its
      // “shall” dropped (sic register). Sticheron 3 opens “Completing THINE
      // honored service” on a plural subject.
      aposticha: [
        hx2("Like most luminous stars * spiritually illumining * the firmament of the Church, * ye illumine all of creation, * driving away the power of darkness * by the radiant effulgence of your miracles, * wherefore we rejoice today * celebrating your radiant and holy memory, ** O glorious Hieromartyrs.", "p3 Aposticha 1", { spec_mel: "As one valiant among the martyrs ...", label: "plain", tone: 4 }),
        hx2("Thy priests be clothed with righteousness * and Thy righteous shall rejoice.", "p3 Aposticha verse 1", { sourceLabel: "Verse", label: "refrain" }),
        hx2("Ye have appeared unto all to be equal in honor with the Apostles * O holy Hierarchs, * and with equally zealous minds, * you were unafraid of the godlessness of the inhuman tyrants, * but valiantly and earnestly preaching * the word of the Savior, * ye endured a multitude of sufferings; * for which ye now enjoy the blessings of future rewards, ** O most wise ones.", "p3 Aposticha 2", { spec_mel: "As one valiant among the martyrs ...", label: "plain" }),
        hx2("Blessed is the man that feareth the Lord, * in His commandments shall he greatly delight.", "p4 Aposticha verse 2", { sourceLabel: "Verse", label: "refrain" }),
        hx2("Completing thine honored service * unto Christ the Master, * ye offered yourselves as a blameless sacrifice, * like a whole burnt and perfect offering * in your Martyrdom * O sacred and blessed Hierarchs; * pray Him to deliver from corruption and dangers * those who with faith and love ** celebrate your honored memory.", "p4 Aposticha 3", { spec_mel: "As one valiant among the martyrs ...", label: "plain" }),
      ],
      aposticha_glory: hx2("Ye were invincible Martyrs and lights of the universe, * unshakable pillars of the holy Church, * O all-famed Hierarchs * standards of learning, instructors of the faithful, * vanquishers of heresies, * O Divinely-wise Fathers, * radiant guides of our souls, * co-conversers with the Angels ** and champions of the Holy Trinity.", "p4 Aposticha Glory", { sourceLabel: "Glory ..., in Tone IV", tone: 4, label: "glory" }),
      aposticha_closer_label: hx1("Both now ..., in Tone IV:", 'p4 Both now label'),
      aposticha_closer_rubric: hx1("If the Celebration be with a Polyeleos, chant the Resurrection Theotokion:", 'p4 aposticha closer rubric'),
      aposticha_closer: hx2("Mercifully regard the supplications of thy servants, * O all-immaculate one, * quelling the cruel uprisings of the demons against us, * delivering us from every sorrow; * for thee alone do we have as a steadfast and sure confirmation, * and having acquired thine intercession; * let not us who call upon thee be put to shame, * O Sovereign Lady. * Hasten thou to answer the entreaties of those who cry out to thee with faith: * Rejoice, thou help, joy and protection of all, ** and the salvation of our souls!", "p4 Resurrection Theotokion", { tone: 4, type: "theotokion", label: "theotokion" }),
      aposticha_alternate: hx2("O all-hymned Theotokos! * purify my passionate heart from pollution, * and cleanse, O pure one, the festering wounds of sin from my soul, * make steadfast my mind, * so that I, thy sinful and unprofitable servant, ** may magnify thy might and thy great intercession.", "p4 Otherwise Theotokion", { sourceLabel: "Otherwise, Theotokion", type: "theotokion", label: "theotokion", label_inline: true }),
      aposticha_stavrotheotokion: hx2("Seeing Christ, the Lover of mankind, * crucified and with His side pierced with a lance, * the most pure one lamented, crying aloud: * “What is this, O my Son ? * What have the ungrateful people rendered unto Thee * in return for all the good things Thou hast rendered unto them ?” * And yet thou dost show thy tender compassion for me, * that I may endure my childlessness. ** I stand in awe, O Compassionate One, at Thy voluntary crucifixion.", "p4 Stavrotheotokion", { sourceLabel: "Stavrotheotokion", type: "stavrotheotokion", label: "stavrotheotokion", label_inline: true }),
      troparion_rubric: hx1("The Troparion from the Typicon; but, if there be none, chant the following:", 'p4 troparion rubric'),
      closer: { absent: true, reason: "not_printed_in_source", basis: "close_reading", note: "Slot printed as “Glory ..., Both now ..., Theotokion or Stavrotheotokion:” with no text — the conditional closer (§5.8, CLOSER_TYPES)." },
      closing_rubric: hx1("The Dismissal:", 'p4 Dismissal'),
    },
    ...
    matins: {
      order: ['god_is_lord_rubric', 'troparion', 'troparion_closer',
              ...
              'doxology_glory', 'doxology_closer_rubric', 'troparion_rubric',
              'troparion', 'closer', 'closing_rubric'],
      god_is_lord_rubric: hx1("On “God is the Lord ...,” the Troparion, in Tone IV:", 'p5 God is the Lord rubric'),
      troparion_closer: { absent: true, reason: "not_printed_in_source", basis: "close_reading", note: "Slot printed as “Glory ..., Both now ..., Theotokion or Stavrotheotokion:” and no text (§5.8)." },
      sessional_1_rubric: hx1("After the 1st chanting of the Psalter, the Sessional Hymn, in Tone VIII:", 'p5 sessional 1 rubric'),
      // “Of the wisdom” serves sessional 1 here — the SINGULAR spends it on
      // its Polyeleos sessional.
      sessional_1: hx2("Imparting wisdom from the depths of your spiritual knowledge, * O holy ones, * ye preached the One Divinity in Trinity * and clarified the bright mysteries of the orders of Angels, * You also brought order to the priesthood, O Divinely-wise ones, * wherefore, O Hieromartyrs, ye have entered into the intimate communion with Christ God. * Pray Him to grant the remission of sins ** unto those who with faith and love venerate your holy memory.", "p5 Sessional 1", { spec_mel: "Of the wisdom ...", tone: 8, repeat: 2 }),
      // "pas-sions" stored AS EXTRACTED (line-break hyphen kept) to match the
      // MonasticMartyrs copy of this SAME hymn byte-for-byte — the A-1 ruling
      // now governs two symmetric sites, and both would read "passions" if it
      // closes up.
      sessional_1_closer: hx2("As the all-immaculate Bride of the Creator, * Mother of the Redeemer, who knewest not a man, * and as the receptacle of the Comforter O all-hymned one, * hasten thou to deliver me, * the vile abode of iniquity and noetic plaything of the demons, * from their evil machinations; * and make me the bright dwelling-place of the virtues, * O thou incorrupt light-bearing one. * Drive away the clouds of the pas-sions and grant that, * by thy supplications, * I may receive a portion on high ** and share in the never-waning light.", "p5 Sessional 1 Theotokion", { sourceLabel: "Glory ..., Both now ..., Theotokion, in Tone VIII", tone: 8, type: "theotokion" }),
      sessional_2_rubric: hx1("After the 2nd chanting of the Psalter, the Sessional Hymn, in Tone V:", 'p5 sessional 2 rubric'),
      // “The Co-beginningless Word” — capital Co; Nun prints the same melody
      // lowercase.
      sessional_2: hx2("Instructing your minds with apostolic discourses * and carefully tending the flocks of the faithful, * O holy ones, ye offered yourselves as a pure sacrifice * unto your King and Creator * Who for our sake became incarnate from the Virgin Theotokos * and rose again in glory, * He Whom you confessed before the tyrants, * O Hieromartyrs.", "p5 Sessional 2", { spec_mel: "The Co-beginningless Word ...", tone: 5, repeat: 2 }),
      sessional_2_closer: hx2("O fervent and invincible intercessor, * diligent and unashamed hope, * rampart, protection and haven * of those who have recourse to thee, * O pure Ever-virgin do thou, together with the angels, * entreat thy Son and God, ** that He grant peace, salvation and great mercy to the world.", "p5 Sessional 2 Theotokion", { sourceLabel: "Glory ..., Both now ..., Theotokion, in Tone V", tone: 5, type: "theotokion" }),
      megalynarion_rubric: hx1("After the Polyeleos, the Megalynarion:", 'p5 megalynarion rubric'),
      megalynarion: hx1("We magnify you, O Hieromartyrs of Christ, and honor your holy memory, for ye pray for us to Christ our God.", 'p5 Megalynarion'),
      // “inhabit the World .” — the capital-W verse at its FOURTH site, and
      // here the full stop is stranded on its own line (sic register).
      megalynarion_verse: hx1("Hear this, all ye nations; give ear, all ye that inhabit the World .", "p5 Megalynarion verse", { sourceLabel: "Verse", label: "refrain" }),
      sessional_polyeleos_rubric: hx1("After the Polyeleos, the Sessional Hymn, in Tone I:", 'p6 Polyeleos sessional rubric'),
      sessional_polyeleos: hx2("By your labors you cultivated the fruit of the knowledge of God, * uprooting godlessness by the teaching of divine doctrines. * Anointed with the oil of grace you tended well the flocks given you, * and in the end, lawfully enduring Martyrdom, * wherefore ye were deemed worthy of double honors by Christ, * O Hieromartyrs. * Glory be to Him Who hath granted you such strength; * glory be to Him Who hath crowned you; * glory be to Him Who through you granteth healings unto all.", "p6 Polyeleos sessional", { spec_mel: "While the stone was sealed ...", tone: 1, repeat: 2 }),
      // Ends WITHOUT a full stop — second unstopped closer in the file (sic
      // register).
      sessional_polyeleos_closer: hx2("O most holy Virgin, * stretching forth thy divine hands * which have borne thy Creator, * Who for the sake of mercy assumed flesh, * entreat Him that those who praise thee with love, * may be delivered from temptations, passions, and dangers and cry aloud: * Glory to Him Who made His abode within thee! * Glory to Him Who came forth from thee! ** Glory to Him Who hath set us free by thy birthgiving", "p6 Polyeleos sessional Theotokion", { sourceLabel: "Glory ..., Both now ..., Theotokion, in Tone I", tone: 1, type: "theotokion" }),
      anabathmoi_rubric: hx1("If of Polyeleos rank, and not a Resurrection Service, chant the following:", 'p6 anabathmoi rubric'),
      anabathmoi_intro: hx1("The Song of Ascents: The first antiphon, in Tone IV:", 'p6 anabathmoi heading'),
      anabathmoi: [
        hx2("From my youth * do many passions war against me; * but do Thou Thyself defend ** and save me, O my Savior.", "p6 anabathmoi 1", { label: "plain" }),
        hx2("Ye haters of Zion * shall be shamed by the Lord; * for like grass, by the fire ** shall ye be withered.", "p6 anabathmoi 2", { label: "plain" }),
      ],
      anabathmoi_closer: hx2("In the Holy Spirit, * every soul is quickened, * and, through cleansing, is exalted ** and made radiant by the Triple Unity in a hidden sacred manner.", "p6 anabathmoi Glory Both now", { sourceLabel: "Glory ..., Both now ...,", label: ["glory", "both_now"] }),
      prokeimenon_rubric: hx1("Prokeimenon, in Tone IV:", 'p6 prokeimenon rubric'),
      prokeimenon: hx2("Precious in the sight of the Lord * is the death of His saints.", "p6 Prokeimenon", { sourceLabel: "Prokeimenon, in Tone IV", tone: 4, label_inline: true }),
      prokeimenon_verse: hx1("What shall I render unto the Lord for all that He hath rendered unto me?", "p6 Prokeimenon verse", { sourceLabel: "Verse", label: "refrain" }),
      gospel_rubric: hx1("Let every breath ...,", 'p6 Let every breath'),
      gospel: { heading: 'THE GOSPEL ACCORDING TO ST. MATTHEW',
        src: { file: HX, locus: 'p6 Matins Gospel' },
        citation_verbatim: '(5: 14-19)',
        citation: { book: 'Matthew', chapter: 5, verses: '14-19' },
        citation_basis: 'printed' },
      psalm50_rubric: hx1("After the 50th Psalm:", 'p7 After the 50th Psalm'),
      psalm50_sticheron: hx2("Through the prayers of the Holy Hieromartyrs (names), * O Merciful One, ** blot out the multitude of our transgressions.", "p7 Psalm 50 Glory", { sourceLabel: "Glory ..., in Tone VI", tone: 6, label: "glory" }),
      psalm50_closer: hx2("Through the prayers of the Theotokos, * O Merciful One, ** blot out the multitude of our transgressions.", "p7 Psalm 50 Both now", { sourceLabel: "Both now ...,", type: "theotokion", label: "both_now" }),
      psalm50_verse: hx2("Have mercy on me, O God, * according to Thy great mercy; * and according to the multitude of Thy compassions, ** blot out my transgressions.", "p7 Psalm 50 verse", { label: "refrain" }),
      sessional_post50_rubric: hx1("Then the Sessional Hymn, in Tone IV:", 'p7 post-Psalm-50 sessional rubric'),
      sessional_post50: hx2("Unshakable pillars of the Church of Christ, * ye have destroyed the strongholds of unbelief; * wherefore O Martyrs coming together from separate dioceses before your death, * ye vanquished the tempests of heresy, * we beseech you to pray for our souls.", "p7 post-Psalm-50 Sessional", { tone: 4 }),
      canon_rubric: hx1("The Canon, in Tone IV:", 'p7 Canon rubric'),
      canons: [{
        title: "The Canon, in Tone IV:", tone: 4,
        odes: {
          1: {
            // “by Moses” outstretched hands” — the Moses” defect, third site.
            irmos: hx2("Through the deep of the Red Sea, * marched dry shod Israel of old, * and by Moses” outstretched hands, * raised in the form of a cross, * the power of Amalek was routed in the wilderness.", "p7 Ode 1 irmos", { sourceLabel: "Irmos", label_inline: true }),
            refrain: hx1("Holy Hieromartyrs (names) pray to God for us", "p7 Ode 1 refrain", { sourceLabel: "Refrain", label_inline: true }),
            items: [
              hx1("Resplendent with the radiance of God’s light, O glorious ones, deliver those who reverently glorify your radiant and bright festival, from the fog of the passions.", "p7 Ode 1 troparion 1", { label: "plain" }),
              hx1("The wicked one was put to shame by Thy Martyrs and ministers, O Christ our King; for even though he attacked them relentlessly quivering with rebelliousness, he was unable to overcome their strength.", "p7 Ode 1 troparion 2", { label: "plain" }),
              hx1("Filled with life-creating spiritual waters, ye have given refreshment to those exhausted by the scorching wickedness of godlessness, guiding them to holy and salvific water.", "p7 Ode 1 troparion 3", { label: "plain" }),
              hx1("Through thy birth-giving, O most pure one, the sin of our forefathers hath been pardoned, and a way into paradise hath been opened for those who praise thee.", "p7 Ode 1 Theotokion", { sourceLabel: "Theotokion", label: "theotokion", label_inline: true }),
            ],
          },
          3: {
            irmos: hx2("Thy Church, O Christ, rejoiceth in Thee crying aloud: * Thou, O Lord, art my strength, * my refuge and foundation.", "p8 Ode 3 irmos", { sourceLabel: "Irmos", label_inline: true }),
            items: [
              hx1("Noetically enkindled with the fire of the Comforter and rejoicing therein, O Hieromartyrs, you have extinguished the raging flames of the wicked one.", "p8 Ode 3 troparion 1", { label: "plain" }),
              hx1("By the light of the Holy Spirit, O glorious ones, you have brought those who were in the abyss of darkness to the light of holy baptism.", "p8 Ode 3 troparion 2", { label: "plain" }),
              hx1("You appear unto all as gold refined by the fire of Martyrdom, O holy ones, carrying the seal of your sufferings as Martyrs.", "p8 Ode 3 troparion 3", { label: "plain" }),
              hx1("Thou hast given birth, O most pure and all-immaculate Virgin, to the mighty God who delivereth all mankind from the violence of the enemy.", "p8 Ode 3 Theotokion", { sourceLabel: "Theotokion", label: "theotokion", label_inline: true }),
            ],
          },
          4: {
            irmos: hx2("Beholding Thee, the Sun of righteousness, * lifted up upon the Cross, * the Church now standeth arrayed and doth worthily cry aloud: * Glory be to Thy power, O Lord!", "p8-p9 Ode 4 irmos", { sourceLabel: "Irmos", label_inline: true }),
            items: [
              hx1("Let the sacred choir of Hieromartyrs be hymned, since they are adorned with both the grace of the episcopacy and with Martyrdom, and let us sing joyously: “Glory to Thy power, O Lord.”", "p8-p9 Ode 4 troparion 1", { label: "plain" }),
              // “divinely ending your lives Martyrdom” — the “in” is not
              // on the page (sic register).
              hx1("Having been taught the divine mysteries, O God-bearing Fathers, you have truly tended well your flocks, in all righteousness and truth, divinely ending your lives Martyrdom.", "p8-p9 Ode 4 troparion 2", { label: "plain" }),
              hx1("Adorned with the sacred gifts of the Apostles and Prophets, the sacred choir of Hieromartyrs joyfully crieth aloud to Thee: “Glory to Thy power, O Lord.”", "p8-p9 Ode 4 troparion 3", { label: "plain" }),
              hx1("Taught by the word of God and beholding the fulfillment of what was spoken of thee, O Mother of God, as ones delivered by thy birth-giving we praise thee crying: “Rejoice, O most immaculate Virgin.”", "p8-p9 Ode 4 Theotokion", { sourceLabel: "Theotokion", label: "theotokion", label_inline: true }),
            ],
          },
          5: {
            irmos: hx2("Thou, O Lord, who camest into the world, * art my light, * a holy light turning from the darkness of ignorance * those who sing Thy praises in faith.", "p9 Ode 5 irmos", { sourceLabel: "Irmos", label_inline: true }),
            items: [
              hx1("With the divine illumination of most wise instruction, ye have shone the light of grace upon those sitting in the darkness of ignorance.", "p9 Ode 5 troparion 1", { label: "plain" }),
              hx1("Beholding Christ face to face, immersed now in the enjoyment of the ineffable divine light, entreat Him on our behalf.", "p9 Ode 5 troparion 2", { label: "plain" }),
              hx1("Filled with the divine rivers of Christ’s teaching, ye have stopped the streams of ignorance and filled the minds of the faithful with noetic refreshment.", "p9 Ode 5 troparion 3", { label: "plain" }),
              hx1("Having selected thee alone out of all generations, the Lord became incarnate from thee, O Theotokos, and thereby deified mankind.", "p9 Ode 5 Theotokion", { sourceLabel: "Theotokion", label: "theotokion", label_inline: true }),
            ],
          },
          6: {
            // “the blood of the demons”” — the demons” defect, FOURTH file.
            irmos: hx2("The church crieth out unto Thee O Lord, * “I will sacrifice unto Thee with a voice of praise” * having been cleansed of the blood of the demons” * by the blood that for mercy’s sake flowed from Thy side.", "p9 Ode 6 irmos", { sourceLabel: "Irmos", label_inline: true }),
            items: [
              hx1("Having passed through life in manliness and wisdom, the choirs of Thy saints, O Lord, now rejoice in Thee in truth, in prayer and in chastity.", "p9 Ode 6 troparion 1", { label: "plain" }),
              hx1("Sustained by the hope of eternal life, you cheerfully endured the rending of your bodies, O valiant and holy ones, emulating the sufferings of the divine Prophets.", "p9 Ode 6 troparion 2", { label: "plain" }),
              hx1("Having been educated in spiritual law, O most wise ones, you offered unto the lawless salutary laws and thus guided them into the light of Orthodoxy.", "p9 Ode 6 troparion 3", { label: "plain" }),
              hx1("In paradise of old Adam was dragged from life to death, but with thy life-creating birth-giving, O Virgin, he was made immortal, O most pure Bride of God.", "p9 Ode 6 Theotokion", { sourceLabel: "Theotokion", label: "theotokion", label_inline: true }),
            ],
          },
          7: {
            irmos: hx2("In the Persian furnace the youths and descendants of Abraham, * burning with a love of piety * rather than by a flame of fire, * cried aloud saying: * Blessed art Thou in the temple of Thy glory, O Lord.", "p10 Ode 7 irmos", { sourceLabel: "Irmos", label_inline: true }),
            items: [
              hx1("Made illustrious through the chrism of the episcopacy and through the divine blood of Martyrdom, O divinely-wise ones, ye have been exceedingly glorified on account of both, crying aloud: “Blessed art Thou in the temple of Thy glory, O Lord.”", "p10 Ode 7 troparion 1", { label: "plain" }),
              hx1("Instantly, O all-famed hieromartyrs, ye completely subdued the enticements of earthly things, when you were most gloriously honored with martyrdom, and while in your most pure bodies, cried aloud: “Blessed art Thou in the temple of Thy glory, O Lord.”", "p10 Ode 7 troparion 2", { label: "plain" }),
              hx1("Aware of the deceitful craftiness of the adversary, O glorious Hieromartyrs, ye repelled every rebellious illusion of the tyrants, chanting: “Blessed art Thou in the temple of Thy glory, O Lord.”", "p10 Ode 7 troparion 3", { label: "plain" }),
              hx1("The Lord Who hath clothed the earth with mist and the heavens with clouds, hath Himself put on mortal flesh from thy pure blood, O Virgin, clothing mankind with the raiment of immortal Glory.", "p10 Ode 7 Theotokion", { sourceLabel: "Theotokion", label: "theotokion", label_inline: true }),
            ],
          },
          8: {
            irmos: hx2("Having spread his hands, Daniel closed the lions’ jaws * in their den; * while the zealously pious youths, * girded with virtue, * quenched the power of the fire and cried aloud: * Bless ye the Lord, all ye works of the Lord.", "p10-p11 Ode 8 irmos", { sourceLabel: "Irmos", label_inline: true }),
            items: [
              hx1("Scourged with lashes and afflicted with bodily pangs, O Hieromartyrs, ye bestowed eternal life by your intercessions upon those who previously served inanimate gods and who, having been saved, ever cry out with you: “Bless ye the Lord, all ye works of the Lord.”", "p10-p11 Ode 8 troparion 1", { label: "plain" }),
              hx1("Like clusters of spiritual grapes, O Hieromartyrs, ye pour forth the wine of healing gladdening the hearts of all those who with faith praise you and cry aloud: “Bless ye the Lord, all ye works of the Lord.”", "p10-p11 Ode 8 troparion 2", { label: "plain" }),
              hx1("From the tombs of the Hieromartyrs a multitude of miracles have poured forth upon the Church of the faithful, vanquishing the deceptive illusions of the malicious demons, and vouchsafing an abundance of wondrous healings to those who cry aloud: “Bless ye the Lord, all ye works of the Lord.”", "p10-p11 Ode 8 troparion 3", { label: "plain" }),
              hx1("The pre-eternal One Who was born of thee, O most pure Virgin, hath voluntarily assumed the likeness and appearance of a man, dual in nature, activities and desires; Unto Him do we sing with faith: “Bless ye the Lord, all ye works of the Lord.”", "p10-p11 Ode 8 Theotokion", { sourceLabel: "Theotokion", label: "theotokion", label_inline: true }),
            ],
          },
          9: {
            irmos: hx2("A cornerstone not cut by hand O Virgin, * was cut from thee the unhewn mountain: * even Christ, Who hath joined together the disparate natures; * therefore rejoicing we magnify thee, * O Theotokos.", "p11 Ode 9 irmos", { sourceLabel: "Irmos", label_inline: true }),
            items: [
              hx1("Come O ye faithful, let us celebrate the sacred memory of the holy Hieromartyrs, and with solemn and sacred odes let us honor them who pray for us to our All-compassionate God.", "p11 Ode 9 troparion 1", { label: "plain" }),
              hx1("Consoled by the Word of God, you cleansed your souls of every defilement and by Martyrdom you stripped yourselves of your fleshly raiment, and put on the beautiful garment of salvation.", "p11 Ode 9 troparion 2", { label: "plain" }),
              hx1("O ye people, we are gathered together in memory of the Martyrs, that we may partake of the grace of the saints, and hymn the valiant Hieromartyrs who suffered manfully, crushing the originator of evil.", "p11 Ode 9 troparion 3", { label: "plain" }),
              hx1("As thou didst carry in thine arms O most pure one, Christ who by His will sustaineth all things, pray thou unto Him as thy Son, that I may be delivered from all assaults of the enemy, and encompassed by His mercy, may be saved.", "p11 Ode 9 Theotokion", { sourceLabel: "Theotokion", label: "theotokion", label_inline: true }),
            ],
          },
        },
      }],
      sessional_ode3_rubric: hx1("The Sessional Hymn, in Tone VIII:", 'p8 post-Ode-III sessional rubric'),
      // “Of the divine faith” — the melody the SINGULAR spends on sessional 1.
      sessional_ode3: hx2("Sanctified by the holy oil of unction, * ye have been revealed to your rational flock as wise pastors * and like the purest of lambs ye have sacrificed yourselves, * and were thus presented unto the Word and Chief Pastor, * Who Himself was slaughtered like a lamb, * O all-praised Martyrs, and lamps of all the universe, * wherefore with faith and love we celebrate your divine memorial.", "p8 post-Ode-III Sessional", { spec_mel: "Of the divine faith ...", tone: 8 }),
      // THIRD unstopped closer — “O thou who alone art blessed” and the page
      // moves on (sic register).
      sessional_ode3_closer: hx2("Thou art our refuge and strength O Theotokos, * the mighty help of all the world: * by thy supplications do thou protect thy servants from every want, ** O thou who alone art blessed", "p8 post-Ode-III Theotokion", { sourceLabel: "Glory ..., Both now ..., Theotokion, in Tone VIII", tone: 8, type: "theotokion" }),
      sessional_ode3_stavrotheotokion: hx2("Having obtained the Cross of thy Son as a staff of strength, * O Theotokos, * therewith we cast down the arrogance of the enemy, ** and with love unceasingly magnify thee.", "p8 post-Ode-III Stavrotheotokion", { sourceLabel: "Stavrotheotokion", type: "stavrotheotokion", label: "stavrotheotokion", label_inline: true }),
      // The rubric ends with a COMMA — “chant the following,” — and the label
      // line prints “Kontakion In Tone III” (capital-I class, second of four).
      kontakion_rubric: hx1("The Kontakion from the Typicon; if there be none, chant the following,", 'p9 Kontakion rubric'),
      exapostilarion_rubric: hx1("Exapostilarion in Tone III:", 'p11 exapostilarion rubric'),
      exapostilarion: hx2("This day hath been revealed as a special day set aside for us, * for it is a day in which we celebrate the solemn memory of the sacred successors of the holy Apostles * who are both God-bearing teachers of the faith * and invincible Martyrs.", "p11 Exapostilarion", { spec_mel: "Hearken, O ye women ...", tone: 3, repeat: 2 }),
      exapostilarion_closer: hx2("With the sprinkling of thy tender compassion, * O pure one, * cleanse the pollution of my soul, * and grant, O Maiden, that I may unceasingly pour forth tears ** which wither the streams of my passions.", "p11 Exapostilarion Theotokion", { sourceLabel: "Glory ..., Both now ..., Theotokion, in Tone III", tone: 3, type: "theotokion" }),
      praises_rubric: hx1("On the Praises, these Stichera, in Tone IV:", 'p11 Praises rubric'),
      praises: [
        hx2("With sacred unction and the blood of martyrdom, * ye have drawn near to God, * O all-glorious Hieromartyrs, * like blossoms of nature, ornaments of reason, and summits of wisdom, * your theology was purely Orthodox, and as true rules of faith, * you were examples of discipline to your flocks, * and the glory of the Orthodox Churches.", "p11-p12 Praises 1", { spec_mel: "As one valiant among the martyrs ...", label: "plain", tone: 4, repeat: 2 }),
        hx2("Directing all, O divinely-wise ones, * to offer adoration to the holy sufferers * and to glorify the holy Martyrs, * you prepared yourselves well to valiantly undertake diverse tortures, * bonds and imprisonment, * to be stripped naked, and bound in chains, * to be fearfully frozen, * to suffer cruel wounds and finally death, * O holy Hieromartyrs.", "p12 Praises 2", { spec_mel: "As one valiant among the martyrs ...", label: "plain" }),
        hx2("By a multitude of tortures * and by discarding the garment of the flesh through death, * O glorious Martyrs ye have been clothed in incorruptibility, * and now dwelling in the heavens, * ye ever stand before the throne of God; * wherefore with faith we celebrate your radiant memory, * embracing the shrine of your holy relics.", "p12 Praises 3", { spec_mel: "As one valiant among the martyrs ...", label: "plain" }),
      ],
      // “Glory ..., In Tone VIII” — capital-I class, third of four.
      praises_glory: hx2("Having passed your lives as Hierarchs * and died as Martyrs, * you were revealed to be faithful pastors who drank of the cup of Christ; * wherefore, ye were found acceptable to Christ * as both Hierarchs and as Martyrs, * now that ye dwell eternally in the never-waning light * we beseech you that, together with the hosts on high, * ye intercede in prayer before Him on our behalf.", "p12 Praises Glory", { sourceLabel: "Glory ..., In Tone VIII", tone: 8, label: "glory" }),
      praises_closer: hx2("Taking up the cry of the Archangel Gabriel, let us say: * Rejoice, O Mother of God, * who hast given birth unto Christ, ** the bestower of life upon the world!", "p12 Praises Both now", { sourceLabel: "Both now ..., Theotokion, in Tone VIII", tone: 8, type: "theotokion", label: ["both_now", "theotokion"] }),
      praises_stavrotheotokion: hx2("Beholding Thee O Lord Jesus, * nailed upon the cross and voluntarily accepting the passion, * the Virgin Mother cried aloud: * Woe is me, O my sweet Child! * how dost Thou wrongfully endure such wounds? * O compassionate Physician and healer of the infirmities of mankind, * Thou hast redeemed all from corruption ** by Thy tender compassion.", "p12 Stavrotheotokion", { sourceLabel: "Stavrotheotokion", type: "stavrotheotokion", label: "stavrotheotokion", label_inline: true }),
      great_doxology_rubric: hx1("The great Doxology: If a small Doxology is read, and a Doxasticon is appointed, the following is chanted after the Aposticha:", 'p12 great Doxology rubric'),
      doxology_glory: hx2("Ye were invincible Martyrs and lights of the universe, * unshakable pillars of the holy Church, * O all-famed Hierarchs * standards of learning, instructors of the faithful, * vanquishers of heresies, * O Divinely-wise Fathers, * radiant guides of our souls, * co-conversers with the Angels ** and champions of the Holy Trinity.", "p12 Doxology Glory", { sourceLabel: "Glory ..., in Tone IV", tone: 4, label: "glory" }),
      doxology_closer_rubric: hx1("Both now ..., Theotokion or Stavrotheotokion:", 'p12 Doxology closer rubric'),
      // “the Troparion, In Tone IV” — capital-I class, fourth of four.
      troparion_rubric: hx1("After Our Father ..., the Troparion, In Tone IV:", 'p12 after Our Father rubric'),
      closer: { absent: true, reason: "not_printed_in_source", basis: "close_reading", note: "Slot printed as “Glory ..., Both now ..., Theotokion or Stavrotheotokion:” with no text (§5.8)." },
      closing_rubric: hx1("The Dismissal:", 'p12 Dismissal'),
    },
    ...
    liturgy: {
      order: ['beatitudes_rubric', 'beatitudes', 'propers_rubric', 'troparion',
              'kontakion', 'prokeimenon', 'prokeimenon_verse', 'epistle',
              'alleluia', 'alleluia_verse', 'gospel', 'communion_verse'],
      beatitudes_rubric: hx1("Typika and Beatitudes.", 'p13 Typika and Beatitudes'),
      // Beatitude 1 alone is marked (Twice) — a repeat the canon site does
      // not carry: the first Beatitude row to bring its own rubric.
      beatitudes: [
        hx1("Noetically enkindled with the fire of the Comforter and rejoicing therein, O Hieromartyrs, you have extinguished the raging flames of the wicked one.", "p13 Beatitude 1", { label: "plain", repeat: 2 }),
        hx1("By the light of the Holy Spirit, O glorious ones, you have brought those who were in the abyss of darkness to the light of holy baptism.", "p13 Beatitude 2", { label: "plain" }),
        hx1("You appear unto all as gold refined by the fire of Martyrdom, O holy ones, carrying the seal of your sufferings as Martyrs.", "p13 Beatitude 3", { label: "plain" }),
        hx1("Having passed through life in manliness and wisdom, the choirs of Thy saints, O Lord, now rejoice in Thee in truth, in prayer and in chastity.", "p13 Beatitude 4", { label: "plain" }),
        hx1("Sustained by the hope of eternal life, you cheerfully endured the rending of your bodies, O valiant and holy ones, emulating the sufferings of the divine Prophets.", "p13 Beatitude 5", { label: "plain" }),
        hx1("Having been educated in spiritual law, O most wise ones, you offered unto the lawless salutary laws and thus guided them into the light of Orthodoxy.", "p13 Beatitude 6", { label: "plain" }),
        hx1("In paradise of old Adam was dragged from life to death, but with thy life-creating birth-giving, O Virgin, he was made immortal, O most pure Bride of God.", "p13 Beatitude 7", { sourceLabel: "Theotokion", label: "theotokion", label_inline: true }),
      ],
      propers_rubric: hx1("The Troparion and Kontakion from the Typicon; if there be none, chant the following:", 'p13 Liturgy propers rubric'),
      // THE ONE-WORD VARIANT SITE: “those that fast” against the canonical
      // p9 “those who fast” — stored locally because R-1 recycling requires
      // byte-identity and this site refuses it (register: variant).
      kontakion: hx2("We who have assembled today, * praise you in song as never-waning lights of the noetic Sun; * for having shone forth unto those in the darkness of ignorance, * ye called all to the heights of piety, * O holy Hieromartyrs. * Wherefore we cry unto you: ** Rejoice, O ye foundations of those that fast.", "p13 Liturgy Kontakion", { sourceLabel: "Kontakion of the Hieromartyrs, in Tone III", tone: 3 }),
      // The SAME prokeimenon text as Matins under a DIFFERENT announced tone
      // — Tone VII here, Tone IV there: first Matins/Liturgy prokeimenon
      // TONE mismatch on identical text (ledger B-5, physical-book check —
      // VII may be a misprint for IV, or the Grave-Tone appointment is real).
      prokeimenon: hx2("Precious in the sight of the Lord * is the death of His saints.", "p13 Liturgy Prokeimenon", { sourceLabel: "Prokeimenon, in Tone VII", tone: 7, label_inline: true }),
      prokeimenon_verse: hx1("What shall I render unto the Lord for all that He hath rendered unto me?", "p13 Liturgy Prokeimenon verse", { sourceLabel: "Verse", label: "refrain" }),
      // "THE EPISTLE OF ST. PAUL TO THE HEBREWS" — a heading form no sibling
      // uses (the singular prints "THE EPISTLE TO THE HEBREWS").
      epistle: { heading: 'THE EPISTLE OF ST. PAUL TO THE HEBREWS',
        src: { file: HX, locus: 'p13-p14 Epistle' },
        citation_verbatim: '(8: 1-6)',
        citation: { book: 'Hebrews', chapter: 8, verses: '1-6' },
        citation_basis: 'printed' },
      alleluia: hx1("Thy priests shall be clothed with righteousness, and thy righteous shall rejoice.", "p14 Alleluia", { sourceLabel: "Alleluia, in Tone II", tone: 2, label_inline: true }),
      alleluia_verse: hx1("For the Lord hath elected Zion; He hath chosen Her to be a habitation for Himself.", "p14 Alleluia verse", { sourceLabel: "Verse", label: "refrain" }),
      gospel: { heading: 'THE HOLY GOSPEL ACCORDING TO ST. LUKE',
        src: { file: HX, locus: 'p14 Liturgy Gospel' },
        citation_verbatim: '(14:25-35)',
        citation: { book: 'Luke', chapter: 14, verses: '25-35' },
        citation_basis: 'printed' },
      // The semicolon form — third file (MonasticMartyrs, Hieromartyr).
      communion_verse: hx1("Rejoice in the Lord, O ye righteous; praise is meet for the upright.", "p14 Communion verse", { sourceLabel: "Communion Verse", label_inline: true }),
    },
  },
  HieroConfessor: {
    // A DUAL-SUBJECT FILE — the title serves a Hiero-Confessor OR a Monk-
    // Confessor, and the book provides for both: two megalynaria under a
    // “For a Monk-confessor:” alternate rubric, a monastic (Wisdom ×3)
    // lesson set, and a monks'-multitude Doxasticon.
    title: hc1("THE GENERAL VIGIL SERVICE TO A HIERO-CONFESSOR OR MONK-CONFESSOR.", 'p1 title'),

    // FOUR SITES, THREE STATES — the second R-1 refusal in the corpus, and
    // worse than the first: p4/p5 print “instructor … ** entreat … be
    // saved.” (canonical); p12 prints “instruction of Hierarchs” and “may
    // be saved.”; p13 prints “instructor … be saved.” but points the final
    // clause with a SINGLE asterisk. The p12 and p13 copies are stored at
    // their sites (matins.troparion_after_our_father, liturgy.troparion).
    troparion: hc2("Teacher of Orthodoxy, instructor of piety and chastity, * luminary of the Church, God-inspired instructor of Hierarchs, * O most wise (name), thou hast illumined all by thy teaching; ** entreat Christ God that our souls be saved.", "p4 Troparion", { sourceLabel: "Troparion, in Tone VIII", verified_sites: [{"locus": "p4 Vespers dismissal", "tone": 8}, {"locus": "p5 God is the Lord", "tone": 8, "repeat": 2}] }),
    // The kontakion's two sites ARE byte-identical (generator-verified) —
    // including the missing stop at “the flesh * Revealed” (sic register).
    // Only the LABELS flex case: “Kontakion of the Holy Confessor” at p9,
    // “of the holy confessor” at p13.
    kontakion: hc2("Finding delight in abstinence, * thou hast subdued the desires of the flesh * Revealed to be nurtured in the faith, * thou hast blossomed like the tree of life in paradise, ** O sacred Father (name).", "p9 Kontakion after Ode VI", { sourceLabel: "Kontakion of the Holy Confessor, in Tone II", tone: 2, verified_sites: [{"locus": "p9 after Ode VI", "tone": 2}, {"locus": "p13 AT LITURGY", "tone": 2}] }),
    ikos: hc1("Standing now before God, O most glorious, most sacred, and holy Confessor (name), by thy God-pleasing prayers open my lips, that I may hymn thy blessed life and worthily describe thy virtues which, fervently loving God, thou hast practiced on earth; for thou wast revealed to be a fearless confessor, loving vigilance, purity, and abstinence, by which thou hast set aright the faith, O sacred Father (name).", "p10 Ikos", { sourceLabel: "The Ikos", label_inline: true }),
    ...
    vespers: {
      order: ['lic_rubric', 'lic', 'lic_closer', 'lic_stavrotheotokion',
              ...
              'aposticha_closer', 'aposticha_alternate', 'aposticha_stavrotheotokion',
              'troparion_rubric', 'troparion', 'closer', 'closing_rubric'],
      lic_rubric: hc1("On “Lord, I have cried ...,” the Stichera, in Tone IV:", 'p1 LIC rubric'),
      // “O God inspired holy Father” — unhyphenated where this same file
      // prints “God-inspired” in its own troparion (sic register).
      lic: [
        hc2("We know thee, * O God inspired holy Father (name), * to be the foundation of truth * and confirmation of the faith, * the elucidation of dogmas and a model of piety, * an abode of purity, a select vessel, * the sweet redolence of the Spirit, * a great treasury of doctrines ** and a foundation of the Church of Christ.", "p1 LIC 1", { spec_mel: "As one valiant among the martyrs ...", label: "plain", tone: 4 }),
        hc2("We praise thee, * O God-bearing, all-praised, most wise (name) * as a successor to the Apostles, * as one sharing the temperament of the Confessors, * a zealous emulator of ascetics, * the seal of teachers, * a divine representative of the sages of God, * a God-flowing river of understanding ** which drowneth the thoughts of blaspheming heretics.", "p1 LIC 2", { spec_mel: "As one valiant among the martyrs ...", label: "plain" }),
        hc2("Increasing thy talent of wisdom * O spiritually rich (name), * thou wast deemed worthy * to participate in the joy of thy Lord; * adorned with the bright illumination * of divine grace * and spiritual radiance, * standing now before the life-creating right hand of God, ** thou art eternally resplendent.", "p1 LIC 3", { spec_mel: "As one valiant among the martyrs ...", label: "plain" }),
      ],
      // The text Heiromartyrs prints as its APOSTICHA alternate serves here
      // as the LIC closer — the wandering-slot pattern again (register).
      lic_closer: hc2("O all-hymned Theotokos! * purify my passionate heart from pollution, * and cleanse, O pure one, the festering wounds of sin from my soul, * make steadfast my mind, * so that I, thy sinful and unprofitable servant, ** may magnify thy might and thy great intercession.", "p1 LIC closer", { sourceLabel: "Glory ..., Both now ..., Theotokion, in Tone IV", tone: 4, type: "theotokion", label: ["glory", "both_now", "theotokion"] }),
      lic_stavrotheotokion: hc2("Seeing Christ, the Lover of mankind, * crucified and with His side pierced with a lance, * the most pure one lamented, crying aloud: * “What is this, O my Son ? * What have the ungrateful people rendered unto Thee * in return for all the good things Thou hast rendered unto them ?” * And yet thou dost show thy tender compassion for me, * that I may endure my childlessness. ** I stand in awe, O Compassionate One, at Thy voluntary crucifixion.", "p1 Stavrotheotokion", { sourceLabel: "Stavrotheotokion", type: "stavrotheotokion", label: "stavrotheotokion", label_inline: true }),
      idiomelon_rubric: hc1("If an Idiomelon be appointed, Glory ..., in Tone VI:", 'p1 idiomelon rubric'),
      lic_glory: hc2("Grace poured forth abundantly from thy lips, * O glorious Father (name), * lamp of the Church of Christ, * ever teaching the spiritual sheep to believe in the Divinity one in essence ** and the Consubstantial Trinity.", "p1 Glory idiomelon", { sourceLabel: "Glory ..., in Tone VI", tone: 6, label: "glory" }),
      // “for that service):” — NO space before the close paren: the FIRST
      // file since Monastic's family to print this rubric without the
      // travelling “service ):” space.
      dogmatikon_rubric: hc1("If the Celebration be with a Polyeleos, and not a Resurrection Service, sing the following Dogmatic in Tone VI (If the service is a Resurrection service sing the Dogmatic of the Tone for that service):", 'p1 dogmatikon rubric'),
      dogmatikon: hc2("Who doth not call thee blessed, O most holy Virgin? * Who will not hymn thy most pure birthgiving? * For the only-begotten Son Who hath shone forth timelessly from the Father, * came forth, ineffably incarnate, from thee, O pure one; * By nature he is God, by nature for our sakes, he hath become a man * not divided into two Hypostases, * but known in two natures without commingling. * Him do thou beseech, O pure and most blessed one, ** that our souls find mercy!", "p2 Both now dogmatic", { sourceLabel: "Both now ..., in Tone VI", tone: 6, type: "dogmatic_theotokion", label: "both_now" }),
      // “those that asketh … receiveth” — singular verbs on plural subjects,
      // captured verbatim.
      dogmatikon_alternate: hc2("No one that fleeth unto thee, O most pure Virgin Theotokos, * departeth from thee ashamed; * for those that asketh grace of thee, ** ever receiveth a gift for their profitable petition.", "p2 Otherwise Theotokion", { sourceLabel: "Otherwise, Theotokion", type: "theotokion", label: "theotokion", label_inline: true }),
      dogmatikon_stavrotheotokion: hc2("The most pure one seeing Thee hanging upon the cross * with maternal tears cried aloud to Thee: * “O my Son and God, * O my sweetest Child, * how is it that Thou sufferest ** such a shameful death?”", "p2 Stavrotheotokion", { sourceLabel: "Stavrotheotokion", type: "stavrotheotokion", label: "stavrotheotokion", label_inline: true }),
      entrance_rubric: hc1("The Entrance. The Prokeimenon of the day. The Three Lessons, if appointed.", 'p2 Entrance rubric'),
      // The MONASTIC lesson set (Wisdom ×3, no Isaiah) — the dual subject's
      // monastic face. And this file's Wisdom 5 is a DIFFERENT, CORRECT
      // rendering: "The righteous live for evermore", "right-aiming
      // thunderbolts", and a clean "stone bow" where five siblings print the
      // sIn-Tone corruption — the uncorrupted copy exists in the same book.
      // (Its own defect: "Hear, therefore, aye kings" for "O ye kings".)
      // Headings flex their article: THE READING (L1), A READING (L2, L3).
      readings: [
        { heading: 'THE READING FROM THE WISDOM OF SOLOMON',
          src: { file: HC, locus: 'p2 Lesson 1' },
          citation: { book: 'Wisdom of Solomon', chapter: 3, verses: '3:1-3:9' },
          citation_basis: 'identified',
          provenance_note: 'The "souls of the righteous" lesson. Identified; confirm against the page.' },
        { heading: 'A READING FROM THE WISDOM OF SOLOMON',
          src: { file: HC, locus: 'p2-p3 Lesson 2' },
          citation: { book: 'Wisdom of Solomon', chapter: 5, verses: '5:15-6:3' },
          citation_basis: 'identified',
          provenance_note: 'The "righteous live FOR EVERMORE" rendering — a different translation from the "unto the ages" copy five siblings share, and FREE of the sIn-Tone corruption ("cast as out of a stone bow" prints correctly). Identified; confirm against the page.' },
        { heading: 'A READING FROM THE WISDOM OF SOLOMON',
          src: { file: HC, locus: 'p3 Lesson 3' },
          citation: { book: 'Wisdom of Solomon', chapter: 4, verses: '4:7-15' },
          citation_basis: 'identified',
          provenance_note: 'The "righteous prevented with death" lesson — the monastic third lesson. Identified; confirm against the page.' },
      ],
      aposticha_rubric: hc1("On the Aposticha, these Stichera, in Tone VIII:", 'p3 Aposticha rubric'),
      // Sticheron 2: “the calm haven of Christ. * truly radiant” — lowercase
      // after a full stop, captured verbatim.
      aposticha: [
        hc2("O all-wise Father (name), * thou hast illumined the Church of Christ * with thine odes, * likened unto those of David * by the grace of the Spirit, * O most glorious Father, * striking the harp * and chanting things divine, ** thine odes draw all to the Church.", "p3 Aposticha 1", { spec_mel: "O most glorious wonder ...", label: "plain", tone: 8 }),
        hc2("Precious in the sight of the Lord * is the death of His saints.", "p3 Aposticha verse 1", { sourceLabel: "Verse", label: "refrain" }),
        hc2("O most glorious Father (name), * abandoning the unruly noise of the world, * thou, O holy one, * didst reach the calm haven of Christ. * truly radiant with spiritual richness * through the contemplation of the Divinity, * reflecting them upon the faithful, * before whom thou didst shine ** with thy God-pleasing life.", "p3 Aposticha 2", { spec_mel: "O most glorious wonder ...", label: "plain" }),
        hc2("Blessed is the man that feareth the Lord, * in His commandments shall he greatly delight.", "p3 Aposticha verse 2", { sourceLabel: "Verse", label: "refrain" }),
        hc2("Come, O ye born of earth, * let us today devoutly honor with hymns * the sacred and honorable memory of holy (name); * for, behold, in truth he hath been deemed worthy * to embrace the divine light. * O how ineffable is Thy kindness, * O Lord and Master, * through which we learned to glorify Thee, ** the most compassionate One!", "p3 Aposticha 3", { spec_mel: "O most glorious wonder ...", label: "plain" }),
      ],
      // “Glory ..., in the same tone and melody:” — the FIRST same-tone-and-
      // melody Glory label in eighteen files; the Doxasticon reprint at p12
      // spells the tone and melody out. A monks'-multitude text — the dual
      // subject's monastic face at the Glory.
      aposticha_glory: hc2("We, the multitude of monks, * honor thee as our instructor, O Father (name), * for we have learned from the path trodden by thee * to conduct ourselves virtuously. * Blessed art thou for having labored for Christ * and subduing the enemy, * O friend of Angels, * and companion of the righteous and holy, ** with them entreat the Lord that our souls may be saved.", "p4 Aposticha Glory", { sourceLabel: "Glory ..., in the same tone and melody", tone: 8, spec_mel: "O most glorious wonder ...", label: "glory" }),
      aposticha_closer_label: hc1("Both now ..., in Tone VIII:", 'p4 Both now label'),
      aposticha_closer_rubric: hc1("If the Celebration be with a Polyeleos, chant the Resurrection Theotokion:", 'p4 aposticha closer rubric'),
      aposticha_closer: hc2("O unwedded Virgin! * thou who ineffably conceived God in the flesh, * Mother of God Most High: * accept the supplications of thy servants, O all-immaculate one, * granting unto all cleansing of transgressions; * and, accepting now our supplications, ** pray thou that we all be saved.", "p4 Resurrection Theotokion", { tone: 8, type: "theotokion", label: "theotokion" }),
      // = Heiromartyrs' DOGMATIKON alternate, here at the aposticha — the
      // wandering-slot pattern (register).
      aposticha_alternate: hc2("I flee to thy protection, O holy Virgin Theotokos, * for I know that through thee I shall obtain salvation; ** for thou art able to help me, O pure one.", "p4 Otherwise Theotokion", { sourceLabel: "Otherwise, Theotokion", type: "theotokion", label: "theotokion", label_inline: true }),
      aposticha_stavrotheotokion: hc2("The unblemished heifer, beholding her Bullock * willingly nailed upon the Tree, * cried out aloud, lamenting piteously: * “Woe is me, O my most beloved Child! * How hath the ungrateful assembly of the Jews rewarded Thee, * desiring to leave me childless and bereft of Thee, ** O my most beloved Child?”", "p4 Stavrotheotokion", { sourceLabel: "Stavrotheotokion", type: "stavrotheotokion", label: "stavrotheotokion", label_inline: true }),
      // The rubric runs straight into the Troparion label with NO colon —
      // “chant the following” / “Troparion, in Tone VIII:”.
      troparion_rubric: hc1("The Troparion from the Typicon; but if there be none, chant the following", 'p4 troparion rubric'),
      closer: { absent: true, reason: "not_printed_in_source", basis: "close_reading", note: "Slot printed as “Glory ..., Both now ..., Theotokion or Stavrotheotokion:” with no text — the conditional closer (§5.8, CLOSER_TYPES)." },
      closing_rubric: hc1("The Dismissal:", 'p4 Dismissal'),
    },
    ...
    matins: {
      order: ['god_is_lord_rubric', 'troparion', 'troparion_closer',
              ...
              'sessional_2_rubric', 'sessional_2', 'sessional_2_closer',
              'megalynarion_rubric', 'megalynarion', 'megalynarion_verse',
              'megalynarion_alternate_rubric', 'megalynarion_alternate',
              'megalynarion_alternate_verse',
              'sessional_polyeleos_rubric', 'sessional_polyeleos',
              'sessional_polyeleos_closer', 'anabathmoi_rubric', 'anabathmoi_intro',
              'anabathmoi', 'anabathmoi_closer', 'prokeimenon_rubric', 'prokeimenon',
              'prokeimenon_verse', 'gospel_rubric', 'gospel', 'psalm50_rubric',
              ...
              'praises_stavrotheotokion', 'great_doxology_rubric',
              'doxology_glory', 'doxology_closer_rubric', 'troparion_rubric',
              'troparion_after_our_father', 'closer', 'closing_rubric'],
      god_is_lord_rubric: hc1("On “God is the Lord ...,” the Troparion in Tone VIII:", 'p5 God is the Lord rubric'),
      troparion_closer: { absent: true, reason: "not_printed_in_source", basis: "close_reading", note: "Slot printed as “Glory ..., Both now ..., Theotokion or Stavrotheotokion:” and no text (§5.8)." },
      sessional_1_rubric: hc1("After the 1st chanting of the Psalter, the Sessional Hymn, in Tone IV:", 'p5 sessional 1 rubric'),
      // “Having been lifted up” — the melody the singular Hieromartyr spends
      // on its KONTAKION serves sessional 1 here.
      sessional_1: hc2("Forsaking the enjoyment of earthly and corruptible things, * the comeliness of the world and temporal pleasures, * thou didst live the eremitic life, * and wast deemed worthy to be numbered with the choirs of Confessors and ascetics; * with them pray that thy servants may be saved.", "p5 Sessional 1", { spec_mel: "Having been lifted up ...", tone: 4, repeat: 2 }),
      // “Theotokion in Tone IV” — comma dropped before the tone, at all
      // three kathisma-closer labels in this file.
      sessional_1_closer: hc2("O all-immaculate unwedded Virgin, * who hath given birth to the pre-eternal Son and Word of God, * do thou, together with the holy and venerable Apostles, Confessors, Prophets and Monastics * entreat Him to grant us cleansing and great mercy.", "p5 Sessional 1 Theotokion", { sourceLabel: "Glory ..., Both now ..., Theotokion in Tone IV", tone: 4, type: "theotokion" }),
      sessional_2_rubric: hc1("After the 2nd chanting of the Psalter, the Sessional Hymn, in Tone IV:", 'p5 sessional 2 rubric'),
      sessional_2: hc2("Following Christ, thou hast forsaken the world * and by abstinence subdued thy flesh, * wherefore O most blessed (name), * thou wast anointed with the unction of consecration * and hast now passed over to the incorporeal choirs, ** interceding on behalf of us who praise thee.", "p5 Sessional 2", { spec_mel: "Go thou quickly before ...", tone: 4, repeat: 2 }),
      sessional_2_closer: hc2("O most pure one, * thou alone hast given birth to the Creator of all, * and adorned mankind with thy birth-giving, * deliver me from the snares of the flattering Belial, * and set me upon the rock of Christ’s commandments, ** fervently entreating Him, to Whom thou hast given flesh.", "p5 Sessional 2 Theotokion", { sourceLabel: "Glory ..., Both now ..., Theotokion in Tone IV", tone: 4, type: "theotokion" }),
      megalynarion_rubric: hc1("After the Polyeleos, the Megalynarion:", 'p5 megalynarion rubric'),
      megalynarion: hc1("We magnify thee, O Hierarch, Father (name), and honor thy holy memory, for thou dost pray for us unto Christ our God.", 'p5 Megalynarion'),
      // The capital-W verse — FIFTH megalynarion site, clean stop this time.
      megalynarion_verse: hc1("Hear this, all ye nations; give ear, all ye that inhabit the World.", "p5 Megalynarion verse", { sourceLabel: "Verse", label: "refrain" }),
      // THE DUAL SUBJECT GETS DUAL MEGALYNARIA — first file to print an
      // alternate megalynarion under its own conditional rubric, with its
      // own verse (the Nun/Nuns “With patience” verse, byte-checked in the
      // register; the megalynarion itself is the Nun text regendered).
      megalynarion_alternate_rubric: hc1("For a Monk-confessor:", 'p5 Monk-confessor rubric'),
      megalynarion_alternate: hc1("We bless thee, O Venerable Father (name), and we honor thy holy memory, Instructor of monks, and converser with the angels.", 'p5 Monk-confessor Megalynarion'),
      megalynarion_alternate_verse: hc1("With patience I waited patiently for the Lord, and He was attentive unto me, and He hearkened unto my supplication.", "p5 Monk-confessor verse", { sourceLabel: "Verse", label: "refrain" }),
      sessional_polyeleos_rubric: hc1("After the Polyeleos the Sessional Hymn, in Tone III:", 'p6 Polyeleos sessional rubric'),
      sessional_polyeleos: hc2("Enlightened by the Divine Spirit, * thou didst boldly proclaim Orthodoxy, O all-blessed (name), * putting to shame the lawless tyrant, even suffering banishment. * O holy Father! Entreat Christ God * to grant remission of sins ** unto those who lovingly venerate thy holy memory.", "p6 Polyeleos sessional", { spec_mel: "Of the divine faith ...", tone: 3, repeat: 2 }),
      // = Hieromartyr's post-Ode-III closer (and Heirarchs', Apostle's) —
      // here serving the POLYELEOS sessional: the wandering-slot pattern.
      sessional_polyeleos_closer: hc2("Whither doth each one who is saved, * rightly have recourse; * and to what other such refuge can there be * which doth protect our souls like thee, ** O Theotokos?", "p6 Polyeleos sessional Theotokion", { sourceLabel: "Glory ..., Both now ..., Theotokion, in Tone III", tone: 3, type: "theotokion" }),
      anabathmoi_rubric: hc1("If of Polyeleos rank, and not a Resurrection Service, chant the following:", 'p6 anabathmoi rubric'),
      anabathmoi_intro: hc1("The Song of Ascents: The first antiphon, in Tone IV:", 'p6 anabathmoi heading'),
      anabathmoi: [
        hc2("From my youth * do many passions war against me; * but do Thou Thyself defend ** and save me, O my Savior.", "p6 anabathmoi 1", { label: "plain" }),
        hc2("Ye haters of Zion * shall be shamed by the Lord; * for like grass, by the fire ** shall ye be withered.", "p6 anabathmoi 2", { label: "plain" }),
      ],
      anabathmoi_closer: hc2("In the Holy Spirit, * every soul is quickened, * and, through cleansing, is exalted ** and made radiant by the Triple Unity in a hidden sacred manner.", "p6 anabathmoi Glory Both now", { sourceLabel: "Glory ..., Both now ...,", label: ["glory", "both_now"] }),
      // A DOUBLE LABEL: the line “Prokeimenon, in Tone IV:” and then “The
      // Prokeimenon:” again before the text — first double-labelled
      // prokeimenon in the corpus.
      prokeimenon_rubric: hc1("Prokeimenon, in Tone IV:", 'p6 prokeimenon rubric'),
      prokeimenon: hc2("Precious in the sight of the Lord * is the death of His saints.", "p6 Prokeimenon", { sourceLabel: "The Prokeimenon", tone: 4, label_inline: true }),
      // Lowercase “he hath rendered” — NOT a defect: this is the MATINS-family
      // form of the verse, byte-identical with Monastic, Monastics, Heirarchs
      // and MonasticMartyrs; the Liturgy family capitalizes.
      prokeimenon_verse: hc1("What shall I render unto the Lord for all that he hath rendered unto me?", "p6 Prokeimenon verse", { sourceLabel: "Verse", label: "refrain" }),
      gospel_rubric: hc1("Let every breath.", 'p6 Let every breath'),
      // Matins and Liturgy read the SAME pericope (Luke 12:8-12) — first file
      // to do so; the Matins heading adds HOLY and a trailing colon, and its
      // body opens "The Lord said unto His Disciples:" against the Liturgy's
      // "The Lord said:" — one pericope, two dressings.
      gospel: { heading: 'THE HOLY GOSPEL ACCORDING TO ST. LUKE',
        src: { file: HC, locus: 'p6 Matins Gospel' },
        citation_verbatim: '(12, 8-12):',
        citation: { book: 'Luke', chapter: 12, verses: '8-12' },
        citation_basis: 'printed' },
      psalm50_rubric: hc1("After the 50th Psalm:", 'p6 After the 50th Psalm'),
      // “of Holy Confessor (name)” — no article, where siblings print “of
      // the …”.
      psalm50_sticheron: hc2("Through the prayers of Holy Confessor (name), * O Merciful One, ** blot out the multitude of our transgressions.", "p7 Psalm 50 Glory", { sourceLabel: "Glory ..., in Tone VI", tone: 6, label: "glory" }),
      psalm50_closer: hc2("Through the prayers of the Theotokos, * O Merciful One, ** blot out the multitude of our transgressions.", "p7 Psalm 50 Both now", { sourceLabel: "Both now ...,", type: "theotokion", label: "both_now" }),
      psalm50_verse: hc2("Have mercy on me, O God, * according to Thy great mercy; * and according to the multitude of Thy compassions, ** blot out my transgressions.", "p7 Psalm 50 verse", { label: "refrain" }),
      sessional_post50_rubric: hc1("Then the Sessional Hymn, in Tone VI:", 'p7 post-Psalm-50 sessional rubric'),
      // “by Thine intercessions” — the saint's pronoun capitalized as if
      // divine, captured verbatim.
      sessional_post50: hc2("O venerable Father! * the sounds of thine instructions have gone forth throughout all the earth, * for contemplating the orders of Angels * thou didst faultlessly emulate them in thy life, * destroying the armies of the demons, * wherefore, thou hast reaped the rewards of thy labors in heaven. * Having boldness now before Christ God, ** by Thine intercessions grant peace unto our souls.", "p7 post-Psalm-50 Sessional", { tone: 6 }),
      canon_rubric: hc1("The Canon, in Tone VI:", 'p7 Canon rubric'),
      canons: [{
        title: "The Canon, in Tone VI:", tone: 6,
        odes: {
          1: {
            irmos: hc2("When Israel walked on foot in the sea as on dry land, * on seeing their pursuer Pharaoh drowned, * they cried: * Let us sing to God * a song of victory.", "p7 Ode 1 irmos", { sourceLabel: "Irmos", label_inline: true }),
            // NO REFRAIN PRINTED — first canon in eighteen files without
            // one; the irmos runs straight into the first troparion.
            refrain: { absent: true, reason: "not_printed_in_source", basis: "close_reading", note: "Every prior file prints a Refrain line after the Ode I irmos; this canon has none." },
            items: [
              hc1("With all his thoughts our Holy Father (name) loved Thee, O Jesus, and with all his heart was ready to suffer for Thee, enduring sorrows, affliction and suffering, thereby attaining to everlasting grace.", "p7 Ode 1 troparion 1", { label: "plain" }),
              hc1("With the drops of thy sacred blood thou hast assuaged the bitter seas of unbelief; and as Christ’s sacred river, thou dost ever give proper refreshment to the Church.", "p7 Ode 1 troparion 2", { label: "plain" }),
              hc1("Thou, O glorious (name), bringing unto God the ascetic feats accomplished by thee on earth, wast deemed worthy to receive a crown in the heavenly Kingdom and to inherit tranquil everlasting life.", "p7 Ode 1 troparion 3", { label: "plain" }),
              // “thou hast, conceived the True God” — a comma between
              // auxiliary and verb (sic register).
              hc1("Adorned with the beauty of virtues O pure Mother of God, thou hast, conceived the True God Who illumineth all with divine virtues.", "p7 Ode 1 Theotokion", { sourceLabel: "Theotokion", label: "theotokion", label_inline: true }),
            ],
          },
          3: {
            irmos: hc2("There is none as holy as Thou, * O Lord my God, * who hast exalted the horn of Thy faithful O good One, * and strengthened us upon the rock * of Thy confession.", "p7-p8 Ode 3 irmos", { sourceLabel: "Irmos", label_inline: true }),
            items: [
              hc1("Giving neither repose unto thine eyelids, nor sleep unto thine eyes, O holy Father (name), till thou wast shown to be a temple of the Holy Trinity and a treasury of wisdom, thou hast enriched the world with thy teachings, resplendent as gold, O blessed one.", "p7-p8 Ode 3 troparion 1", { label: "plain" }),
              hc1("Locked up in prisons, O divinely-wise (name), thou wast a gate-keeper of the divine commandments, and by instruction thou didst open unto the faithful the gates leading to the path of perfect understanding.", "p7-p8 Ode 3 troparion 2", { label: "plain" }),
              hc1("Like a soldier in the divine army, and strengthened by divine might, O all-sacred sufferer (name), thou hast vanquished the arrogant insolence of the lawless by thy firm confession.", "p7-p8 Ode 3 troparion 3", { label: "plain" }),
              hc1("The Wisdom and Word of the Father, Who existed before all ages, and in these latter days was ineffably incarnate from thee, hath made thee the Mother of God, O thou who knewest not wedlock.", "p7-p8 Ode 3 Theotokion", { sourceLabel: "Theotokion", label: "theotokion", label_inline: true }),
            ],
          },
          4: {
            irmos: hc2("Christ is my power, * my God and my Lord, * the holy Church divinely singeth, * crying with a pure mind, * keeping festival in the Lord.", "p8 Ode 4 irmos", { sourceLabel: "Irmos", label_inline: true }),
            items: [
              hc1("As if with a lance, thou hast, with thy words, pierced godlessness, and as if with a sword thou hast, by thy sufferings, obtained victory over the armies of demons, from whose malice deliver those who venerate thee, O all-praised (name).", "p8 Ode 4 troparion 1", { label: "plain" }),
              hc1("The sacred Confessor (name) cried out: I will not sacrifice to idols, neither do I fear death or physical tortures, for I confess One God known in the Trinity.", "p8 Ode 4 troparion 2", { label: "plain" }),
              hc1("Beholding the glorious height of thy humility, the Lord hath granted thee words of divine inspiration, with which, O Father, thou hast humbled the dark falsehoods of heretics.", "p8 Ode 4 troparion 3", { label: "plain" }),
              hc1("We bless thee, O Virgin, as the door and entrance leading into divine paradise, as the spiritual haven of sanctity, and as the beauty of Jacob.", "p8 Ode 4 Theotokion", { sourceLabel: "Theotokion", label: "theotokion", label_inline: true }),
            ],
          },
          5: {
            irmos: hc2("Illumine with Thy divine light, I pray, O Good One, * the souls of those who with love rise early to pray to Thee, * that they may know Thee, O Word of God, * as the true God, * Who recalleth us from the darkness of sin.", "p9 Ode 5 irmos", { sourceLabel: "Irmos", label_inline: true }),
            items: [
              hc1("With the flow of thy tears, O all-wise Father (name), thou hast dried up the abyss of temporal delights, and by the outpouring of thy teaching thou hast dammed the torrents of heresies.", "p9 Ode 5 troparion 1", { label: "plain" }),
              hc1("O Father (name), thou wast shown to be a truly spacious temple of the Holy Trinity, adorned with grace, resplendent with honorable virtues and illuminating humility.", "p9 Ode 5 troparion 2", { label: "plain" }),
              hc1("By thine endurance thou didst vanquish the uprisings of the evil one, O glorious (name), deliver me from his assaults, and grant me courage, setting me aright on the path that leads to God.", "p9 Ode 5 troparion 3", { label: "plain" }),
              hc1("We hymn Him Who came forth from thee, O all-pure one, and Who hath taken mortal flesh, revealed in His birth as uncommingled with his Divinity.", "p9 Ode 5 Theotokion", { sourceLabel: "Theotokion", label: "theotokion", label_inline: true }),
            ],
          },
          6: {
            irmos: hc2("Beholding the sea of life surging with the tempest of temptations, * I run to Thy calm haven, and cry to Thee: * Raise up my life from corruption, * O greatly Merciful One.", "p9 Ode 6 irmos", { sourceLabel: "Irmos", label_inline: true }),
            items: [
              hc1("As a luminary thou hast enlightened the ends of the world with the light of thy sufferings, confessing the name of Christ before the tyrants, O all-praised sufferer of the Lord (name).", "p9 Ode 6 troparion 1", { label: "plain" }),
              hc1("Thy tongue was truly like the swift quill of a scribe; expounding the meaning of spiritual law, and inscribing it on the tablets of the hearts of the faithful, O Father (name).", "p9 Ode 6 troparion 2", { label: "plain" }),
              hc1("Those who swim in the calm of thine instructions, O Godly-spoken Father, avoid the tempests of deep deception, and those returning from heresies are saved by faith in them.", "p9 Ode 6 troparion 3", { label: "plain" }),
              hc1("O pure one, preserver of virginity, the Holy Spirit overshadowed thee, and made thee, O all-blessed one, an all-immaculate and all-honored abode of the Son of the Most High.", "p9 Ode 6 Theotokion", { sourceLabel: "Theotokion", label: "theotokion", label_inline: true }),
            ],
          },
          7: {
            irmos: hc2("An Angel made the furnace bedew the holy Children. * But the command of God consumed the Chaldeans * and prevailed upon the tyrant to cry: * O God of our fathers, blessed art Thou.", "p10 Ode 7 irmos", { sourceLabel: "Irmos", label_inline: true }),
            items: [
              hc1("Thy life was made illustrious by abstinence, and thy suffering confirmed this, O divinely-wise one, for thou hast openly glorified Christ, proclaiming: “O God of our fathers, blessed art Thou.”", "p10 Ode 7 troparion 1", { label: "plain" }),
              hc1("Girding thyself with manliness and the purity of chastity, thou hast obtained by grace the radiant crown of Confession, O God-pleasing Father (name), crying: “Blessed art Thou, the God of our Fathers.”", "p10 Ode 7 troparion 2", { label: "plain" }),
              hc1("The wicked ones who refuse to adore Thine exceedingly pure icon, O Savior, have on numerous occasions deeply aggrieved Thy servant who ever crieth unto Thee: “O God of our fathers, blessed art Thou.”", "p10 Ode 7 troparion 3", { label: "plain" }),
              hc1("He who sitteth uncircumscribed in the bosom of the Begetter, having issued from thy loins, O most pure one, sitteth now bounded in the form of Adam, that He may save Adam.", "p10 Ode 7 Theotokion", { sourceLabel: "Theotokion", label: "theotokion", label_inline: true }),
            ],
          },
          8: {
            irmos: hc2("Thou didst make flame bedew the holy children, * and didst burn the sacrifice of a righteous man with water. * For Thou alone, O Christ, dost do all as Thou willest, * Thee do we supremely exalt throughout all ages.", "p10-p11 Ode 8 irmos", { sourceLabel: "Irmos", label_inline: true }),
            items: [
              hc1("Appearing as radiant as the sun, O blessed (name), thou didst illumine the ends of the earth with thine instructions, vanquishing the darkness of every perplexing sin with the light of repentance.", "p10-p11 Ode 8 troparion 1", { label: "plain" }),
              hc1("Issuing forth like a river from paradise, fed by the streams of divine knowledge, O God-pleasing (name), thou didst give nourishment to those on earth, drowning the tares of wickedness.", "p10-p11 Ode 8 troparion 2", { label: "plain" }),
              hc1("Adorned with beautiful speech, O all-blessed one, thou wast revealed as a quill, devoutly writing down for the faithful thy divine contemplations, extolling Christ throughout the ages.", "p10-p11 Ode 8 troparion 3", { label: "plain" }),
              hc1("Unto thy shelter do I flee, O all-immaculate one, the protection of my life, thou who beyond understanding hast given birth to God the Word, Whom we praise throughout the ages.", "p10-p11 Ode 8 Theotokion", { sourceLabel: "Theotokion", label: "theotokion", label_inline: true }),
            ],
          },
          9: {
            irmos: hc2("It is impossible for mankind to see God * upon Whom the orders of Angels dare not gaze; * but through thee, O all-pure one, * did the Word Incarnate become a man * and with the Heavenly Hosts * Him we magnify and thee we call blessed.", "p11 Ode 9 irmos", { sourceLabel: "Irmos", label_inline: true }),
            items: [
              hc1("Thou hast shone forth unto the Church of Christ, like light from a great sun, illumining the thoughts of the faithful; now making thine abode in the never-fading light, thou dost sing the Trisagion hymn unto the Uncreated Trinity.", "p11 Ode 9 troparion 1", { label: "plain" }),
              hc1("The earth hath been adorned with thy holy tomb and with thy sacred relics, O all-praised (name), and the souls of the righteous rejoiced when the Angels received thy spirit, O blessed one; with them remember us who hymn thee.", "p11 Ode 9 troparion 2", { label: "plain" }),
              hc1("Thou wast a Temple of the Holy Spirit, a river filled with living water, an ever-flowing stream, and wondrous Source of divine repentance, O (name), thou steadfast foundation of the Church, and standard of Orthodoxy.", "p11 Ode 9 troparion 3", { label: "plain" }),
              hc1("The heavenly rain descended into thy womb, O Virgin, drying the streams of deceit, and through thee, O full of God’s grace, making incorruption and redemption flow forth unto all mankind.", "p11 Ode 9 Theotokion", { sourceLabel: "Theotokion", label: "theotokion", label_inline: true }),
            ],
          },
        },
      }],
      sessional_ode3_rubric: hc1("The Sessional Hymn, in Tone IV:", 'p8 post-Ode-III sessional rubric'),
      sessional_ode3: hc2("Like a morning star, * the glorious Sun placed thee on the summit of His Church * enlightening the faithful with thy teachings, * O heavenly (name), * our Divinely-wise Father.", "p8 post-Ode-III Sessional", { spec_mel: "Thou hast appeared today ...", tone: 4 }),
      // UNPOINTED, like the Nun copy of this same family text.
      sessional_ode3_closer: hc1("O pure, all-immaculate one who knewest not a man, who alone hast given birth within time to the timeless Son and Word of God, with the holy and honored apostles, the martyrs, prophets and the venerable, entreat Him, that He grant us purification and great mercy.", "p8 post-Ode-III Theotokion", { sourceLabel: "Glory ..., Both now ..., Theotokion in Tone IV", tone: 4, type: "theotokion" }),
      sessional_ode3_stavrotheotokion: hc1("When Thy most pure Mother beheld Thee uplifted upon the Cross, O Word of God she exclaimed, lamenting maternally: “What is this new and strange wonder, O my Son? How is it that Thou, the Life of all, dost taste of death desiring to bring life to the dead, in that Thou art compassionate?”", "p8 post-Ode-III Stavrotheotokion", { sourceLabel: "Stavrotheotokion", type: "stavrotheotokion", label: "stavrotheotokion", label_inline: true }),
      kontakion_rubric: hc1("The Kontakion from the Typicon; but if there be none, chant the following:", 'p9 Kontakion rubric'),
      // NO Spec. Mel. on the exapostilarion — the label goes straight from
      // tone to text.
      exapostilarion_rubric: hc1("Exapostilarion in Tone III:", 'p11 exapostilarion rubric'),
      exapostilarion: hc2("Well tried in asceticism, and finishing thy divine course in suffering, * thou hast ascended into heaven and standest before Christ, * O venerable Father (name), * fervently entreat Him on behalf of us who hymn thee.", "p11 Exapostilarion", { tone: 3, repeat: 2 }),
      exapostilarion_closer: hc2("O most pure one, having given birth to Christ the ineffable Joy, * make partakers of the heavenly joy * all those who honor thee * and who offer unto thee their heartfelt thanksgiving. * Forget not thy servants, O Mary blessed of God.", "p11 Exapostilarion Theotokion", { sourceLabel: "Glory ..., Both now ..., Theotokion, in Tone III", tone: 3, type: "theotokion" }),
      praises_rubric: hc1("On the Praises, these Stichera, in Tone IV:", 'p11 Praises rubric'),
      // Praises 1 and 2 are the SAME HYMNS Hieromartyr prints as its praises
      // 1 and 2, in a different rendering (“The grace of the Holy Spirit hath
      // brightly shone” / “Spiritual grace shining forth”) — the translation-
      // pair pattern extends to whole stichera sets (register: variant).
      praises: [
        hc2("The grace of the Holy Spirit, * hath brightly shone upon thee, * O Father (name), illumining thee * and shortening the dark night of the passions, * causing the light of dispassion to dawn upon thee; * Now dwelling immersed in that purest of Light, * forget not, O voice of God, * those who in faith ** hymn thy sacred memory.", "p11 Praises 1", { spec_mel: "Thou hast given a sign ...", label: "plain", tone: 4, repeat: 2 }),
        hc2("Forsaking earthly things, * thou didst acquire the heavenly grace desired by thee, * O venerable (name), * and choosing a life of suffering, * O God-pleasing one, * thou didst, like the bodiless ones, * thirst for the streams of eternal beatitude, * wherefore drying up the murky spring of the passions by thy tears ** thou hast nourished the senses of thy soul.", "p11 Praises 2", { spec_mel: "Thou hast given a sign ...", label: "plain" }),
        hc2("Having worthily obtained * the grace of healing from God, * thou hast vanquished the seducing spirits * who sought to ensnare thee, * thereby avoiding the corruption of spiritual afflictions, * O holy (name), * having reposed, thou dost now pour forth streams of grace, * with which we are watered, ** ever hymning thy memory.", "p12 Praises 3", { spec_mel: "Thou hast given a sign ...", label: "plain" }),
      ],
      praises_glory: hc2("O venerable Father! * Giving neither sleep to thine eyes, * nor slumber to thine eyelids * till both thy soul and body were free from passion, * and an abode for the Holy Spirit had been prepared within thyself, * thou didst receive Christ, * Who together with the Father and the Holy Spirit, made their dwelling within thee; * O Father (name), * great preacher and favorite of the Consubstantial Trinity, ** entreat Him on behalf of our souls.", "p12 Praises Glory", { sourceLabel: "Glory ..., in Tone V", tone: 5, label: "glory" }),
      praises_closer: hc2("We bless thee, O Virgin Theotokos, * and we, the faithful, glorify thee as is meet, * thou unassailable city, * impregnable rampart, ** and steadfast intercession and refuge of our souls.", "p12 Praises Both now", { sourceLabel: "Both now ..., Theotokion in Tone V", tone: 5, type: "theotokion", label: ["both_now", "theotokion"] }),
      // UNPOINTED stavrotheotokion — and “Thou diest” surfaces in yet another
      // hymn of the lament family.
      praises_stavrotheotokion: hc1("Of old, the Virgin Mother, the all-blessed Maiden, beholding the Lamb, her Son, lifted up upon the Cross, cried out, weeping: “Woe is me, O my Son! How is it that Thou diest Who art in essence God immortal?”", "p12 Stavrotheotokion", { sourceLabel: "Stavrotheotokion", type: "stavrotheotokion", label: "stavrotheotokion", label_inline: true }),
      great_doxology_rubric: hc1("The great Doxology: If a small Doxology is read, and a Doxasticon is appointed, the following is chanted after the Aposticha:", 'p12 great Doxology rubric'),
      // The reprint SPELLS OUT what the aposticha site called “the same tone
      // and melody” — Tone VIII, “O most glorious wonder”.
      doxology_glory: hc2("We, the multitude of monks, * honor thee as our instructor, O Father (name), * for we have learned from the path trodden by thee * to conduct ourselves virtuously. * Blessed art thou for having labored for Christ * and subduing the enemy, * O friend of Angels, * and companion of the righteous and holy, ** with them entreat the Lord that our souls may be saved.", "p12 Doxology Glory", { sourceLabel: "Glory ..., in Tone VIII", tone: 8, spec_mel: "O most glorious wonder ...", label: "glory" }),
      doxology_closer_rubric: hc1("Both now ..., Theotokion or Stavrotheotokion:", 'p12 Doxology closer rubric'),
      troparion_rubric: hc1("After Our Father ..., the Troparion, in Tone VIII:", 'p12 after Our Father rubric'),
      // THE p12 VARIANT SITE — “God-inspired instrucTION of Hierarchs” and
      // “that our souls MAY BE saved” against the canonical p4/p5 copy:
      // stored locally per the R-1 refusal (register: variant).
      troparion_after_our_father: hc2("Teacher of Orthodoxy, instructor of piety and chastity, * luminary of the Church, God-inspired instruction of Hierarchs, * O most wise (name), thou hast illumined all by thy teaching; ** entreat Christ God that our souls may be saved.", "p12 after Our Father Troparion", { sourceLabel: "After Our Father ..., the Troparion, in Tone VIII", tone: 8 }),
      closer: { absent: true, reason: "not_printed_in_source", basis: "close_reading", note: "Slot printed as “Glory ..., Both now ..., Theotokion or Stavrotheotokion:” with no text (§5.8)." },
      closing_rubric: hc1("The Dismissal:", 'p12 Dismissal'),
    },
    ...
    liturgy: {
      order: ['beatitudes_rubric', 'beatitudes', 'propers_rubric', 'troparion',
              'kontakion', 'prokeimenon', 'prokeimenon_verse', 'epistle',
              'alleluia', 'alleluia_verse', 'gospel', 'communion_verse'],
      beatitudes_rubric: hc1("Typika and Beatitudes.", 'p13 Typika and Beatitudes'),
      // THE BEATITUDES DRAW FROM ODES I AND VI — every prior file draws from
      // III and VI. Beatitude 1 brings its own (Twice), as in Heiromartyrs.
      beatitudes: [
        hc1("With all his thoughts our Holy Father (name) loved Thee, O Jesus, and with all his heart was ready to suffer for Thee, enduring sorrows, affliction and suffering, thereby attaining to everlasting grace.", "p13 Beatitude 1", { label: "plain", repeat: 2 }),
        hc1("With the drops of thy sacred blood thou hast assuaged the bitter seas of unbelief; and as Christ’s sacred river, thou dost ever give proper refreshment to the Church.", "p13 Beatitude 2", { label: "plain" }),
        hc1("Thou, O glorious (name), bringing unto God the ascetic feats accomplished by thee on earth, wast deemed worthy to receive a crown in the heavenly Kingdom and to inherit tranquil everlasting life.", "p13 Beatitude 3", { label: "plain" }),
        hc1("As a luminary thou hast enlightened the ends of the world with the light of thy sufferings, confessing the name of Christ before the tyrants, O all-praised sufferer of the Lord (name).", "p13 Beatitude 4", { label: "plain" }),
        hc1("Thy tongue was truly like the swift quill of a scribe; expounding the meaning of spiritual law, and inscribing it on the tablets of the hearts of the faithful, O Father (name).", "p13 Beatitude 5", { label: "plain" }),
        hc1("Those who swim in the calm of thine instructions, O Godly-spoken Father, avoid the tempests of deep deception, and those returning from heresies are saved by faith in them.", "p13 Beatitude 6", { label: "plain" }),
        hc1("O pure one, preserver of virginity, the Holy Spirit overshadowed thee, and made thee, O all-blessed one, an all-immaculate and all-honored abode of the Son of the Most High.", "p13 Beatitude 7", { sourceLabel: "Theotokion", label: "theotokion", label_inline: true }),
      ],
      propers_rubric: hc1("The Troparion and Kontakion from the Typicon; but if there be none, chant the following:", 'p13 Liturgy propers rubric'),
      // THE p13 VARIANT SITE — same words as the canonical copy but the
      // final clause pointed with a SINGLE asterisk (“teaching; * entreat”)
      // where p4/p5/p12 point “**”: stored locally per the R-1 refusal.
      troparion: hc2("Teacher of Orthodoxy, instructor of piety and chastity, * luminary of the Church, God-inspired instructor of Hierarchs, * O most wise (name), thou hast illumined all by thy teaching; * entreat Christ God that our souls be saved.", "p13 Liturgy Troparion", { sourceLabel: "Troparion of the holy confessor, in Tone VIII", tone: 8 }),
      // “The Prokeimenon, in Tone VIII” — with the article, alone in the
      // corpus so far.
      prokeimenon: hc2("The saints shall boast in glory * and they shall rejoice upon their beds.", "p13 Liturgy Prokeimenon", { sourceLabel: "The Prokeimenon, in Tone VIII", tone: 8, label_inline: true }),
      // “His saints? .” — the MonasticMartyrs “saints?.” defect at a second
      // file, now with the stop STRANDED after a space (sic register +
      // register variant).
      prokeimenon_verse: hc1("Sing unto the Lord a new song, His praise is in the Church of His saints? .", "p14 Liturgy Prokeimenon verse", { sourceLabel: "Verse", label: "refrain" }),
      epistle: { heading: 'THE EPISTLE OF ST. PAUL TO THE EPHESIANS',
        src: { file: HC, locus: 'p14 Epistle' },
        citation_verbatim: '(6:10-17)',
        citation: { book: 'Ephesians', chapter: 6, verses: '10-17' },
        citation_basis: 'printed',
        provenance_note: 'The body prints "his might Put on" — a missing stop after "might" — unstored per R-4, recorded here.' },
      // The monastic-class Alleluia — FOURTH file (Monastic, Monastics,
      // MonasticMartyrs) — reprinting this file's own aposticha verse 2
      // unpointed: the pointed/unpointed cross-slot pattern.
      alleluia: hc1("Blessed is the man that feareth the Lord, in His commandments shall he greatly delight.", "p14 Alleluia", { sourceLabel: "Alleluia, in Tone VI", tone: 6, label_inline: true }),
      alleluia_verse: hc1("His seed shall be mighty upon the earth; the generation of the upright shall be blessed.", "p14 Alleluia verse", { sourceLabel: "Verse", label: "refrain" }),
      gospel: { heading: 'THE GOSPEL ACCORDING TO ST. LUKE',
        src: { file: HC, locus: 'p14 Liturgy Gospel' },
        citation_verbatim: '(12, 8-12)',
        citation: { book: 'Luke', chapter: 12, verses: '8-12' },
        citation_basis: 'printed' },
      // The semicolon form — fourth file.
      communion_verse: hc1("Rejoice in the Lord, O ye righteous; praise is meet for the upright.", "p14 Communion verse", { sourceLabel: "Communion Verse", label_inline: true }),
    },
  },
  MonasticMartyr: {
    // A GENERAL SERVICE (not a Vigil) — yet it prints a megalynarion and
    // Polyeleos block regardless.
    title: mmy1("THE GENERAL SERVICE TO A MONK-MARTYR.", 'p1 title'),

    // The monastic troparion — Nun's "In thee, O mother" regendered; four
    // sites byte-identical (generator-verified). R-1 holds again after two
    // refusals.
    troparion: mmy2("In thee, O father, the image of God was preserved, * for taking up thy cross, thou didst follow after Christ; * by activity thou didst learn to disdain the flesh, as something transient, * but to care for thy soul as something immortal. ** Wherefore, with the angels thy spirit doth rejoice, O venerable (name).", "p4 Troparion", { sourceLabel: "Troparion, in Tone VIII", verified_sites: [{"locus": "p4 Vespers dismissal", "tone": 8}, {"locus": "p5 God is the Lord", "tone": 8, "repeat": 2}, {"locus": "p13 after Our Father", "tone": 8}, {"locus": "p14 AT LITURGY", "tone": 8}] }),
    kontakion: mmy2("As a pious and capable faster, * as an all-honored and willing martyr, * and as one who led an eremitic life in the desert, * let us worthily extol in hymns the ever-lauded (name), ** for he hath trampled the serpent underfoot.", "p10 Kontakion after Ode VI", { sourceLabel: "Kontakion of the venerable martyr, in Tone II", tone: 2, verified_sites: [{"locus": "p10 after Ode VI", "tone": 2}, {"locus": "p14 AT LITURGY", "tone": 2}] }),
    // Bare “Ikos:” label — every sibling prints “The Ikos”. Body keeps the
    // British “honour” and a semicolon where a colon belongs (“cry aloud to
    // thee; From enemies”).
    ikos: mmy1("Emulating the Lord’s passion O most blessed one, thou didst harbor the desire to sacrifice thyself for Him, and having manfully struggled against the adversaries, thou didst destroy the delusion of idolatry, bringing to naught the cunning machinations and wiles of the enemy, and hast thereby obtained a crown of honour, O (name), most venerable father; wherefore we in faith have recourse to thy protection and cry aloud to thee; From enemies visible and invisible do thou deliver us, for thou hast trampled the serpent underfoot.", "p10 Ikos", { sourceLabel: "Ikos", label_inline: true }),

    vespers: {
      order: ['lic_rubric', 'lic', 'lic_closer', 'lic_stavrotheotokion',
              'idiomelon_rubric', 'lic_glory', 'lic_glory_closer_label',
              'lic_glory_closer', 'lic_glory_stavrotheotokion',
              'dogmatikon_rubric', 'dogmatikon',
              'entrance_rubric', 'readings', 'aposticha_rubric', 'aposticha',
              'aposticha_glory', 'aposticha_closer_label', 'aposticha_closer_rubric',
              'aposticha_closer', 'aposticha_alternate', 'aposticha_stavrotheotokion',
              'troparion_rubric', 'troparion', 'closer', 'closing_rubric'],
      lic_rubric: mmy1("On “Lord, I have cried ...,” the Stichera, in Tone VI:", 'p1 LIC rubric'),
      // “On the third day” — a Spec. Mel. new to the corpus.
      lic: [
        mmy2("Let us, O faithful, as is meet, * praise the ascetic feats, and pangs, * of the wise faster and warrior of Christ, * and cry out unto the Lord: * By his prayers, O Christ God, ** deliver us from every evil circumstance.", "p1 LIC 1", { spec_mel: "On the third day ...", label: "plain", tone: 6 }),
        mmy2("An abundance of most gracious peace * hath been granted thee from God, * O venerable father (name), * for thou didst endure * the turbulent storm of torments, * O invincible warrior, ** ever intercede for those who praise thee.", "p1 LIC 2", { spec_mel: "On the third day ...", label: "plain" }),
        mmy2("Thou, O wise one, having suffered lawfully, * and been most wisely disposed to God, * became another temple of the Fashioner of all that is, * and revealed to be a god-bearing martyr, * thou light of the church, ** and adornment of the venerable.", "p1 LIC 3", { spec_mel: "On the third day ...", label: "plain" }),
      ],
      lic_closer: mmy2("O pure Virgin Theotokos, * entreat the Lord that by thine intercessions, * He grant our souls remission of sins, ** peace and great mercy.", "p1 LIC closer", { sourceLabel: "Glory ..., Both now ..., Theotokion, in Tone VI", tone: 6, type: "theotokion", label: ["glory", "both_now", "theotokion"] }),
      lic_stavrotheotokion: mmy2("Upon beholding our Life suspended upon the Tree, * the all-immaculate Theotokos cried aloud, * maternally lamenting: ** O my Son and my God, save those who with love hymn Thee!", "p1 Stavrotheotokion", { sourceLabel: "Stavrotheotokion", type: "stavrotheotokion", label: "stavrotheotokion", label_inline: true }),
      idiomelon_rubric: mmy1("If an Idiomelon be appointed, Glory ..., in Tone V:", 'p1 idiomelon rubric'),
      // The same hymn HieroConfessor prints POINTED DIFFERENTLY as its
      // Praises Glory (“Giving neither sleep to thine eyes”) — the
      // translation-pair pattern (register: variant).
      lic_glory: mmy2("O venerable father, * thou didst not give sleep to thine eyes, * nor slumber to thine eyelids, * until thou didst free thy mind and body from the passions, * and prepare thyself to be a habitation of the Spirit; * Wherefore Christ having come unto thee with His Father * made His abode within thee. * O great preacher and venerable one, * having received the grace of the Consubstantial Trinity, ** pray thou for our souls.", "p1 Glory idiomelon", { sourceLabel: "Glory ..., in Tone V", tone: 5, label: "glory" }),
      // THE IDIOMELON BLOCK GROWS A BOTH-NOW AND A STAVROTHEOTOKION — first
      // file to print them here.
      lic_glory_closer_label: mmy1("Both now ..., Theotokion in Tone V:", 'p1 idiomelon Both now label'),
      lic_glory_closer: mmy2("We bless thee, O Virgin Theotokos, * and we, the faithful, glorify thee as is meet, * thou unassailable city, * impregnable rampart, ** and steadfast intercession and refuge of our souls.", "p1 idiomelon Both now Theotokion", { tone: 5, type: "theotokion", label: "both_now" }),
      // The page then prints “Spec. Mel.: “We bless thee ...”:” — naming the
      // theotokion JUST SUNG as the melody for this stavrotheotokion.
      lic_glory_stavrotheotokion: mmy1("Of old, the Virgin Mother, the all-blessed Maiden, beholding the Lamb, her Son, lifted up upon the Cross, cried out, weeping: “Woe is me, O my Son! How is it that Thou diest Who art in essence God immortal?”", "p1 idiomelon Stavrotheotokion", { sourceLabel: "Stavrotheotokion", spec_mel: "We bless thee ...", type: "stavrotheotokion", label: "stavrotheotokion", label_inline: true }),
      // “chant the following Dogmatic OF Tone V” — chant for sing, of for in;
      // and the travelling “service ):” space returns (sixth file).
      dogmatikon_rubric: mmy1("If the Celebration be with a Polyeleos, and not a Resurrection Service, chant the following Dogmatic of Tone V (If the service is a Resurrection service chant the Dogmatic of the Tone for that service ):", 'p1 dogmatikon rubric'),
      // THE TONE V DOGMATIC — “In the Red Sea of old” — first Tone V dogmatic
      // in the General Menaion: a THIRD cross-book row candidate against the
      // Octoechos tone-5 copy (ledger E-1). NO Both-now label, no alternate,
      // no stavrotheotokion follow it — the dogmatic stands alone here.
      dogmatikon: mmy2("In the Red Sea of old * an image of the Bride who knew not wedlock was depicted. * There Moses was the one who parted the sea, * here Gabriel is the minister of the miracle. * At that time Israel marched dry-shod through the deep, * now the Virgin doth seedlessly give birth to Christ. * The sea after Israel’s passage remained impassable; * the Immaculate one after bearing Emmanuel remained incorrupt. * O God, who doth exist and is pre-eternal, * and hath appeared as man, ** have mercy upon us.", "p2 Dogmatic", { tone: 5, type: "dogmatic_theotokion" }),
      entrance_rubric: mmy1("The Entrance. The Prokeimenon of the day. The Three Lessons, if appointed.", 'p2 Entrance rubric'),
      // The monastic Wisdom-×3 set in the CORRECT rendering — clean "stone
      // bow", "right-aiming", "aye kings" — byte-matching HieroConfessor's
      // copies down to the defects, plus one of its own: "wisdom is the gray
      // hair un to men" ("un to" split). Bodies unstored per R-4.
      readings: [
        { heading: 'THE READING FROM THE WISDOM OF SOLOMON',
          src: { file: MY, locus: 'p2 Lesson 1' },
          citation: { book: 'Wisdom of Solomon', chapter: 3, verses: '3:1-3:9' },
          citation_basis: 'identified',
          provenance_note: 'The "souls of the righteous" lesson. Identified; confirm against the page.' },
        { heading: 'A READING FROM THE WISDOM OF SOLOMON',
          src: { file: MY, locus: 'p2 Lesson 2' },
          citation: { book: 'Wisdom of Solomon', chapter: 5, verses: '5:15-6:3' },
          citation_basis: 'identified',
          provenance_note: 'The CORRECT "live for evermore" rendering, as in HieroConfessor — free of the sIn-Tone corruption. Identified; confirm against the page.' },
        { heading: 'A READING FROM THE WISDOM OF SOLOMON',
          src: { file: MY, locus: 'p2-p3 Lesson 3' },
          citation: { book: 'Wisdom of Solomon', chapter: 4, verses: '4:7-15' },
          citation_basis: 'identified',
          provenance_note: 'The monastic third lesson, with "un to men" split on the page. Identified; confirm against the page.' },
      ],
      aposticha_rubric: mmy1("On the Aposticha, these Stichera, in Tone I:", 'p3 Aposticha rubric'),
      // Sticheron 3: “in the vanquishing the passions” — a doubled article
      // (sic register).
      aposticha: [
        mmy2("O all-famed (name), * thou didst dedicate thy life * to the cultivation of the virtues; * wherefore the faithful who with faith praise Christ, * were humbled by thy doctrines, * and having confirmed them while in the world, * and standing now before the Divine Spirit, ** ever beseech Him for us.", "p3 Aposticha 1", { spec_mel: "O all-praised Martyrs ...", label: "plain", tone: 1 }),
        mmy2("Precious in the sight of the Lord * is the death of His saints.", "p3 Aposticha verse 1", { sourceLabel: "Verse", label: "refrain" }),
        mmy2("Thy life, O divinely inspired martyr (name), * was revealed to be * equal to that of the angels, * and like a sacrifice * of fragrant and precious incense, * thy confession was brought unto those on high. * Do thou now pray ** that our souls be granted peace and great mercy.", "p3 Aposticha 2", { spec_mel: "O all-praised Martyrs ...", label: "plain" }),
        mmy2("Blessed is the man that feareth the Lord, * in His commandments shall he greatly delight.", "p3 Aposticha verse 2", { sourceLabel: "Verse", label: "refrain" }),
        mmy2("Having been abundantly rich * in the vanquishing the passions, * thou, O (name), didst triumph over the tyrant; * and exulting now together with the crown-bearers, * remember, O blessed one, * all those who celebrate thy memory, * and entreat Christ ** to grant our souls peace and great mercy.", "p3 Aposticha 3", { spec_mel: "O all-praised Martyrs ...", label: "plain" }),
      ],
      aposticha_glory: mmy2("O venerable martyr (name), with the help of the Spirit * thou didst vanquish the embittered enemy, * and as an invincible warrior, * thou didst slay the noetic Ethiopians * with the weapon of the faith, * and having lawfully completed thine ascetic endeavors, * thou hast been crowned together with all the choirs of the martyrs, ** O most noetically rich and venerable martyr.", "p3 Aposticha Glory", { sourceLabel: "Glory ..., in Tone IV", tone: 4, label: "glory" }),
      aposticha_closer_label: mmy1("Both now ..., in Tone IV:", 'p3 Both now label'),
      aposticha_closer_rubric: mmy1("If the Celebration be with a Polyeleos, chant the Resurrection Theotokion:", 'p3 aposticha closer rubric'),
      aposticha_closer: mmy2("Mercifully regard the supplications of thy servants, * O all-immaculate one, * quelling the cruel uprisings of the demons against us, * delivering us from every sorrow; * for thee alone do we have as a steadfast and sure confirmation, * and having acquired thine intercession; * let not us who call upon thee be put to shame, * O Sovereign Lady. * Hasten thou to answer the entreaties of those who cry out to thee with faith: * Rejoice, thou help, joy and protection of all, ** and the salvation of our souls!", "p3-p4 Resurrection Theotokion", { tone: 4, type: "theotokion", label: "theotokion" }),
      aposticha_alternate: mmy2("Deliver us from our needs, * O Mother of Christ God, * thou who hast given birth to the Creator of all, * that we all may cry out to thee: ** Rejoice, O thou who alone art the intercessor for our souls!", "p4 Otherwise Theotokion", { sourceLabel: "Otherwise, Theotokion", type: "theotokion", label: "theotokion", label_inline: true }),
      // SEVENTH site of the spaced-question-marks copy.
      aposticha_stavrotheotokion: mmy2("Seeing Christ, the Lover of mankind, * crucified and with His side pierced with a lance, * the most pure one lamented, crying aloud: * “What is this, O my Son ? * What have the ungrateful people rendered unto Thee * in return for all the good things Thou hast rendered unto them ?” * And yet thou dost show thy tender compassion for me, * that I may endure my childlessness. ** I stand in awe, O Compassionate One, at Thy voluntary crucifixion.", "p4 Stavrotheotokion", { sourceLabel: "Stavrotheotokion", type: "stavrotheotokion", label: "stavrotheotokion", label_inline: true }),
      // A COMMA after “Typicon” where every sibling prints a semicolon.
      troparion_rubric: mmy1("The Troparion from the Typicon, but if there be none, chant the following:", 'p4 troparion rubric'),
      closer: { absent: true, reason: "not_printed_in_source", basis: "close_reading", note: "Slot printed as “Glory ..., Both now ..., Theotokion or Stavrotheotokion:” with no text — the conditional closer (§5.8, CLOSER_TYPES)." },
      closing_rubric: mmy1("The Dismissal:", 'p4 Dismissal'),
    },
    ...
    matins: {
      order: ['god_is_lord_rubric', 'troparion', 'troparion_closer',
              ...
              'praises_rubric', 'praises', 'praises_glory', 'praises_closer',
              'praises_stavrotheotokion', 'great_doxology_rubric',
              'doxology_glory', 'doxology_closer_label', 'doxology_closer',
              'troparion_rubric', 'troparion', 'closer', 'closing_rubric'],
      god_is_lord_rubric: mmy1("On “God is the Lord ...,” the Troparion, in Tone VIII:", 'p5 God is the Lord rubric'),
      troparion_closer: { absent: true, reason: "not_printed_in_source", basis: "close_reading", note: "Slot printed as “Glory ..., Both now ..., Theotokion or Stavrotheotokion:” and no text (§5.8)." },
      sessional_1_rubric: mmy1("After the 1st chanting of the Psalter, the Sessional Hymn, in Tone IV:", 'p5 sessional 1 rubric'),
      // HieroConfessor's sessional 1 re-rendered (“Having despised the
      // pleasures” / “Forsaking the enjoyment”), same melody — register:
      // variant. And this file writes its repeat marker “(Twice).” WITH a
      // full stop, at four sites.
      sessional_1: mmy2("Having despised the pleasures of earthly and corruptible things, * and loved the eremitic life, * thou didst reject temporal food and all the beauty of the world, * and wast thereby deemed worthy * to be a participant in the choir of martyrs and fasters. ** Do thou pray together with them that thy faithful servants be saved.", "p5 Sessional 1", { spec_mel: "Having been lifted up ...", tone: 4, repeat: 2 }),
      sessional_1_closer: mmy2("He that sitteth upon the throne of the cherubim * and abideth in the bosom of the Father * doth sit in thy womb as upon a throne, O Lady; * for, being truly God incarnate, * He reigneth over all nations, * and with understanding we now chant to Him. * Him do thou also entreat, ** that thy servants be saved.", "p5 Sessional 1 Theotokion", { sourceLabel: "Glory ..., Both now ..., Theotokion, in Tone IV", tone: 4, type: "theotokion" }),
      sessional_2_rubric: mmy1("After the 2nd chanting of the Psalter, the Sessional Hymn, in Tone VIII:", 'p5 sessional 2 rubric'),
      // “Of the Wisdom” — capital W on the melody, alone in the corpus.
      sessional_2: mmy2("Imitating the fasting of John the Baptist, * and the virtues of Elijah the Tishbite, * thou didst live a life likened to the immaterial angels, * and together with them thou dost glorify the Holy and Divine Trinity, * having valiantly defeated the assaults of demons; * wherefore O blessed (name), * having suffered, and manfully executed thy noetic warfare, * and confessed Christ’s divine incarnation and Godhead; * Do thou ever beseech Him to grant remission of sins ** unto those who lovingly celebrate thy sacred memory.", "p5 Sessional 2", { spec_mel: "Of the Wisdom ...", tone: 8, repeat: 2 }),
      // “Glory..., Both now ...” — the Glory printed WITHOUT its space before
      // the ellipsis, only here.
      sessional_2_closer: mmy2("All we, the generations of mankind, * call thee blessed, * in that thou art the Virgin who alone among women * hast given birth without seed unto God in the flesh; * for the fire of the Godhead made its abode within thee, * and thou didst feed the Creator and Lord * with milk as an infant. * Wherefore, we, the race of mankind and of angels, * worthily glorify thine all-holy birthgiving, * and together we cry out to thee: * Entreat Christ God to grant forgiveness of sins ** unto those who with faith worship thine all-holy Offspring.", "p5 Sessional 2 Theotokion", { sourceLabel: "Glory..., Both now ..., Theotokion, in Tone VIII", tone: 8, type: "theotokion" }),
      megalynarion_rubric: mmy1("After the Polyeleos, the Megalynarion:", 'p6 megalynarion rubric'),
      // A MEGALYNARION IN A GENERAL (non-Vigil) SERVICE — and the Monastic
      // family text mutates again: “Father-Martyr”, capital-A “Angels”, and
      // the comma after “monks” dropped (register: variant vs Monastic and
      // HieroConfessor copies).
      megalynarion: mmy1("We bless thee, O Venerable Father-Martyr, and we honor thy holy memory, Instructor of monks and converser with the Angels.", 'p6 Megalynarion'),
      megalynarion_verse: mmy1("With patience I waited patiently for the Lord, and He was attentive unto me, and He hearkened unto my supplication.", "p6 Megalynarion verse", { sourceLabel: "Verse", label: "refrain" }),
      sessional_polyeleos_rubric: mmy1("After the Polyeleos, the Sessional Hymn, in Tone IV:", 'p6 Polyeleos sessional rubric'),
      // “Thou hast appeared ...” — the melody label SHORTENED (siblings print
      // “Thou hast appeared today ...”).
      sessional_polyeleos: mmy2("As one proficient in abstinence, * thou didst shine forth in martyrdom * enlightening the faithful with thine ascetic endeavors, * O blessed (name); ** wherefore we all with one voice magnify thee.", "p6 Polyeleos sessional", { spec_mel: "Thou hast appeared ...", tone: 4, repeat: 2 }),
      sessional_polyeleos_closer: mmy2("O all-pure one, * who hath contained the infinite Godhead in thy womb * Who, in His love for mankind, hath become a man, * and hath received our substance from thee, * deifying it: * disdain me not who am now sorrowing, * but quickly take pity * and free me from divers enemies ** and the malice of the evil one.", "p6 Polyeleos sessional Theotokion", { sourceLabel: "Glory ..., Both now ..., Theotokion, in Tone IV", tone: 4, type: "theotokion" }),
      anabathmoi_rubric: mmy1("If of Polyeleos rank, and not a Resurrection Service, chant the following:", 'p6 anabathmoi rubric'),
      anabathmoi_intro: mmy1("The Song of Ascents: The first antiphon, in Tone IV:", 'p6 anabathmoi heading'),
      anabathmoi: [
        mmy2("From my youth * do many passions war against me; * but do Thou Thyself defend ** and save me, O my Savior.", "p6 anabathmoi 1", { label: "plain" }),
        mmy2("Ye haters of Zion * shall be shamed by the Lord; * for like grass, by the fire ** shall ye be withered.", "p6 anabathmoi 2", { label: "plain" }),
      ],
      anabathmoi_closer: mmy2("In the Holy Spirit, * every soul is quickened, * and, through cleansing, is exalted ** and made radiant by the Triple Unity in a hidden sacred manner.", "p6 anabathmoi Glory Both now", { sourceLabel: "Glory ..., Both now ...,", label: ["glory", "both_now"] }),
      // The HieroConfessor double label again — second file.
      prokeimenon_rubric: mmy1("Prokeimenon, in Tone IV:", 'p6 prokeimenon rubric'),
      prokeimenon: mmy2("Precious in the sight of the Lord * is the death of His saints.", "p6 Prokeimenon", { sourceLabel: "The Prokeimenon", tone: 4, label_inline: true }),
      // The MATINS-family lowercase-“he” form — sixth file.
      prokeimenon_verse: mmy1("What shall I render unto the Lord for all that he hath rendered unto me?", "p6 Prokeimenon verse", { sourceLabel: "Verse", label: "refrain" }),
      gospel_rubric: mmy1("Let every breath ...,", 'p6 Let every breath'),
      gospel: { heading: 'THE GOSPEL ACCORDING TO ST. MARK',
        src: { file: MY, locus: 'p6-p7 Matins Gospel' },
        citation_verbatim: '(8:34 - 9:1)',
        citation: { book: 'Mark', chapter: 8, verses: '8:34-9:1' },
        citation_basis: 'printed' },
      psalm50_rubric: mmy1("After the 50th Psalm:", 'p7 After the 50th Psalm'),
      psalm50_sticheron: mmy2("Through the prayers of the venerable (name), * O Merciful One, ** blot out the multitude of our transgressions.", "p7 Psalm 50 Glory", { sourceLabel: "Glory ..., in Tone VI", tone: 6, label: "glory" }),
      psalm50_closer: mmy2("Through the prayers of the Theotokos, * O Merciful One, ** blot out the multitude of our transgressions.", "p7 Psalm 50 Both now", { sourceLabel: "Both now ...,", type: "theotokion", label: "both_now" }),
      psalm50_verse: mmy2("Have mercy on me, O God, * according to Thy great mercy; * and according to the multitude of Thy compassions, ** blot out my transgressions.", "p7 Psalm 50 verse", { label: "refrain" }),
      sessional_post50_rubric: mmy1("Then the Sessional Hymn, in Tone IV:", 'p7 post-Psalm-50 sessional rubric'),
      // The aposticha Glory REPRINTED as the post-50 sessional — but with the
      // final “and” DROPPED (“rich venerable martyr” for “rich and venerable
      // martyr”): a Martyresses-style in-file variant reprint (register).
      sessional_post50: mmy2("O venerable martyr (name), with the help of the Spirit * thou didst vanquish the embittered enemy, * and as an invincible warrior, * thou didst slay the noetic Ethiopians * with the weapon of the faith, * and having lawfully completed thine ascetic endeavors, * thou hast been crowned together with all the choirs of the martyrs, ** O most noetically rich venerable martyr.", "p7 post-Psalm-50 Sessional", { tone: 4 }),
      // “The Canon, in Tone VI” — NO closing colon, alone in the corpus.
      canon_rubric: mmy1("The Canon, in Tone VI", 'p7 Canon rubric'),
      canons: [{
        title: "The Canon, in Tone VI", tone: 6,
        odes: {
          1: {
            irmos: mmy2("When Israel walked on foot in the sea as on dry land, * on seeing their pursuer Pharaoh drowned, * they cried: * Let us sing to God * a song of victory.", "p7 Ode 1 irmos", { sourceLabel: "Irmos", label_inline: true }),
            // No refrain printed — second refrain-less canon (after
            // HieroConfessor).
            refrain: { absent: true, reason: "not_printed_in_source", basis: "close_reading", note: "No Refrain line after the Ode I irmos." },
            items: [
              mmy1("From the seductions of life and from the passions that torment me, do thou set my mind at rest, O venerable spiritual athlete, that I may be found worthy to praise thy memory in peace.", "p7 Ode 1 troparion 1", { label: "plain" }),
              mmy1("As a martyr, thou wast crowned with a diadem of suffering, O venerable (name), and thereby translated from the earth into the world free from struggles, unto the true Light and Life, O most blessed one.", "p7 Ode 1 troparion 2", { label: "plain" }),
              mmy1("With the streams of thy blood thou didst extinguish the flames of the tyrants, and, O venerable martyr, thereby water the souls of the faithful, arousing within them the desire for eternal life, O venerable one.", "p7 Ode 1 troparion 3", { label: "plain" }),
              mmy1("Since thou hast given birth unto the uncircumscribable Word, Who made His abode within thy womb, O divine tabernacle, do thou deliver me, O pure one, from the tempests of the evil one, which ever oppress me.", "p7 Ode 1 Theotokion", { sourceLabel: "Theotokion", label: "theotokion", label_inline: true }),
            ],
          },
          3: {
            irmos: mmy2("There is none as holy as Thou, * O Lord my God, * who hast exalted the horn of Thy faithful O good One, * and strengthened us upon the rock * of Thy confession.", "p8 Ode 3 irmos", { sourceLabel: "Irmos", label_inline: true }),
            items: [
              mmy1("O venerable father, fortified by God’s strength, thou, O most blessed spiritual athlete, didst undertake the endurance of afflictions and torments from the tyrants.", "p8 Ode 3 troparion 1", { label: "plain" }),
              mmy1("The greatest of strugglers, even Christ, endowed thee with strength to destroy deception, and to put to shame the enemy, who impudently boasted, everywhere raging in vain.", "p8 Ode 3 troparion 2", { label: "plain" }),
              mmy1("Beautiful appear thy feet, O venerable one, traversing joyfully the path of martyrdom, covering the heads of the wicked with shame, O great sufferer (name).", "p8 Ode 3 troparion 3", { label: "plain" }),
              // “pure Mary - the palace of the Master -” — spaced hyphens
              // as dashes, first such punctuation in the corpus.
              mmy1("Let us hymn pure Mary - the palace of the Master - whom Jacob of old clearly foresaw as a divine ladder stretching from the earth to heaven.", "p8 Ode 3 Theotokion", { sourceLabel: "Theotokion", label: "theotokion", label_inline: true }),
            ],
          },
          4: {
            irmos: mmy2("Christ is my power, * my God and my Lord, * the holy Church divinely singeth, * crying with a pure mind, * keeping festival in the Lord.", "p8-p9 Ode 4 irmos", { sourceLabel: "Irmos", label_inline: true }),
            items: [
              mmy1("In accordance with the law thou didst observe the fasts, suffering legitimately, and wast therefore crowned, being fortified by God’s word and preserving thyself unharmed, O most blessed one.", "p8-p9 Ode 4 troparion 1", { label: "plain" }),
              mmy1("Suffering not to follow the path of falsehood, in thy wisdom O venerable one, thou didst traverse joyfully the path of the knowledge of God, and imbued with noetic light, thou hast been revealed to be a beacon of light.", "p8-p9 Ode 4 troparion 2", { label: "plain" }),
              mmy1("In a sacred manner, thou didst offer thyself as voluntary and holy sacrifice, O (name), unto Him, Who was slain for thee, wherefore thou hast now found rest rejoicing in the temple of the first-born.", "p8-p9 Ode 4 troparion 3", { label: "plain" }),
              mmy1("Thou didst remain a Virgin after giving birth, just as thou wast a Virgin before thy birthgiving, for thou hast given birth unto God the Word Who hath delivered us from corruption by thine intercessions, O most immaculate one.", "p8-p9 Ode 4 Theotokion", { sourceLabel: "Theotokion", label: "theotokion", label_inline: true }),
            ],
          },
          5: {
            irmos: mmy2("Illumine with Thy divine light, I pray, O Good One, * the souls of those who with love rise early to pray to Thee, * that they may know Thee, O Word of God, * as the true God, * Who recalleth us from the darkness of sin.", "p9 Ode 5 irmos", { sourceLabel: "Irmos", label_inline: true }),
            items: [
              mmy1("The enemy was smitten with the great endurance of the wise martyr; for having been trodden underfoot and put to shame, he became a subject of derision.", "p9 Ode 5 troparion 1", { label: "plain" }),
              mmy1("Having repulsed the malice of the tyrant, thou, O all-honored martyr, appearing meek and gentle, hast by thy bloody end been adorned with an incorruptible crown.", "p9 Ode 5 troparion 2", { label: "plain" }),
              mmy1("Thou hast truly been crowned with the honors of a martyr, and by the labors of fasting, O venerable (name), the longsuffering God fortified thee against the slayer of mankind.", "p9 Ode 5 troparion 3", { label: "plain" }),
              mmy1("The god-seeing choir of prophets, having mystically perceived thine ineffable divine birthgiving, O Virgin bride of God, proclaimed thee from afar in sacred images.", "p9 Ode 5 Theotokion", { sourceLabel: "Theotokion", label: "theotokion", label_inline: true }),
            ],
          },
          6: {
            irmos: mmy2("Beholding the sea of life surging with the tempest of temptations, * I run to Thy calm haven, and cry to Thee: * Raise up my life from corruption, * O greatly Merciful One.", "p9-p10 Ode 6 irmos", { sourceLabel: "Irmos", label_inline: true }),
            items: [
              mmy1("Steered by the life-creating arm, thou didst sit upon the waters and remain unharmed, O our father, but the commands of the persecutor were drowned therein by thine ardent prayer, O all-sacred one.", "p9-p10 Ode 6 troparion 1", { label: "plain" }),
              mmy1("By small things thou didst effect great things, for having given thyself up to martyrdom O divinely revealed one, by the spirit thou didst slay the serpent, the seducer of Eve.", "p9-p10 Ode 6 troparion 2", { label: "plain" }),
              mmy1("Unable to bear the power of thy discourse, the flattering begetter of evil savagely gave thee over to chains, wounds and a violent death, O (name).", "p9-p10 Ode 6 troparion 3", { label: "plain" }),
              mmy1("Behold, the Lord hath now assumed flesh from thy pure blood, O Virgin Theotokos, uniting Himself to mankind in an supra-natural manner, bringing about our salvation through His unspeakable mercy.", "p9-p10 Ode 6 Theotokion", { sourceLabel: "Theotokion", label: "theotokion", label_inline: true }),
            ],
          },
          7: {
            irmos: mmy2("An Angel made the furnace bedew the holy Children. * But the command of God consumed the Chaldeans * and prevailed upon the tyrant to cry: * O God of our fathers, blessed art Thou.", "p10 Ode 7 irmos", { sourceLabel: "Irmos", label_inline: true }),
            items: [
              mmy1("Separating thy mind from sympathy for carnal things, O blessed one, and consumed with the fire of asceticism, thou, O wise one, didst chant the hymn of the children: “O God of our fathers, blessed art Thou.”", "p10 Ode 7 troparion 1", { label: "plain" }),
              mmy1("By the mere invocation of thy name, evil spirits are driven away, for they have come to know thee, O venerable one, as an ascetic and martyr of Christ, who dost fervently chant: “O God of our fathers, blessed art Thou.”", "p10 Ode 7 troparion 2", { label: "plain" }),
              mmy1("Thine end was announced to thee, O most blessed (name), by the all-accomplishing will; wherefore didst thou give thyself over to yet greater fasting, and ascending from glory to glory thou wast slain for the sake of Christ, the God of all.", "p10 Ode 7 troparion 3", { label: "plain" }),
              mmy1("Raise me up who am humbled by despondency, that I may do God’s works, O most pure one, strengthening me against the enemies that ever assail me, seducing me with contrary thoughts.", "p10 Ode 7 Theotokion", { sourceLabel: "Theotokion", label: "theotokion", label_inline: true }),
            ],
          },
          8: {
            irmos: mmy2("Thou didst make flame bedew the holy children, * and didst burn the sacrifice of a righteous man with water. * For Thou alone, O Christ, dost do all as Thou willest, * Thee do we supremely exalt throughout all ages.", "p10-p11 Ode 8 irmos", { sourceLabel: "Irmos", label_inline: true }),
            items: [
              mmy1("Adorned with the virtues of fasting, and tormented with the pangs of wounds, O most glorious one, thou hast appeared before the Bestower of victories and obtained from Him the honors of victory.", "p10-p11 Ode 8 troparion 1", { label: "plain" }),
              mmy1("Kindled by love of the Almighty, O most glorious (name), thou hast laid low the haughty enemy, and through thy desire for God, thou hast been granted to be His abode throughout the ages.", "p10-p11 Ode 8 troparion 2", { label: "plain" }),
              mmy1("Deem me worthy of God’s mercy, O godly-blessed martyr, and deliver me from temptations and calamities, O venerable one (name), for honoring thee I have recourse to thy protection.", "p10-p11 Ode 8 troparion 3", { label: "plain" }),
              mmy1("Rejoice! O holy mountain, through which God hath passed; Rejoice! manifestation of the sacred mysteries, awesome tidings, and the revelation of things unseen; Rejoice! O Virgin, the restoration of the fallen.", "p10-p11 Ode 8 Theotokion", { sourceLabel: "Theotokion", label: "theotokion", label_inline: true }),
            ],
          },
          9: {
            irmos: mmy2("It is impossible for mankind to see God * upon Whom the orders of Angels dare not gaze; * but through thee, O all-pure one, * did the Word Incarnate become a man * and with the Heavenly Hosts * Him we magnify and thee we call blessed.", "p11 Ode 9 irmos", { sourceLabel: "Irmos", label_inline: true }),
            items: [
              mmy1("O godly wise father (name), thou hast attained unto the uttermost beauty and sweetness, and standing now before God dost hymn with the immaterial hosts: Holy, Holy, Holy art Thou, O all-accomplishing and all-powerful Trinity.", "p11 Ode 9 troparion 1", { label: "plain" }),
              mmy1("Having escaped the snares of thy tyrants O venerable one (name), thou, hast found rest in the heavenly abodes and having joined the ranks of the martyrs; do thou now, together with the immaterial hosts, pray for us, that we all may glorify thee.", "p11 Ode 9 troparion 2", { label: "plain" }),
              mmy1("Placing Christ, thy strength and power, before the ferocious attacks of demons thou didst easily repel them, and attain to refuge in the highest, being thoroughly adorned and richly resplendent with the effulgence of the divine light.", "p11 Ode 9 troparion 3", { label: "plain" }),
              // Item 2: “thou, hast found rest” — the comma-splice class
              // (HieroConfessor's “thou hast, conceived” mirrored).
              mmy1("Unable to comprehend the incomprehensible wonder of thy birthgiving, O Virgin Mother of God, but rather glorifying it silently, we exceedingly praise thee, O most blessed and immaculate one, who alone among women art supremely good.", "p11 Ode 9 Theotokion", { sourceLabel: "Theotokion", label: "theotokion", label_inline: true }),
            ],
          },
        },
      }],
      sessional_ode3_rubric: mmy1("The Sessional Hymn, in Tone IV:", 'p8 post-Ode-III sessional rubric'),
      // UNPOINTED, structured “the first: … the second: … the third, O
      // blessed (name):” — the thrice-baptized sessional.
      sessional_ode3: mmy1("In truth thou wast thrice baptized; the first: of water and the fire of the Holy Spirit, the second: in the ascetic struggles thou didst willingly endure, having lived on earth a life equal to that of the angels, the third, O blessed (name): when thou, like a chosen lamb, wast slain for Christ our God. Him do thou unceasingly entreat that our souls be saved.", "p8 post-Ode-III Sessional", { spec_mel: "Joseph was amazed ...", tone: 4 }),
      sessional_ode3_closer: mmy2("As he contemplated that which was beyond nature * Joseph was struck with wonder O Theotokos, at thy conception without seed. * He contemplated the mysterious dew upon the fleece, * the bush un-burnt by fire, * Aaron’s rod which budded. * Thus thy Betrothed and guardian bore witness and cried unto the priests saying: * A Virgin beareth a child, ** and after child-birth remaineth yet a virgin.", "p8 post-Ode-III Theotokion", { sourceLabel: "Glory ..., Both now ..., Theotokion, in Tone IV", tone: 4, type: "theotokion" }),
      sessional_ode3_stavrotheotokion: mmy1("The thoughts of many a heart are being laid bare and mine own mind is pierced with the lance of Thy passion, in Thy voluntary sufferings: O Child! Who seeing my lamentations and bodily sufferings will recognize in Thee the most truly existing God? I hymn, O Word, Thy compassion for the sake of which dost Thou endure the crucifixion.", "p8 post-Ode-III Stavrotheotokion", { sourceLabel: "Stavrotheotokion", type: "stavrotheotokion", label: "stavrotheotokion", label_inline: true }),
      kontakion_rubric: mmy1("The Kontakion from the Typicon; but if there be none, chant the following:", 'p10 Kontakion rubric'),
      exapostilarion_rubric: mmy1("Exapostilarion in Tone III:", 'p11 exapostilarion rubric'),
      // No (Twice) on the exapostilarion — and a semicolon after “proved”
      // where the sense wants a colon.
      exapostilarion: mmy1("Having been well proved; first by suffering, and then by thine accomplished and divine eremitic life, thou didst ascend into heaven, and standing now before Christ; do thou, O venerable father (name), fervently intercede on behalf of us who hymn thee.", "p11 Exapostilarion", { spec_mel: "Hearken, O ye women ...", tone: 3 }),
      // Bare “Theotokion:” closer label (no Glory/Both-now) — and the text is
      // HieroConfessor's exapostilarion closer RE-RENDERED (register:
      // variant).
      exapostilarion_closer: mmy1("Having given birth unto the Lord, the ineffable Joy, do thou make all who honour thee, to be participants of heavenly joy, O most pure and truly graced one, for they cry out to thee: “Forsake not thy servants, O blessed Mary.”", "p12 Exapostilarion Theotokion", { sourceLabel: "Theotokion", type: "theotokion", label: "theotokion", label_inline: true }),
      praises_rubric: mmy1("On the Praises, these Stichera, in Tone VI:", 'p12 Praises rubric'),
      // UNPOINTED PRAISES, no Spec. Mel. — prose-set stichera; praises 3
      // carries a spaced question mark (“endurance ?”).
      praises: [
        mmy1("Having dyed thy sacred vesture in the purple of thy martyric blood, thou hast worthily entered into the Holy of Holies, wherein divine glory and ineffable Light doth shine, wherein is heard the voices of those feasting; wherein also thou hast obtained the reward of thy labors; thy victory as a martyr, the never-fading crown, right worthy praise, and ever abiding life in paradise. Do thou, O most wise (name), with boldness intercede for our souls.", "p12 Praises 1", { label: "plain", tone: 6, repeat: 2 }),
        mmy1("The tempest of torments did cause thy soul to waiver, neither could long imprisonment in a dark dungeon hide thee, O glorious martyr; but rather, shining forth as light unto those in the gloomy darkness of vanity, thou didst reveal them to be the sons of day through the laver of baptism, the great and saving birth into divine life, as a God-pleasing martyr, O most wise (name).", "p12 Praises 2", { label: "plain" }),
        mmy1("Who can worthily testify to the victories of thy virtues? Whose mouth can adequately describe thy torments and endurance ? For in both hast thou been pleasing to Christ, O (name). And now, O venerable martyr, since thou hast great boldness, cease not to pray that our souls may be saved.", "p12 Praises 3", { label: "plain" }),
      ],
      praises_glory: mmy1("O come, let us crown with hymns the sufferer of Christ; as a lily of the field, and a divine flower of paradise; as a sheep of the orthodox flock, as the most comely purity and confirmation of the faith, the glory of fasters, as one manifestly revealed to the world; as one who hath obtained a never-fading diadem.", "p12 Praises Glory", { sourceLabel: "Glory ..., in Tone II", tone: 2, label: "glory" }),
      // The great short theotokion — “All my hope I place in thee” — second
      // file (Apostle prints it at the same slot).
      praises_closer: mmy2("All my hope I place in thee, * O Mother of God; ** keep me under thy protection.", "p12 Praises Both now", { sourceLabel: "Both now ..., Theotokion", type: "theotokion", label: ["both_now", "theotokion"] }),
      // The ripe-Cluster stavrotheotokion — its opening quote NEVER CLOSES
      // (sic register).
      praises_stavrotheotokion: mmy2("Upon beholding the ripe Cluster, * Whom thou didst bear in thy womb without being tilled, * hanging upon the Tree, O pure one, * thou didst exclaim lamenting and crying aloud: * “I beseech Thee O my Child, * pour forth that sweetness * by which the drunkenness of the passions is taken away, * for my sake, O Benefactor, ** who didst bear Thee in Thy tender compassion!", "p12 Stavrotheotokion", { sourceLabel: "Stavrotheotokion", type: "stavrotheotokion", label: "stavrotheotokion", label_inline: true }),
      // The rubric DROPS “and a Doxasticon is appointed” — the short form.
      great_doxology_rubric: mmy1("The great Doxology: If a small Doxology is read, the following is chanted after the Aposticha:", 'p12 great Doxology rubric'),
      doxology_glory: mmy2("O venerable martyr (name), with the help of the Spirit * thou didst vanquish the embittered enemy, * and as an invincible warrior, * thou didst slay the noetic Ethiopians * with the weapon of the faith, * and having lawfully completed thine ascetic endeavors, * thou hast been crowned together with all the choirs of the martyrs, ** O most noetically rich and venerable martyr.", "p12-p13 Doxology Glory", { sourceLabel: "Glory ..., in Tone IV", tone: 4, label: "glory" }),
      doxology_closer_label: mmy1("Both now ..., in Tone IV:", 'p13 Both now label'),
      // The aposticha alternate REPRINTED as the Doxology closer, under a
      // bare inline “Theotokion:” label — two sites in-file (register).
      doxology_closer: mmy2("Deliver us from our needs, * O Mother of Christ God, * thou who hast given birth to the Creator of all, * that we all may cry out to thee: ** Rejoice, O thou who alone art the intercessor for our souls!", "p13 Doxology Theotokion", { sourceLabel: "Theotokion", tone: 4, type: "theotokion", label: "theotokion", label_inline: true }),
      troparion_rubric: mmy1("After Our Father ..., the Troparion of the venerable martyr, in Tone VIII:", 'p13 after Our Father rubric'),
      closer: { absent: true, reason: "not_printed_in_source", basis: "close_reading", note: "Slot printed as “Glory ..., Both now ..., Theotokion or Stavrotheotokion:” with no text (§5.8)." },
      // “The Dismissal” — no colon, alone in the corpus.
      closing_rubric: mmy1("The Dismissal", 'p13 Dismissal'),
    },
    ...
    liturgy: {
      order: ['beatitudes_rubric', 'beatitudes', 'propers_rubric', 'troparion',
              'kontakion', 'prokeimenon', 'prokeimenon_verse', 'epistle',
              'alleluia', 'alleluia_verse', 'gospel', 'communion_verse'],
      beatitudes_rubric: mmy1("Typika and Beatitudes.", 'p14 Typika and Beatitudes'),
      // Beatitude 5 REWRITES its canon source — “O godly venerable one, by
      // the spirit thou HAST SLAIN” against the canon's “O divinely revealed
      // one … DIDST SLAY”: the first Beatitude to rewrite rather than copy
      // (register: variant). The other six copy byte-for-byte.
      beatitudes: [
        mmy1("O venerable father, fortified by God’s strength, thou, O most blessed spiritual athlete, didst undertake the endurance of afflictions and torments from the tyrants.", "p14 Beatitude 1", { label: "plain", repeat: 2 }),
        mmy1("The greatest of strugglers, even Christ, endowed thee with strength to destroy deception, and to put to shame the enemy, who impudently boasted, everywhere raging in vain.", "p14 Beatitude 2", { label: "plain" }),
        mmy1("Beautiful appear thy feet, O venerable one, traversing joyfully the path of martyrdom, covering the heads of the wicked with shame, O great sufferer (name).", "p14 Beatitude 3", { label: "plain" }),
        mmy1("Steered by the life-creating arm, thou didst sit upon the waters and remain unharmed, O our father, but the commands of the persecutor were drowned therein by thine ardent prayer, O all-sacred one.", "p14 Beatitude 4", { label: "plain" }),
        mmy1("By small things thou didst effect great things, for having given thyself up to martyrdom O godly venerable one, by the spirit thou hast slain the serpent, the seducer of Eve.", "p14 Beatitude 5", { label: "plain" }),
        mmy1("Unable to bear the power of thy discourse, the flattering begetter of evil savagely gave thee over to chains, wounds and a violent death, O (name).", "p14 Beatitude 6", { label: "plain" }),
        mmy1("Behold, the Lord hath now assumed flesh from thy pure blood, O Virgin Theotokos, uniting Himself to mankind in an supra-natural manner, bringing about our salvation through His unspeakable mercy.", "p14 Beatitude 7", { sourceLabel: "Theotokion", label: "theotokion", label_inline: true }),
      ],
      propers_rubric: mmy1("The Troparion and Kontakion from the Typicon, but if there be none, chant the following:", 'p14 Liturgy propers rubric'),
      prokeimenon: mmy2("The saints shall boast in glory * and they shall rejoice upon their beds.", "p14 Liturgy Prokeimenon", { sourceLabel: "Prokeimenon, in Tone VIII", tone: 8, label_inline: true }),
      // “His saints?.” — the MonasticMartyrs-plural defect EXACTLY, at its
      // second file (HieroConfessor mutates it to “saints? .”).
      prokeimenon_verse: mmy1("Sing unto the Lord a new song, His praise is in the Church of His saints?.", "p14 Liturgy Prokeimenon verse", { sourceLabel: "Verse", label: "refrain" }),
      // "THE 2nd EPISTLE" — a mixed-case ordinal in a heading, alone in the
      // corpus.
      epistle: { heading: 'THE 2nd EPISTLE OF ST. PAUL TO TIMOTHY',
        src: { file: MY, locus: 'p15 Epistle' },
        citation_verbatim: '(1: 8-17)',
        citation: { book: '2 Timothy', chapter: 1, verses: '8-17' },
        citation_basis: 'printed' },
      // The monastic-class Alleluia — fifth file.
      alleluia: mmy1("Blessed is the man that feareth the Lord, in His commandments shall he greatly delight.", "p15 Alleluia", { sourceLabel: "Alleluia, in Tone VI", tone: 6, label_inline: true }),
      alleluia_verse: mmy1("His seed shall be mighty upon the earth; the generation of the upright shall be blessed.", "p15 Alleluia verse", { sourceLabel: "Verse", label: "refrain" }),
      // "GOSPEL ACCORDING TO ST. MATTHEW" — no "THE", alone in the corpus;
      // and the citation prints "19 27-30" with its colon MISSING.
      gospel: { heading: 'GOSPEL ACCORDING TO ST. MATTHEW',
        src: { file: MY, locus: 'p15 Liturgy Gospel' },
        citation_verbatim: '(10:32,33,37-38; 19 27-30)',
        citation: { book: 'Matthew', chapter: 10, verses: '10:32-33, 37-38; 19:27-30' },
        citation_basis: 'printed' },
      // The semicolon form — fifth file.
      communion_verse: mmy1("Rejoice in the Lord, O ye righteous; praise is meet for the upright.", "p15 Communion verse", { sourceLabel: "Communion Verse", label_inline: true }),
    },

    // Page 16 is BLANK — the service ends on p15. Declared per §2.10 (the
    // first trailing blank page in the corpus; silence is not a declaration).
    page_16: { absent: true, reason: "not_printed_in_source", basis: "close_reading", src: { file: MY, locus: "p16 blank page" }, note: "Nothing printed on the final leaf." },
  },
  NunMartyr: {
    // “GENERAL VIGIL SERVICE TO A NUN-MARTYR.” — the only title WITHOUT
    // its leading THE. The dual nature runs into the LESSON SET: martyric
    // Isaiah + Wisdom 3, then the MONASTIC Wisdom 4 third lesson.
    title: nm1("GENERAL VIGIL SERVICE TO A NUN-MARTYR.", 'p1 title'),

    // Martyress's “Thy ewe-lamb” troparion — with the SAME “cru-cified”
    // line-break hyphen inside it at all four sites, stored as-extracted
    // per the A-1 precedent (byte-symmetric with Martyress's copy). Four
    // sites byte-identical, all Tone IV.
    troparion: nm2("Thy ewe-lamb (name), O Jesus crieth out with a loud voice: * “Thee do I love, O my Bridegroom, * and, seeking Thee, I endure suffering. * In Thy baptism I am cru-cified and buried with Thee. * I suffer for Thy sake, that I may reign with Thee; * I die for Thee, that I may live with Thee. * Accept me, who with love sacrifice myself for Thee, * as an unblemished offering!” ** By her supplications, in that Thou art merciful, save Thou our souls.", "p4 Troparion", { sourceLabel: "Troparion of the venerable nun-martyr, in Tone IV", verified_sites: [{"locus": "p4 Vespers dismissal", "tone": 4}, {"locus": "p5 God is the Lord", "tone": 4, "repeat": 2}, {"locus": "p13 after Our Father", "tone": 4}, {"locus": "p14 AT LITURGY", "tone": 4}] }),
    kontakion: nm2("Thy divine memory, O (name), * appeareth like a sun proclaiming thy life to the world, * for having subdued the passions of the flesh with abstinence, * thou hast united thyself to Christ by the blood of martyrdom; * wherefore we implore thee to deliver from every evil circumstance * those who praise thee, that we may cry unto thee: ** Rejoice, O venerable mother (name).", "p9 Kontakion after Ode VI", { sourceLabel: "Kontakion of the venerable nun-martyr, in Tone IV", spec_mel: "Go thou quickly before ...", tone: 4, verified_sites: [{"locus": "p9 after Ode VI", "tone": 4}, {"locus": "p14 AT LITURGY", "tone": 4}] }),
    // Bare “Ikos:” (second file) — and the body is HieroConfessor's Ikos
    // REGENDERED for the nun-martyr, closing “Rejoice, O venerable mother.”
    // with no (name) where the kontakion prints one (register: variant).
    ikos: nm1("Standing now before God, O most glorious venerable martyr, by thy God-pleasing entreaties open my lips, that I may praise thy divine life, O most-blessed one, and worthily depict thy sufferings which for the sake of thy fervent love, thou hast endured on earth. By thy faith thou didst ever pursue vigilance and abstinence, and loving purity, wast revealed to be an invincible maiden martyr; wherefore deliver us who praise thee from every evil circumstance, that we may cry out to thee: “Rejoice, O venerable mother.”", "p10 Ikos", { sourceLabel: "Ikos", label_inline: true }),
    ...
    vespers: {
      order: ['lic_rubric', 'lic', 'lic_closer', 'lic_stavrotheotokion',
              ...
              'aposticha_closer', 'aposticha_alternate', 'aposticha_stavrotheotokion',
              'troparion_rubric', 'troparion', 'closer', 'closing_rubric'],
      lic_rubric: nm1("On “Lord, I have cried ...,” these Stichera, in Tone VIII:", 'p1 LIC rubric'),
      lic: [
        nm2("Through abstinence * subduing the bodily passions, * and by thy passion slaying the alien adversary, * O all-praised maiden martyr (name), * thou hast been a source of astonishment to the angels, * and by thy suffering of pangs for us, * thou hast brought joy to all, * O adornment of ascetics, and vessel of virginity! ** pray thou that our souls be saved.", "p1 LIC 1", { spec_mel: "What shall we call you ...", label: "plain", tone: 8 }),
        nm2("What shall we call thee, * O glorious one, * a bride of Christ made radiant through the beauty of virginity, * an elect daughter of Jerusalem on high, * a co-dweller and friend of the Angels? * Delighting now * in the spiritual palace, * O greatly-suffering adornment of ascetics (name), ** pray thou that our souls be saved.", "p1 LIC 2", { spec_mel: "What shall we call you ...", label: "plain" }),
        nm2("Looking upon the beauty * of the Bridegroom, * O greatly suffering (name), * thou didst endure the breaking of thy teeth, * the severing of thy hands, feet and breasts, * and being cut in pieces by the lawless tormentors, * thou didst supra-naturally suffer pangs, * O incorrupt bride of Christ, ** pray thou that our souls be saved.", "p1 LIC 3", { spec_mel: "What shall we call you ...", label: "plain" }),
      ],
      lic_closer: nm2("Which of thy kind deeds do we find most wondrous, * O most pure one? * For we see thee healing the sick, and delivering us from passions, * driving away the godless assaults of our enemies, * soothing the afflicted, * and through thine intercessions saving from misfortunes those who hymn thee. * O Virgin, mediatress, the joy of thy servants, ** pray thou that our souls be saved.", "p1 LIC closer", { sourceLabel: "Glory ..., Both now ..., Theotokion in Tone VIII", tone: 8, type: "theotokion", label: ["glory", "both_now", "theotokion"] }),
      lic_stavrotheotokion: nm2("The ewe-lamb, as she beheld the Lamb * stretched out of His own will upon the Tree of the Cross, * cried out maternally, in pain with her weeping: * O my Son, what is this strange sight? * O Longsuffering One, how is it that Thou art slain, * Who, as Lord, bestoweth life upon all, granting resurrection to mortals? ** I glorify Thy great condescension, O my God!", "p1 Stavrotheotokion", { sourceLabel: "Stavrotheotokion", type: "stavrotheotokion", label: "stavrotheotokion", label_inline: true }),
      // “If an Idiomelon be appointed. Glory ...” — a FULL STOP where every
      // sibling prints a comma (sic register).
      idiomelon_rubric: nm1("If an Idiomelon be appointed. Glory ..., in Tone II:", 'p1 idiomelon rubric'),
      // “she hath vanquished the falshood of idols” — falsehood misspelled
      // (sic register).
      lic_glory: nm2("Let us hymn with gladsome voices and solemn chant, * the venerable martyr (name), * for she hath vanquished the falshood of idols * and manfully subdued the adversary under her feet, * and after her repose ascended into the heavens, * bearing a crown upon her head, and crying aloud: * “Thee do I love and desire O my Bridegroom, * I have given my body over to torments for Thee, * that I might make my dwelling in the heavens, ** wherein all those who praise Thee abide.”", "p1 Glory idiomelon", { sourceLabel: "Glory ..., in Tone II", tone: 2, label: "glory" }),
      // “chant … chant” for “sing … sing”, “the Dogmatic IN the Tone” for
      // “of the Tone” — and the travelling “service ):” space, SEVENTH file.
      dogmatikon_rubric: nm1("If the Celebration be with a Polyeleos, and not a Resurrection Service, chant the following Dogmatic in Tone II (If the service is a Resurrection service chant the Dogmatic in the Tone for that service ):", 'p1-p2 dogmatikon rubric'),
      // The Tone II dogmatic — Nun's copy (the octoechos:tone2 cross-book
      // pair) — byte-checked in the register.
      dogmatikon: nm2("The shadow of the law hath passed now that grace hath come, * for as the Bush wrapped in flame was not consumed, * so didst thou bear a Child O Virgin * and remained a Virgin; * in place of a pillar of fire, the Sun of righteousness hath dawned, * instead of Moses, Christ is come, ** the salvation of our souls.", "p2 Both now dogmatic", { sourceLabel: "Both now ..., in Tone II", tone: 2, type: "dogmatic_theotokion", label: "both_now" }),
      // “That we not fall way” — “away” missing its first letter (sic
      // register).
      dogmatikon_alternate: nm2("In thee have we placed our trust, O Theotokos. * That we not fall way, save us from perils, * O helper of the tempest-tossed, * and confound the counsels of the adversary, ** for thou art our salvation, O blessed one.", "p2 Otherwise Theotokion", { sourceLabel: "Otherwise, Theotokion", type: "theotokion", label: "theotokion", label_inline: true }),
      dogmatikon_stavrotheotokion: nm2("Upon beholding her Lamb led of His own will to the slaughter as a man, * the unblemished ewe-lamb, cried aloud weeping: * “Dost Thou now hasten to leave childless, * the one who gave Thee birth, O Christ? * What is this that Thou hast done, O Redeemer of all? * Even so I will hymn and glorify Thine extreme goodness * which passeth understanding and all telling, ** O Lover of mankind!”", "p2 Stavrotheotokion", { sourceLabel: "Stavrotheotokion", type: "stavrotheotokion", label: "stavrotheotokion", label_inline: true }),
      entrance_rubric: nm1("The Entrance. The Prokeimenon of the day. The Three Lessons, if appointed:", 'p2 Entrance rubric'),
      // THE DUAL NATURE'S LESSON SET: the martyric Isaiah (in the CORRUPTED
      // "our let them hear" copy — fifth file with that body defect) and
      // Wisdom 3, then the MONASTIC Wisdom 4 third lesson (with
      // MonasticMartyr's "un to men" split — second file). No Wisdom 5 at
      // all, so neither stone-bow rendering appears. Bodies unstored per R-4.
      readings: [
        { heading: 'THE READING IS FROM ISAIAH',
          src: { file: NM, locus: 'p2 Lesson 1' },
          citation: { book: 'Isaiah', chapter: 43, verses: '9-14' },
          citation_basis: 'identified',
          provenance_note: 'The martyric Isaiah, "our let them hear" included. Identified; confirm against the page.' },
        { heading: 'A READING FROM THE WISDOM OF SOLOMON',
          src: { file: NM, locus: 'p2-p3 Lesson 2' },
          citation: { book: 'Wisdom of Solomon', chapter: 3, verses: '3:1-3:9' },
          citation_basis: 'identified',
          provenance_note: 'The "souls of the righteous" lesson. Identified; confirm against the page.' },
        { heading: 'A READING FROM THE WISDOM OF SOLOMON',
          src: { file: NM, locus: 'p3 Lesson 3' },
          citation: { book: 'Wisdom of Solomon', chapter: 4, verses: '4:7-15' },
          citation_basis: 'identified',
          provenance_note: 'The monastic third lesson with the "un to men" split. Identified; confirm against the page.' },
      ],
      aposticha_rubric: nm1("On the Aposticha, the Stichera, in Tone IV:", 'p3 Aposticha rubric'),
      // “double-crowns” — hyphenated at its line break; the corpus elsewhere
      // prints “double crown(s)” as two words. Restored per the A-1 compound
      // rule; printed again hyphenated at Praises 3.
      aposticha: [
        nm2("In thy struggles, O all-praised (name), * thou hast endured a dual suffering, * mixing the sweat of abstinence * with the blood of Martyrdom; * wherefore, O holy one, * having ascended unto the Compassionate one * brightly adorned with unblemished virginity, * and as an invincible martyr, ** He hath bestowed upon thee double-crowns.", "p3 Aposticha 1", { spec_mel: "Thou hast given a sign ...", label: "plain", tone: 4 }),
        nm2("Wondrous is God in His saints, * the God of Israel.", "p3 Aposticha verse 1", { sourceLabel: "Verse", label: "refrain" }),
        nm2("The fairness of thy form * and the beauty of thy divine soul * have been joined together in thee, * shining forth like a pure white lily * in the abodes of the ascetics * and the meadows of martyrdom, * O undefiled bride (name); * wherefore the divine Bridegroom hath also received thee ** as a virgin and martyr in the everlasting palaces.", "p3 Aposticha 2", { spec_mel: "Thou hast given a sign ...", label: "plain" }),
        nm2("In the Congregations bless ye God, the Lord, * from the wellsprings of Israel.", "p3 Aposticha verse 2", { sourceLabel: "Verse", label: "refrain" }),
        nm2("From childhood thou wast god-fearing * and presented as an honorable offering to the Almighty, * O all-praised (name), * wherefore thy guardian angel * protected thee, * assisting thee to trample underfoot * the raging of the tyrant, ** delivering thee to thy Bridegroom Christ.", "p3 Aposticha 3", { spec_mel: "Thou hast given a sign ...", label: "plain" }),
      ],
      // THIS GLORY PRINTS AT THREE SITES — aposticha Glory, post-Psalm-50
      // sessional, Doxasticon — all byte-identical (register).
      aposticha_glory: nm2("Standing on the right hand of the Savior, * O maiden martyr (name), * adorned with a vesture of virtues, * the oil of purity and the blood of martyrdom, * thou dost joyfully raise thy lamp unto Him and cry aloud: * “I was seeking, O Christ God, the sweet smell of Thy myrrh, * since I am smitten with love for Thee, * cast me not away, * O my heavenly Bridegroom.” * By her intercessions send down upon us Thy mercies, ** O all-powerful Savior.", "p4 Aposticha Glory", { sourceLabel: "Glory ..., in Tone VI", tone: 6, label: "glory" }),
      aposticha_closer_label: nm1("Both now ..., in Tone VI:", 'p4 Both now label'),
      aposticha_closer_rubric: nm1("If the Celebration be with a Polyeleos, chant the Resurrection Theotokion:", 'p4 aposticha closer rubric'),
      // “Rejoice!, O Sovereign Lady” — exclamation mark AND comma stacked
      // (sic register).
      aposticha_closer: nm2("Christ the Lord, my Creator and Redeemer, * Who came forth from thy womb, O all-pure one, * and clothed Himself in my nature, * hath freed Adam from the primal curse. * Wherefore, like the angel * we unceasingly cry out to thee, * O most pure one, * who art truly the Mother of God and Virgin: * Rejoice!, O Sovereign Lady, ** the intercession, protection and salvation of our souls!", "p4 Resurrection Theotokion", { tone: 6, type: "theotokion", label: "theotokion" }),
      aposticha_alternate: nm2("The eye of my heart longingly seeketh thee, * O Sovereign Lady; disdain not my feeble sigh. * At the hour when thy Son shall judge the world, ** be thou my protection and helper.", "p4 Otherwise Theotokion", { sourceLabel: "Otherwise, Theotokion", type: "theotokion", label: "theotokion", label_inline: true }),
      // The “diest?,” copy — FOURTH byte-identical site.
      aposticha_stavrotheotokion: nm2("Upon seeing Thee crucified, O Christ, * she who gaveth birth to Thee cried aloud: * “What is this strange mystery that I see, * O my Son How is it that Thou diest?, * suspended upon the Tree, ** O Bestower of life?”", "p4 Stavrotheotokion", { sourceLabel: "Stavrotheotokion", type: "stavrotheotokion", label: "stavrotheotokion", label_inline: true }),
      // NO TYPICON-FALLBACK RUBRIC AT VESPERS — the only file to print its
      // Vespers troparion under a bare label with no “from the Typicon”
      // conditional. Declared, not silent (§2.10).
      troparion_rubric: { absent: true, reason: "not_printed_in_source", basis: "close_reading", note: "The page goes straight to “Troparion of the venerable nun-martyr, in Tone IV:” — no Typicon-fallback rubric printed, alone in twenty files." },
      closer: { absent: true, reason: "not_printed_in_source", basis: "close_reading", note: "Slot printed as “Glory ..., Both now ..., Theotokion, or Stavrotheotokion.” — a comma before ‘or’ and a full stop for the colon — with no text (§5.8)." },
      closing_rubric: nm1("The Dismissal:", 'p4 Dismissal'),
    },
    ...
    matins: {
      order: ['god_is_lord_rubric', 'troparion', 'troparion_closer',
              ...
              'doxology_glory', 'doxology_closer_rubric', 'troparion_rubric',
              'troparion', 'closer', 'closing_rubric'],
      // “the Troparion of the venerable nun-Martyr.” — mixed-case Martyr, a
      // full stop for the colon, and NO tone named.
      god_is_lord_rubric: nm1("On “God is the Lord ...,” the Troparion of the venerable nun-Martyr.", 'p5 God is the Lord rubric'),
      troparion_closer: { absent: true, reason: "not_printed_in_source", basis: "close_reading", note: "Slot printed as “Glory ..., Both now ..., Theotokion, or Stavrotheotokion.” — comma-or and full stop again — with no text (§5.8)." },
      sessional_1_rubric: nm1("After the 1st chanting of the Psalter, the Sessional Hymn, in Tone VIII:", 'p5 sessional 1 rubric'),
      sessional_1: nm2("Extinguishing the flame of passions * with the dew of abstinence * and burning the delusion of idols * with the fire of thy blood * thou hast brought thine honorable virginity and valiant suffering * as a precious dowry unto the Bridegroom Christ; * wherefore He led thee, who fought gloriously * and vanquished the serpent, * into the palace of His glory * O greatly-suffering (name). * Entreat Christ God to grant the remission of sins ** unto those who lovingly honor thy holy memory.", "p5 Sessional 1", { spec_mel: "Of the wisdom ...", tone: 8, repeat: 2 }),
      // The five-file “All we, the generations” Theotokion — but the TAIL
      // REWRITES AND BREAKS: “forgiveness of sins, ** unto those who with
      // hymn thy glory as is meet.” — a word lost after “with” (sic
      // register; register: variant against the family).
      sessional_1_closer: nm2("All we, the generations of mankind, * call thee blessed, * in that thou art the Virgin who alone among women * hast given birth without seed unto God in the flesh; * for the fire of the Godhead made its abode within thee, * and thou didst feed the Creator and Lord * with milk as an infant. * Wherefore, we, the race of mankind and of angels, * worthily glorify thine all-holy birthgiving, * and together we cry out to thee: * Entreat Christ God to grant forgiveness of sins, ** unto those who with hymn thy glory as is meet.", "p5 Sessional 1 Theotokion", { sourceLabel: "Glory ..., Both now ..., Theotokion, in Tone VIII", tone: 8, type: "theotokion" }),
      sessional_2_rubric: nm1("After the 2nd chanting of the Psalter, the Sessional Hymn, in Tone VIII:", 'p5 sessional 2 rubric'),
      // “Thy tomb O Savior” — the melody label without its comma.
      sessional_2: nm2("For the sake of thy love for Christ, * thou didst bring unto the Bridegroom, * like an alabaster phial of fragrant myrrh, * first asceticism, secondly the blood of Martyrdom, * and he rewarded thee, O wondrous martyr (name), * with a divine and incorruptible crown * and the grace of healing through the power of the Holy Spirit.", "p5 Sessional 2", { spec_mel: "Thy tomb O Savior ...", tone: 8, repeat: 2 }),
      sessional_2_closer: nm1("O pure Virgin Theotokos who knewest not wedlock, thou sole intercessor and protection of the faithful: from tribulations, sorrows and cruel circumstances deliver all who place their trust in thee, O Maiden, and save our souls by thy divine supplications.", "p5 Sessional 2 Theotokion", { sourceLabel: "Glory ..., Both now ..., Theotokion, in Tone VIII", tone: 8, type: "theotokion" }),
      megalynarion_rubric: nm1("After the Polyeleos, the Megalynarion:", 'p6 megalynarion rubric'),
      megalynarion: nm1("We magnify thee, O holy maiden martyr (name), and honor thy precious sufferings which thou didst endure for the sake of Christ.", 'p6 Megalynarion'),
      // “Our God is refuge and strength” — the MARTYRIC megalynarion verse,
      // fourth file (Martyr, Martyress, Martyresses): the martyr half of the
      // dual nature takes the verse.
      megalynarion_verse: nm1("Our God is refuge and strength, a helper in afflictions which mightily befall us.", "p6 Megalynarion verse", { sourceLabel: "Verse", label: "refrain" }),
      sessional_polyeleos_rubric: nm1("After the Polyeleos the Sessional Hymn, in Tone VIII:", 'p6 Polyeleos sessional rubric'),
      // “Of the wisdom” serves BOTH sessional 1 and the Polyeleos sessional —
      // one melody, two hymns, the first such doubling in the corpus.
      sessional_polyeleos: nm2("Binding thy soul to Christ with love, * O glorious disciple of the Word, * and passing by the fleeting corruptible and temporal things of this life; * thou, O wise martyr, didst first slay the passions with ascetic struggle * then put to shame the deceiver by thy martyrdom; * having obeyed thy Creator to the end. * Beseech Christ God, O most noetically rich martyr (name), * that those who honor thy holy memory with love ** be granted the remission of their sins.", "p6 Polyeleos sessional", { spec_mel: "Of the wisdom ...", tone: 8, repeat: 2 }),
      sessional_polyeleos_closer: nm2("As the all-immaculate Bride of the Creator, * Mother of the Redeemer, who knewest not a man, * and as the receptacle of the Comforter O all-hymned one, * hasten thou to deliver me, * the vile abode of iniquity and noetic plaything of the demons, * from their evil machinations; * and make me the bright dwelling-place of the virtues, * O thou incorrupt light-bearing one. * Drive away the clouds of the pas-sions and grant that, * by thy supplications, * I may receive a portion on high ** and share in the never-waning light.", "p6 Polyeleos sessional Theotokion", { sourceLabel: "Glory ..., Both now ..., Theotokion, in Tone VIII", tone: 8, type: "theotokion" }),
      anabathmoi_rubric: nm1("If of Polyeleos rank, and not a Resurrection Service, chant the following:", 'p6 anabathmoi rubric'),
      anabathmoi_intro: nm1("The Song of Ascents: The first antiphon, in Tone IV:", 'p6 anabathmoi heading'),
      anabathmoi: [
        nm2("From my youth * do many passions war against me; * but do Thou Thyself defend ** and save me, O my Savior.", "p6 anabathmoi 1", { label: "plain" }),
        nm2("Ye haters of Zion * shall be shamed by the Lord; * for like grass, by the fire ** shall ye be withered.", "p6 anabathmoi 2", { label: "plain" }),
      ],
      anabathmoi_closer: nm2("In the Holy Spirit, * every soul is quickened, * and, through cleansing, is exalted ** and made radiant by the Triple Unity in a hidden sacred manner.", "p6 anabathmoi Glory Both now", { sourceLabel: "Glory ..., Both now ...,", label: ["glory", "both_now"] }),
      // The double prokeimenon label — THIRD file.
      prokeimenon_rubric: nm1("Prokeimenon, in Tone IV:", 'p6 prokeimenon rubric'),
      prokeimenon: nm2("Wondrous is God in His saints, * the God of Israel.", "p6 Prokeimenon", { sourceLabel: "The Prokeimenon", tone: 4, label_inline: true }),
      prokeimenon_verse: nm1("In the Congregations bless ye God, the Lord, from the wellsprings of Israel.", "p6 Prokeimenon verse", { sourceLabel: "Verse", label: "refrain" }),
      gospel_rubric: nm1("Let every breath ...,", 'p6 Let every breath'),
      // Nun's ten-virgins pericope — but the citation drops Nun's space:
      // "(25,1-13)" against "(25, 1-13)".
      gospel: { heading: 'THE GOSPEL ACCORDING TO ST. MATTHEW',
        src: { file: NM, locus: 'p6-p7 Matins Gospel' },
        citation_verbatim: '(25,1-13)',
        citation: { book: 'Matthew', chapter: 25, verses: '1-13' },
        citation_basis: 'printed' },
      psalm50_rubric: nm1("After the 50th Psalm:", 'p7 After the 50th Psalm'),
      // Capital-V “Venerable” mid-label.
      psalm50_sticheron: nm2("Through the prayers of the Venerable nun-martyr (name), * O Merciful One, ** blot out the multitude of our transgressions.", "p7 Psalm 50 Glory", { sourceLabel: "Glory ..., in Tone VI", tone: 6, label: "glory" }),
      psalm50_closer: nm2("Through the prayers of the Theotokos, * O Merciful One, ** blot out the multitude of our transgressions.", "p7 Psalm 50 Both now", { sourceLabel: "Both now ...,", type: "theotokion", label: "both_now" }),
      psalm50_verse: nm2("Have mercy on me, O God, * according to Thy great mercy; * and according to the multitude of Thy compassions, ** blot out my transgressions.", "p7 Psalm 50 verse", { label: "refrain" }),
      sessional_post50_rubric: nm1("Then the Sessional Hymn, in Tone VI:", 'p7 post-Psalm-50 sessional rubric'),
      // Second site of the three-site Glory.
      sessional_post50: nm2("Standing on the right hand of the Savior, * O maiden martyr (name), * adorned with a vesture of virtues, * the oil of purity and the blood of martyrdom, * thou dost joyfully raise thy lamp unto Him and cry aloud: * “I was seeking, O Christ God, the sweet smell of Thy myrrh, * since I am smitten with love for Thee, * cast me not away, * O my heavenly Bridegroom.” * By her intercessions send down upon us Thy mercies, ** O all-powerful Savior.", "p7 post-Psalm-50 Sessional", { tone: 6 }),
      canon_rubric: nm1("The Canon, in Tone VIII:", 'p7 Canon rubric'),
      canons: [{
        title: "The Canon, in Tone VIII:", tone: 8,
        odes: {
          1: {
            irmos: nm2("Let us sing unto the Lord, * who led His people through the Red Sea: * for He alone hath gloriously been glorified.", "p7-p8 Ode 1 irmos", { sourceLabel: "Irmos", label_inline: true }),
            refrain: nm1("Venerable nun-martyr (name) pray to God for us", "p7 Ode 1 refrain", { sourceLabel: "Refrain", label_inline: true }),
            items: [
              nm1("Grant unto me who honoreth thy radiant commemoration, O Divinely-wise one, divine illumination, and drive away all darkness from my soul.", "p7-p8 Ode 1 troparion 1", { label: "plain" }),
              nm1("From thy youth hast thou given thyself entirely over to thy Maker, O (name), and with the fire of abstinence thou hast burned up the passions of the body.", "p7-p8 Ode 1 troparion 2", { label: "plain" }),
              nm1("Thou hast ascended unto the heights of Martyrdom, O Martyr, not sparing thy body, and as a Virgin thou hast been deemed worthy of the heavenly mansions.", "p7-p8 Ode 1 troparion 3", { label: "plain" }),
              nm1("We honor thee, O Maiden, as the ladder reaching unto heaven, upon which God descended, rendering mankind divine.", "p7-p8 Ode 1 Theotokion", { sourceLabel: "Theotokion", label: "theotokion", label_inline: true }),
            ],
          },
          3: {
            irmos: nm2("O Lord, thou art the confirmation of those who flee to Thee, * Thou art the Light of those in darkness, * and my spirit doth hymn Thee.", "p8 Ode 3 irmos", { sourceLabel: "Irmos", label_inline: true }),
            items: [
              nm1("Standing before the judgment seat of thy tormentor, O glorious (name), thou didst preach Christ the Word of God, as the Master and Fashioner of all.", "p8 Ode 3 troparion 1", { label: "plain" }),
              nm1("Thine eyes reflecting the goodness of thy heart, rendered thee, O glorious (name), the fairest of maidens.", "p8 Ode 3 troparion 2", { label: "plain" }),
              nm1("An inexhaustible treasury of healings was granted unto thee by Christ, O maiden, Whose poverty thou didst voluntarily love.", "p8 Ode 3 troparion 3", { label: "plain" }),
              nm1("Burn up with the fire of thine intercessions, all of my sins, O Mother of the Light, and bestow upon me the divine dew of remission.", "p8 Ode 3 Theotokion", { sourceLabel: "Theotokion", label: "theotokion", label_inline: true }),
            ],
          },
          4: {
            irmos: nm2("O Lord, I have heard the mystery of Thy dispensation; * I have considered Thy works, * and I have glorified Thy Divinity.", "p8-p9 Ode 4 irmos", { sourceLabel: "Irmos", label_inline: true }),
            items: [
              nm1("Having from thy youth borne the light yoke of Christ, O maiden martyr, thou hast now endured the heavy burden laid upon thee by the most lawless ones.", "p8-p9 Ode 4 troparion 1", { label: "plain" }),
              nm1("The drops of thy blood extinguished the burning coals of polytheism, and the rays of thy miracles, O (name), have consumed the passions.", "p8-p9 Ode 4 troparion 2", { label: "plain" }),
              nm1("Thou hast been raised on high by the fire that hath been lit in thy bosom, O Martyr, enflaming, O virgin, thy fervor for the Master.", "p8-p9 Ode 4 troparion 3", { label: "plain" }),
              nm1("After birthgiving thou didst remain as pure, O Virgin, as thou wast before birthgiving, for thou hast given birth to a young Child Who existed before all ages.", "p8-p9 Ode 4 Theotokion", { sourceLabel: "Theotokion", label: "theotokion", label_inline: true }),
            ],
          },
          5: {
            irmos: nm2("Rising early we cry to Thee, O Lord; * save us, for Thou art our God, * and we know none other besides Thee.", "p9 Ode 5 irmos", { sourceLabel: "Irmos", label_inline: true }),
            items: [
              nm1("Thou didst appear untouched by the material fire, O (name), for the divine fire of thy fervent love for the Bridegroom bedewed thee.", "p9 Ode 5 troparion 1", { label: "plain" }),
              nm1("Adorned by the striking of thy face, O (name), thou didst rebuff the foolishness of thy tormentors.", "p9 Ode 5 troparion 2", { label: "plain" }),
              nm1("Stretched out upon the tree, O divinely-wise (name), thou wast revealed to be an icon of the divine passion of thy beloved Bridegroom.", "p9 Ode 5 troparion 3", { label: "plain" }),
              nm1("We hymn thee, O all-hymned Sovereign Lady Theotokos, for thou hast given birth in the flesh to God the supremely exalted One, O most pure Virgin.", "p9 Ode 5 Theotokion", { sourceLabel: "Theotokion", label: "theotokion", label_inline: true }),
            ],
          },
          6: {
            irmos: nm2("O Thou that puttest on light as a garment * grant me also a robe of light, * O All-merciful Christ, our God.", "p9 Ode 6 irmos", { sourceLabel: "Irmos", label_inline: true }),
            items: [
              nm1("The ruin of thy body with wounds showed thine adamantine resolve before Christ our God, O maiden martyr (name).", "p9 Ode 6 troparion 1", { label: "plain" }),
              nm1("Suspended and enduring wounds, thou, O right praiseworthy martyr (name), preserved unharmed the nobility of thy soul.", "p9 Ode 6 troparion 2", { label: "plain" }),
              nm1("O venerable mother, whilst enduring the rending of thy breasts, thou didst feed the faithful with the milk of thy divine compassion, O glorious one.", "p9 Ode 6 troparion 3", { label: "plain" }),
              nm1("Having given birth to God, the Lover of mankind, O god-loving Lady, entreat Him that we be delivered from the fire of Gehenna.", "p9 Ode 6 Theotokion", { sourceLabel: "Theotokion", label: "theotokion", label_inline: true }),
            ],
          },
          7: {
            irmos: nm2("The Children of Judaea, * who of old came to dwell in Babylon, * trampled underfoot the flame of the furnace * through their faith in the Trinity, * as they sang: “O God of our fathers, blessed art Thou.”", "p10 Ode 7 irmos", { sourceLabel: "Irmos", label_inline: true }),
            items: [
              nm1("Thou, O maiden martyr (name), dost now exult with the choir of virgins in the place where the sound of those keeping festival is heard, chanting unto God the Creator: “O God of our fathers, blessed art Thou.”", "p10 Ode 7 troparion 1", { label: "plain" }),
              nm1("Beholding thy limbs being broken, and enduring the tearing of thy nails, O (name), thou wast brought as a sacrifice unto God chanting: “O God of our fathers, blessed art Thou.”", "p10 Ode 7 troparion 2", { label: "plain" }),
              nm1("O Divinely-wise (name), thou didst appear like a vine, for thy hands and feet were cut off like branches, pouring forth the noetic wine, consoling our hearts and repelling the sleep of the passions.", "p10 Ode 7 troparion 3", { label: "plain" }),
              nm1("Putting on the whole of man, except sin, the Undefiled one came forth from thy womb in the flesh, O pure one; beseech Him to save those who with faith honor thee.", "p10 Ode 7 Theotokion", { sourceLabel: "Theotokion", label: "theotokion", label_inline: true }),
            ],
          },
          8: {
            irmos: nm2("In his wrath the Chaldean Tyrant made the furnace blaze, * with heat fanned sevenfold for the servants of God; * but when he perceived that they had been saved by a greater power * he cried aloud to the Creator and Redeemer; * “ye children bless, ye priests praise, * ye people, supremely exalt Him throughout all ages.”", "p10-p11 Ode 8 irmos", { sourceLabel: "Irmos", label_inline: true }),
            items: [
              nm1("Boldly revealing thy courage, O all-praised Martyr, thou didst oppose the falsehoods of the Tyrant; enduring the cutting asunder of thy hands and feet, and the removal of thy breasts and teeth, joyfully chanting unto God: “O ye Youths bless, O ye priests praise, O ye people, supremely exalt Him throughout all ages.”", "p10-p11 Ode 8 troparion 1", { label: "plain" }),
              nm1("The purity of thy virginity doth shine forth like a radiant sun bearing the signs of a martyr, illumining the world with the resplendent radiance of thine endurance, O maiden martyr, wherefore thou didst cry unto God: “O ye Youths bless, O ye priests praise, O ye people, supremely exalt Him throughout all ages.”", "p10-p11 Ode 8 troparion 2", { label: "plain" }),
              nm1("O Bride of God, by thy supplications cleanse thou my soul from all evils, for it hath been defiled by passions and darkened by the assaults of the alien one, and by thy bright illumination, O martyr (name), grant me understanding that I may cry out to God: “O ye Youths bless, O ye priests praise, O ye people, supremely exalt Him throughout all ages.”", "p10-p11 Ode 8 troparion 3", { label: "plain" }),
              nm1("The virgin martyr in her love for thee, the pure and all-immaculate one, hath preserved both her body and soul undefiled; for by enduring the pangs of many temptations she hath reduced the fire of the passions to ashes and now, together with thee, rejoiceth in the heavenly palaces, throughout the ages.", "p10-p11 Ode 8 Theotokion", { sourceLabel: "Theotokion", label: "theotokion", label_inline: true }),
            ],
          },
          9: {
            irmos: nm2("Heaven was stricken with awe, * and the ends of the earth were filled with amazement, * for God hath appeared in the flesh, * and thy womb was rendered more spacious than the heavens. * Wherefore, the ranks of men and of angels * magnify thee as the Theotokos.", "p11 Ode 9 irmos", { sourceLabel: "Irmos", label_inline: true }),
            items: [
              nm1("Hung upon a tree, thou didst represent the blessed passion of the Word of God, for enduring the cutting asunder of thy hands and feet, the extraction of thy teeth, the removal of thy tongue and breasts, O pure (name), thou wast revealed to be the glory of ascetics and the adornment of martyrs.", "p11 Ode 9 troparion 1", { label: "plain" }),
              nm1("Arrayed as a bride by thy blessed sufferings thou didst betroth thyself to the Lord, O chosen one, and carrying the lamp of thy virginity thou didst make thine abode within the bright inner chambers, where thou dost now reign in splendor, O (name), with those who live there throughout the ages.", "p11 Ode 9 troparion 2", { label: "plain" }),
              nm1("Thy pangs pour forth a sweetness which doth expel the bitterness of sin; and thy shrine poureth forth rivers of healing, drowning the passions and cruel afflictions of those who worthily glorify thee, to the glory of the Savior, O honored (name).", "p11 Ode 9 troparion 3", { label: "plain" }),
              nm1("Thou O Lord didst assume flesh from a woman, and thy maiden martyr knowing this, adorned herself with the beauty of virginity, and embellished herself with the blood of martyrdom, O God, wherefore she was ushered into heaven in the mystical entourage of Thy Mother.", "p11 Ode 9 Theotokion", { sourceLabel: "Theotokion", label: "theotokion", label_inline: true }),
            ],
          },
        },
      }],
      sessional_ode3_rubric: nm1("The Sessional Hymn, in Tone I:", 'p8 post-Ode-III sessional rubric'),
      sessional_ode3: nm2("By asceticism thou wast brought unto the Lamb and Shepherd, * O rational maiden ewe-lamb, * and finishing thine earthly course in martyrdom * thou didst preserve the faith in purity; * wherefore today we joyfully celebrate thy sacred memory, ** O right wondrous (name), glorifying Christ.", "p8 post-Ode-III Sessional", { tone: 1 }),
      sessional_ode3_closer: nm2("Do thou accept, O Theotokos, * the entreaties of thy servants, * and deliver us from every difficulty, * since thou hast given birth unto the Savior Christ, ** the Redeemer of our souls.", "p8 post-Ode-III Theotokion", { sourceLabel: "Glory ..., Both now ..., Theotokion, in Tone I", tone: 1, type: "theotokion" }),
      sessional_ode3_stavrotheotokion: nm2("Possessing thine intercession, O most pure one, * and delivered from evils by thy supplications, * protected wholly by the Cross of thy Son, ** we all reverently magnify thee as is meet.", "p8 post-Ode-III Stavrotheotokion", { sourceLabel: "Stavrotheotokion", type: "stavrotheotokion", label: "stavrotheotokion", label_inline: true }),
      // NO Typicon-fallback rubric before the kontakion either — the label
      // stands alone, as at the Vespers troparion.
      kontakion_rubric: { absent: true, reason: "not_printed_in_source", basis: "close_reading", note: "The page goes straight to “Kontakion of the venerable nun-martyr, in Tone IV:” — no “from the Typicon” conditional printed." },
      exapostilarion_rubric: nm1("Exapostilarion in Tone III:", 'p11 exapostilarion rubric'),
      // No Spec. Mel., no (Twice).
      exapostilarion: nm2("Like a river thou dost pour forth healing * unto those who in faith have recourse * unto thy honored shrine, O god-seeing (name), * thou vessel of virginity, and flower of great beauty, * as a daughter of the King, thou dost intimately take delight ** in the blessedness of the divine glory.", "p11 Exapostilarion", { tone: 3 }),
      // “heal the bitter and of longstanding scars” — a word-order garble on
      // the page (sic register).
      exapostilarion_closer: nm2("Do thou, O Virgin, * who hast given birth to the Hypostatic Wisdom, * the pre-eternal Word * and the Physician of all, * heal the bitter and of longstanding scars and sores of my soul, ** and pacify the passionate thoughts of my heart.", "p11 Exapostilarion Theotokion", { sourceLabel: "Glory ..., Both now ..., Theotokion in Tone III", tone: 3, type: "theotokion" }),
      praises_rubric: nm1("On the Praises, these Stichera, in Tone VIII:", 'p12 Praises rubric'),
      praises: [
        nm2("Forsaking the beauty of the world, * O all-praised (name), * thou hast been rendered resplendent with heavenly beauty * in the nobility of thy soul, * preserving undefiled in the purity of thy life * the grace of the original image, * O invincible maiden martyr, * god-like reflection of virginity ** and blossom exceedingly glorious in nobility.", "p12 Praises 1", { spec_mel: "O most glorious wonder ...", label: "plain", tone: 8, repeat: 2 }),
        nm2("Adorning thyself in word and deed, * with grace and endurance of soul, * thou didst bring a host of maiden martyrs and virgins * unto Him Who shone forth from the Virgin, * and Who hath revealed to all * the way of martyrdom. * O most wise (name), * implore Him together with them, ** to save thy flock.", "p12 Praises 2", { spec_mel: "O most glorious wonder ...", label: "plain" }),
        nm2("He Who hath ordained all righteousness, * hath adorned thee with double-crowns, * O pure virgin * and glorious martyr, * granting thee to abide * in a most resplendent palace; * dwelling now therein, * O bride of Christ, ** thou hast been enriched with eternal blessedness.", "p12 Praises 3", { spec_mel: "O most glorious wonder ...", label: "plain" }),
      ],
      praises_glory: nm2("While thy body was being stripped naked, * the splendid beauty of thy soul was revealed to be the fairest, * O holy, wise and spiritually rich martyr, * adornment of maiden ascetics, * and maiden martyrs, * ever-flowing source of miracles, * vanquisher of unclean spirits ** and intercessor for those who honor thy memory.", "p12 Praises Glory", { sourceLabel: "Glory ..., in Tone IV", tone: 4, label: "glory" }),
      praises_closer: nm2("Thee have we obtained as a rampart, * O most pure Theotokos, * a favorably calm harbor and confirmation. * Wherefore, I who am tempest-tossed in this life beseech thee: ** do thou guide me and save me!", "p12 Praises Both now", { sourceLabel: "Both now ..., Theotokion in Tone IV", tone: 4, type: "theotokion", label: ["both_now", "theotokion"] }),
      // “Lament not for Me, O Mother” — byte-identical with Nuns' APOSTICHA
      // stavrotheotokion: second site, second slot.
      praises_stavrotheotokion: nm2("“Lament not for Me, O Mother, * beholding Me thy Son and God hanging upon the Tree, * Who hath suspended the earth upon the waters unsupported, * and hath fashioned all creation; * for I shall arise and be glorified, * and shall crush the kingdoms of Hades with strength; * destroying its power * and delivering those in bondage * from its wickedness, * for I am compassionate; * and I shall bring them to My Father, ** in that I am the Lover of mankind.”", "p12 Stavrotheotokion", { sourceLabel: "Stavrotheotokion", type: "stavrotheotokion", label: "stavrotheotokion", label_inline: true }),
      great_doxology_rubric: nm1("The great Doxology: If a small Doxology is read, and a Doxasticon is appointed, the following is chanted after the Aposticha:", 'p12 great Doxology rubric'),
      // Third site of the three-site Glory.
      doxology_glory: nm2("Standing on the right hand of the Savior, * O maiden martyr (name), * adorned with a vesture of virtues, * the oil of purity and the blood of martyrdom, * thou dost joyfully raise thy lamp unto Him and cry aloud: * “I was seeking, O Christ God, the sweet smell of Thy myrrh, * since I am smitten with love for Thee, * cast me not away, * O my heavenly Bridegroom.” * By her intercessions send down upon us Thy mercies, ** O all-powerful Savior.", "p12-p13 Doxology Glory", { sourceLabel: "Glory ..., in Tone VI", tone: 6, label: "glory" }),
      doxology_closer_rubric: nm1("Both now ..., Theotokion or Stavrotheotokion:", 'p13 Doxology closer rubric'),
      troparion_rubric: nm1("After Our Father ..., the Troparion of the venerable nun-martyr, in Tone IV:", 'p13 after Our Father rubric'),
      closer: { absent: true, reason: "not_printed_in_source", basis: "close_reading", note: "Slot printed as “Glory ..., Both now ..., Theotokion or Stavrotheotokion:” with no text (§5.8)." },
      closing_rubric: nm1("The Dismissal:", 'p13 Dismissal'),
    },

    liturgy: {
      order: ['beatitudes_rubric', 'beatitudes', 'propers_rubric', 'troparion',
              'kontakion', 'prokeimenon_rubric', 'prokeimenon', 'prokeimenon_verse',
              'epistle', 'alleluia', 'alleluia_verse', 'gospel', 'communion_verse'],
      beatitudes_rubric: nm1("Typika and Beatitudes.", 'p14 Typika and Beatitudes'),
      // No (Twice) on Beatitude 1 — the marker the last three files carried
      // is absent here.
      beatitudes: [
        nm1("Standing before the judgment seat of thy tormentor, O glorious (name), thou didst preach Christ the Word of God, as the Master and Fashioner of all.", "p14 Beatitude 1", { label: "plain" }),
        nm1("Thine eyes reflecting the goodness of thy heart, rendered thee, O glorious (name), the fairest of maidens.", "p14 Beatitude 2", { label: "plain" }),
        nm1("An inexhaustible treasury of healings was granted unto thee by Christ, O maiden, Whose poverty thou didst voluntarily love.", "p14 Beatitude 3", { label: "plain" }),
        nm1("The ruin of thy body with wounds showed thine adamantine resolve before Christ our God, O maiden martyr (name).", "p14 Beatitude 4", { label: "plain" }),
        nm1("Suspended and enduring wounds, thou, O right praiseworthy martyr (name), preserved unharmed the nobility of thy soul.", "p14 Beatitude 5", { label: "plain" }),
        nm1("O venerable mother, whilst enduring the rending of thy breasts, thou didst feed the faithful with the milk of thy divine compassion, O glorious one.", "p14 Beatitude 6", { label: "plain" }),
        nm1("Having given birth to God, the Lover of mankind, O god-loving Lady, entreat Him that we be delivered from the fire of Gehenna.", "p14 Beatitude 7", { sourceLabel: "Theotokion", label: "theotokion", label_inline: true }),
      ],
      propers_rubric: nm1("The Troparion and Kontakion from the Typicon; but if there be none, chant the following:", 'p14 Liturgy propers rubric'),
      // The double prokeimenon label at the LITURGY — first file to print it
      // in both services.
      prokeimenon_rubric: nm1("Prokeimenon, in Tone IV:", 'p14 Liturgy prokeimenon rubric'),
      prokeimenon: nm2("Wondrous is God in His saints, * the God of Israel.", "p14 Liturgy Prokeimenon", { sourceLabel: "The Prokeimenon", tone: 4, label_inline: true }),
      prokeimenon_verse: nm1("In the Congregations bless ye God, the Lord, from the wellsprings of Israel.", "p14 Liturgy Prokeimenon verse", { sourceLabel: "Verse", label: "refrain" }),
      // Nun's Galatians pericope — with the citation restyled ("(3:23-29)"
      // for Nun's "(GAL. 3:23-29)") and the body keeping KJV's "But" after
      // the Brethren incipit.
      epistle: { heading: 'THE EPISTLE TO THE GALATIANS',
        src: { file: NM, locus: 'p15 Epistle' },
        citation_verbatim: '(3:23-29)',
        citation: { book: 'Galatians', chapter: 3, verses: '23-29' },
        citation_basis: 'printed' },
      alleluia: nm2("I waited patiently for the Lord, and He was attentive unto me, * and hearkened unto my supplication.", "p15 Alleluia", { sourceLabel: "Alleluia, in Tone I", tone: 1, label_inline: true }),
      alleluia_verse: nm1("And he brought me out of the pit of misery, out of the mire of clay.", "p15 Alleluia verse", { sourceLabel: "Verse", label: "refrain" }),
      // "ST. MARK: (5:24-34)" — the colon-in-heading class reaches a FIFTH
      // file and a new position (before the citation).
      gospel: { heading: 'THE GOSPEL ACCORDING TO ST. MARK:',
        src: { file: NM, locus: 'p15 Liturgy Gospel' },
        citation_verbatim: '(5:24-34)',
        citation: { book: 'Mark', chapter: 5, verses: '24-34' },
        citation_basis: 'printed' },
