...
export default [
  ...
  // ── Prophet.pdf ────────────────────────────────────────────────────────────
  { a: 'general.Prophet.matins.canons[0].odes.3.items[0]', b: 'general.Prophet.liturgy.beatitudes[0]', relation: 'identical', note: 'Ode III troparion 1 = Beatitude 1 — no (Twice).' },
  { a: 'general.Prophet.matins.canons[0].odes.3.items[1]', b: 'general.Prophet.liturgy.beatitudes[1]', relation: 'identical', note: 'Ode III troparion 2 = Beatitude 2.' },
  { a: 'general.Prophet.matins.canons[0].odes.3.items[2]', b: 'general.Prophet.liturgy.beatitudes[2]', relation: 'identical', note: 'Ode III troparion 3 = Beatitude 3.' },
  { a: 'general.Prophet.matins.canons[0].odes.6.items[0]', b: 'general.Prophet.liturgy.beatitudes[3]', relation: 'identical', note: 'Ode VI troparion 1 = Beatitude 4.' },
  { a: 'general.Prophet.matins.canons[0].odes.6.items[1]', b: 'general.Prophet.liturgy.beatitudes[4]', relation: 'identical', note: 'Ode VI troparion 2 = Beatitude 5.' },
  { a: 'general.Prophet.matins.canons[0].odes.6.items[2]', b: 'general.Prophet.liturgy.beatitudes[5]', relation: 'identical', note: 'Ode VI troparion 3 = Beatitude 6.' },
  { a: 'general.Prophet.matins.canons[0].odes.6.items[3]', b: 'general.Prophet.liturgy.beatitudes[6]', relation: 'identical', note: 'Ode VI Theotokion = Beatitude 7. NINETEEN files canon→Beatitudes; five variant rows.' },
  { a: 'general.Prophet.vespers.aposticha_glory', b: 'general.Prophet.matins.doxology_glory', relation: 'identical', note: 'The Doxasticon reprints the aposticha Glory — sixteenth file.' },
  { a: 'general.Prophet.vespers.dogmatikon', b: 'general.HieroConfessor.vespers.dogmatikon', relation: 'identical',
    note: 'The Tone VI dogmatic — NINTH byte-identical file — printed under a rubric that announces TONE II: the second rubric-tone/printed-tone mismatch (ledger B-4 updated).' },
  { a: 'general.Prophet.vespers.lic_stavrotheotokion', b: 'general.NunMartyr.matins.praises_stavrotheotokion', relation: 'identical',
    note: '"Lament not for Me, O Mother" — THIRD site, third slot (Nuns aposticha, NunMartyr praises, here at the LIC).' },
  { a: 'general.Prophet.vespers.dogmatikon_stavrotheotokion', b: 'general.NunMartyr.vespers.aposticha_stavrotheotokion', relation: 'identical',
    note: 'The "diest?," copy — SIXTH file, fifth byte-identical site.' },
  { a: 'general.Prophet.vespers.aposticha[1]', b: 'general.Prophet.matins.prokeimenon', relation: 'variant',
    note: 'The Melchisedek verse serves as this file\'s own prokeimenon (Matins AND Liturgy, byte-identical there) — but the aposticha site prints "for ever, * after" with a comma the prokeimenon drops.' },
  { a: 'general.Prophet.vespers.aposticha[3]', b: 'general.Prophet.liturgy.alleluia', relation: 'variant',
    note: 'The Moses-and-Aaron verse as the Alleluia — pointed and STOPLESS at the aposticha ("call upon His name" with no period, sic), unpointed WITH the period at the Alleluia.' },
  { a: 'general.Prophet.matins.megalynarion_verse', b: 'general.Fools.matins.megalynarion_verse', relation: 'identical',
    note: 'The monastic Alleluia text as megalynarion verse — SECOND file (the Fools pattern holds).' },
  { a: 'general.Prophet.matins.sessional_1', b: 'general.HieroConfessor.matins.sessional_polyeleos', relation: 'variant',
    note: 'The Enlightened-by-the-Divine-Spirit hymn re-rendered for the prophet (HieroConfessor\'s Polyeleos sessional speaks of banishment; this of prophecy) — same incipit family.' },
  { a: 'general.Prophet.vespers.lic_glory', b: 'general.Prophet.matins.sessional_post50', relation: 'variant',
    note: 'The idiomelon REPRINTED as the post-50 sessional with its final line REPOINTED ("** pray thou" → "* pray thou") — the pointing travels loosely at an in-file reprint, again.' },
  { a: 'general.Prophet.matins.sessional_polyeleos', b: 'general.Prophet.matins.sessional_ode3', relation: 'variant',
    note: 'THE POLYELEOS SESSIONAL REPRINTED REWRITTEN as the post-Ode-III sessional — three substitutions: "reflection of the Divinity"→"of the divine"; "illumination by the divine Spirit"→"by the Divine spirit" (the case pair swaps); "unto the source"→"unto the wellspring". The rewritten-reprint pattern reaches the sessionals.' },
  { a: 'general.Prophet.matins.canons[0].odes.1.irmos', b: 'general.MonasticMartyr.matins.canons[0].odes.1.irmos', relation: 'identical',
    note: 'THE TONE VI CANON FAMILY REACHES FOUR FILES — odes I-VIII byte-identical with Heirarch, HieroConfessor and MonasticMartyr (generator-verified); Ode IX alone diverges (next row).' },
  { a: 'general.Prophet.matins.canons[0].odes.9.irmos', b: 'general.Heirarch.matins.canons[0].odes.9.irmos', relation: 'variant',
    note: 'The Ode IX irmos in a SECOND RENDERING — "did the Word Incarnate APPEAR TO MANKIND … with Heavenly Hosts" against the three-file "become a man … with the Heavenly Hosts": the Monastics/Hieromartyr one-canon-two-translations pattern at a single ode.' },
  { a: 'general.Prophet.matins.exapostilarion_closer', b: 'general.Heiromartyrs.matins.exapostilarion_closer', relation: 'identical',
    note: '"With the sprinkling of thy tender compassion" — second site.' },
  { a: 'general.Prophet.matins.praises_closer', b: 'general.Fools.vespers.aposticha_alternate', relation: 'identical',
    note: '"Deliver us from our needs" — THIRD file, fourth site.' },
  { a: 'general.Prophet.matins.praises_stavrotheotokion', b: 'general.Nun.matins.sessional_ode3_stavrotheotokion', relation: 'identical',
    note: 'The sword-of-Simeon stavrotheotokion — THIRD site (Unmercenaries, Nun); and this file also prints the FIRST-PERSON sword hymn ("A sword hath pierced me") at its aposticha: two Simeon hymns in one file.' },
  { a: 'general.Prophet.matins.prokeimenon', b: 'general.Prophet.liturgy.prokeimenon', relation: 'identical',
    note: 'Matins and Liturgy print the SAME prokeimenon and verse — under the double label at both services (the NunMartyr pattern).' },
  { a: 'general.Prophet.liturgy.communion_verse', b: 'general.Martyr.liturgy.communion_verse', relation: 'variant',
    note: 'A FOURTH byte-form of the In-everlasting verse: semicolon WITH lowercase he — the semicolon family\'s punctuation carrying the comma family\'s pronoun.' },

  // ── St John Baptist.pdf ────────────────────────────────────────────────────
  { a: 'general.StJohnBaptist.matins.canons[0].odes.3.items[0]', b: 'general.StJohnBaptist.liturgy.beatitudes[0]', relation: 'variant',
    note: 'REWRITE: "O most blessed one" for the canon\'s "O blessed one" — the first of THREE rewritten Beatitudes in this file, the most anywhere.' },
  { a: 'general.StJohnBaptist.matins.canons[0].odes.3.items[1]', b: 'general.StJohnBaptist.liturgy.beatitudes[1]', relation: 'identical', note: 'Ode III troparion 2 = Beatitude 2.' },
  { a: 'general.StJohnBaptist.matins.canons[0].odes.3.items[2]', b: 'general.StJohnBaptist.liturgy.beatitudes[2]', relation: 'identical', note: 'Ode III troparion 3 = Beatitude 3.' },
  { a: 'general.StJohnBaptist.matins.canons[0].odes.6.items[0]', b: 'general.StJohnBaptist.liturgy.beatitudes[3]', relation: 'identical', note: 'Ode VI troparion 1 = Beatitude 4.' },
  { a: 'general.StJohnBaptist.matins.canons[0].odes.6.items[1]', b: 'general.StJohnBaptist.liturgy.beatitudes[4]', relation: 'identical', note: 'Ode VI troparion 2 = Beatitude 5.' },
  { a: 'general.StJohnBaptist.matins.canons[0].odes.6.items[2]', b: 'general.StJohnBaptist.liturgy.beatitudes[5]', relation: 'variant',
    note: 'REWRITE: "O most blessed one … the Word that came down" for the canon\'s "O all-blessed one … the Word Who came down".' },
  { a: 'general.StJohnBaptist.matins.canons[0].odes.6.items[3]', b: 'general.StJohnBaptist.liturgy.beatitudes[6]', relation: 'variant',
    note: 'THE FIRST REWRITTEN BEATITUDE THEOTOKION: "O Sovereign-Lady as is meet" (hyphenated, comma dropped) for the canon\'s "O Lady, as is meet". Twenty files canon→Beatitudes; EIGHT variant rows, three in this file alone.' },
  { a: 'general.StJohnBaptist.troparion', b: 'general.StJohnBaptist.vespers.troparion_general', relation: 'variant',
    note: 'The FIFTH pointing/punctuation refusal: the Vespers site of the General Troparion ends "the great mercy.." — a DOUBLE full stop — against the byte-identical Matins/Liturgy pair (canonical).' },
  { a: 'general.StJohnBaptist.troparion', b: 'general.StJohnBaptist.vespers.troparion_synaxis', relation: 'variant',
    note: 'The Synaxis troparion is the General REPRINTED WITH FOUR VARIANTS ("praise," gains a comma, "Forerunner" loses one, "Him whom" lowercases, "world and grants" drops a pointing) — the rewritten-reprint pattern on the file\'s own principal troparion.' },
  { a: 'general.StJohnBaptist.vespers.troparion_general_closer', b: 'general.StJohnBaptist.vespers.troparion_synaxis_closer', relation: 'variant',
    note: 'The Synaxis theotokion prints as the corpus\'s FIRST INCIPIT REFERENCE ("All of thy most glorious mysteries are beyond comprehension ...,") — incipit_ref resolves to the full General theotokion (gate prefix-checked).' },
  { a: 'general.StJohnBaptist.vespers.troparion_conception', b: 'general.StJohnBaptist.liturgy.troparion_conception', relation: 'identical',
    note: 'The Conception troparion at Vespers and Liturgy — byte-identical; likewise Birth, 1st-2nd Finding and 3rd Finding (single rows stand for the four pairs).' },
  { a: 'general.StJohnBaptist.matins.kontakion_beheading', b: 'general.StJohnBaptist.liturgy.kontakion_beheading', relation: 'identical',
    note: 'ALL SIX FEAST KONTAKIA are byte-identical between Matins and Liturgy — only their LABELS differ (the Liturgy adds "The Kontakion for …"); one row stands for the set.' },
  { a: 'general.StJohnBaptist.vespers.aposticha_closer', b: 'general.Prophet.vespers.aposticha_closer', relation: 'identical',
    note: '"Behold, the prophecy of Isaiah" — second file, and here UNCONDITIONAL under the new "Theotokion of the Resurrection" label.' },
  { a: 'general.StJohnBaptist.vespers.dogmatikon', b: 'octoechos:tone4.great_vespers.dogmatikon', relation: 'variant',
    note: 'THE TONE IV DOGMATIC ("Prophet David, the ancestor of God") — first in the General Menaion; FIFTH cross-book dogmatic row awaiting the octoechos roots (ledger E-1).' },
  { a: 'general.StJohnBaptist.matins.megalynarion_nativity', b: 'general.StJohnBaptist.matins.megalynarion_beheading', relation: 'variant',
    note: 'FIVE FEAST-KEYED MEGALYNARIA sharing one head ("We magnify thee, John the Forerunner of the Savior") with per-feast tails — plus a "The same as above" REFERENCE standing for the whole Conception entry.' },
  { a: 'general.StJohnBaptist.matins.megalynarion_findings_verse', b: 'general.StJohnBaptist.matins.megalynarion_synaxis_verse', relation: 'identical',
    note: 'The Findings and Synaxis megalynaria share one verse — printed twice, colon-terminated both times.' },
  { a: 'general.StJohnBaptist.matins.megalynarion_nativity_verse', b: 'general.StJohnBaptist.matins.prokeimenon_verse', relation: 'identical',
    note: 'The Nativity megalynarion verse doubles as the Matins prokeimenon verse.' },
  { a: 'general.StJohnBaptist.vespers.aposticha[3]', b: 'general.StJohnBaptist.matins.prokeimenon', relation: 'variant',
    note: 'The Benedictus verse as the Matins prokeimenon MINUS its "a" ("called Prophet" for "called a Prophet").' },
  { a: 'general.StJohnBaptist.matins.canons[0].odes.7.irmos', b: 'general.Fools.matins.canons[0].odes.7.irmos', relation: 'identical',
    note: 'The Persian-furnace Ode VII irmos — FIFTH file, crossing into a canon whose other irmoi are proper to the Baptist.' },
  { a: 'general.StJohnBaptist.matins.canons[0].odes.3.irmos', b: 'general.Martyresses.matins.canons[0].odes.3.irmos', relation: 'identical',
    note: '"The bow of the mighty" — second file; ode IX ("Eve dwelt under the curse") likewise = Martyresses.' },
  { a: 'general.StJohnBaptist.matins.exapostilarion_closer', b: 'general.Prophet.matins.sessional_2_closer', relation: 'identical',
    note: '"The prophets preached, the apostles taught" — third site, third slot (Prophet sessional-2, Prophet exapostilarion closer via Heiromartyrs? — no: second FILE, and the slot wanders again).' },
  { a: 'general.StJohnBaptist.matins.praises_closer', b: 'general.Fools.matins.praises_closer', relation: 'variant',
    note: 'The O-Sovereign-lady family REWRITTEN at its fifth file: capital "Lady", capital "Accept" mid-clause, and the pointing moved ("* and deliver us ** from all want").' },
  { a: 'general.StJohnBaptist.liturgy.prokeimenon', b: 'general.Prophet.liturgy.prokeimenon', relation: 'variant',
    note: 'One psalm, two renderings, two tones: "a priest FOREVER … MELCHISEDECH" in Tone I against Prophet\'s "for ever … Melchisedek" in Tone IV — and the verses differ in case throughout.' },
  { a: 'general.StJohnBaptist.liturgy.alleluia', b: 'general.Prophet.liturgy.alleluia', relation: 'identical',
    note: 'The Moses-and-Aaron Alleluia — second file, here under a TONELESS label ("Alleluia:" — alone in the corpus).' },
  { a: 'general.StJohnBaptist.liturgy.communion_verse', b: 'general.Nuns.liturgy.communion_verse', relation: 'identical',
    note: 'The semicolon/capital-He In-everlasting form — fourth file of that form.' },

  // ── Cross.pdf ──────────────────────────────────────────────────────────────
  { a: 'general.Cross.matins.canons[0].odes.3.items[0]', b: 'general.Cross.liturgy.beatitudes[0]', relation: 'variant',
    note: 'ALL THREE ODE-III BEATITUDES ARE REWRITTEN: "O most venerated cross" for the canon\'s "O all-venerable cross".' },
  { a: 'general.Cross.matins.canons[0].odes.3.items[1]', b: 'general.Cross.liturgy.beatitudes[1]', relation: 'variant',
    note: '"O most sacred cross … ornament of Churches … their humiliation" for "Thou O Cross … adornment of the Churches … and their humiliation".' },
  { a: 'general.Cross.matins.canons[0].odes.3.items[2]', b: 'general.Cross.liturgy.beatitudes[2]', relation: 'variant',
    note: '"shield and wall" for "shield and rampart". Corpus rewrites: ELEVEN variant rows across six files — and this Beatitude set has NO THEOTOKION ROW, because Ode VI prints none.' },
  { a: 'general.Cross.matins.canons[0].odes.6.items[0]', b: 'general.Cross.liturgy.beatitudes[3]', relation: 'identical', note: 'Ode VI troparion 1 = Beatitude 4 — the Ode VI four copy byte-true.' },
  { a: 'general.Cross.matins.canons[0].odes.6.items[3]', b: 'general.Cross.liturgy.beatitudes[6]', relation: 'identical', note: 'Ode VI troparion 4 = Beatitude 7 (rows 5-6 likewise; single rows stand for the set). Twenty-one files canon→Beatitudes.' },
  { a: 'general.Cross.kontakion', b: 'general.Cross.liturgy.kontakion', relation: 'variant',
    note: 'THE SIXTH POINTING REFUSAL: p9 "ally, * Thy weapon", Liturgy "ally, ** Thy weapon". And its Spec. Mel. is ITSELF — the first self-referential melody label.' },
  { a: 'general.Cross.vespers.aposticha[1]', b: 'general.Cross.liturgy.prokeimenon', relation: 'identical',
    note: 'The Exalt-ye verse as aposticha verse AND Liturgy prokeimenon — under TONE VII: the third file printing Grave-Tone appointments, and for the Cross certainly genuine (ledger B-5 strengthened to near-certainty).' },
  { a: 'general.Cross.vespers.aposticha[3]', b: 'general.Cross.liturgy.alleluia_verse', relation: 'variant',
    note: 'The King-before-the-ages verse re-punctuated at the Alleluia ("ages; He hath" for "ages, * He hath") — the in-file recirculation pattern.' },
  { a: 'general.Cross.matins.sessional_1_closer_rubric', b: 'general.Cross.matins.sessional_ode3_closer_rubric', relation: 'identical',
    note: 'THE FOREGOING-IS-REPEATED DEVICE — four sites (three byte-identical with full stops; the God-is-the-Lord site ends with a colon), standing where sessional theotokia would print.' },
  { a: 'general.Cross.matins.canons[0].odes.1.irmos', b: 'general.Martyresses.matins.canons[0].odes.1.irmos', relation: 'identical',
    note: 'The I-shall-open-my-mouth festal canon shares irmoi with Martyresses at odes I, IV and VIII; the rest are proper. First canon with a COMPOSER (Gregory the Sinaite) and the first KATAVASIAS (the Exaltation set).' },
  { a: 'general.Cross.matins.canons[0].odes.4.katavasia', b: 'general.Monastic.matins.canons[0].odes.4.irmos', relation: 'variant',
    note: 'The Ode IV katavasia is the SAME heirmos Monastic prints as its Ode IV irmos, in another rendering — one heirmos, two roles, two renderings.' },
  { a: 'general.Cross.matins.sessional_polyeleos', b: 'general.Cross.matins.sessional_ode3', relation: 'variant',
    note: 'ONE MELODY, TWO LABEL RENDERINGS IN ONE FILE: "That which was secretly ordained" (Polyeleos sessional) against "That which was mystically commanded" (post-Ode-III) — different hymns under the same melody, each naming it differently.' },
  { a: 'general.Cross.vespers.lic_rubric', b: 'general.Prophet.vespers.lic_rubric', relation: 'variant',
    note: 'TONE VII stichera — the first Tone VII hymnody — under "Called from on high": the melody Prophet labels "Called from above".' },

  // ── Holy Fathers.pdf ───────────────────────────────────────────────────────
  { a: 'general.HolyFathers.matins.canons[0].odes.3.items[0]', b: 'general.HolyFathers.liturgy.beatitudes[0]', relation: 'identical', note: 'Ode III troparion 1 = Beatitude 1 — the first SINGLE-ODE Beatitude set (Ode III + its Theotokion; the Octoechos supplies the other six rows per the share-count rubric).' },
  { a: 'general.HolyFathers.matins.canons[0].odes.3.items[3]', b: 'general.HolyFathers.liturgy.beatitudes[3]', relation: 'identical', note: 'Ode III Theotokion = Beatitude 4 (rows 2-3 likewise; single rows for the set). TWENTY-TWO files canon→Beatitudes.' },
  { a: 'general.HolyFathers.troparion', b: 'general.HolyFathers.liturgy.troparion_liturgy', relation: 'variant',
    note: 'THE SEVENTH WORDING/POINTING REFUSAL: the Liturgy site inserts "since" ("since Thou hast established") against the byte-identical loaves/Glory pair — and the loaves site carries the corpus\'s first "(Once)" (repeat: 1; gate extended).' },
  { a: 'general.HolyFathers.vespers.lic[3]', b: 'general.HolyFathers.vespers.lic[1]', relation: 'variant',
    note: 'THE VERSED LIC WITH INCIPIT REPEATS: "6 Stichera" = four texts + two incipit references ("Before the morning star ...," / "O My Savior, Who hath rent Thy raiment ...,"), interleaved with the printed psalm verses — the Baptist incipit device at the LIC.' },
  { a: 'general.HolyFathers.matins.praises[3]', b: 'general.HolyFathers.matins.praises[1]', relation: 'variant',
    note: 'The versed Praises repeat the pattern — "4 Stichera" = three texts + one incipit; and verse 2 embeds "Let every breath praise the Lord".' },
  { a: 'general.HolyFathers.matins.praises[4]', b: 'general.HolyFathers.liturgy.prokeimenon', relation: 'identical',
    note: 'Praises verse 3 = the Liturgy prokeimenon ("Blessed art Thou, O Lord, the God of our Fathers") — which prints WITH NO VERSE, the first verse-less prokeimenon.' },
  { a: 'general.HolyFathers.matins.both_now_closer', b: 'general.Nuns.matins.sessional_polyeleos_closer', relation: 'identical',
    note: '"O Good One, Who for our sake wast born" — FOURTH site (Unmercenaries ×2, Nuns), fourth slot arrangement: the corpus\'s most slot-promiscuous theotokion.' },
  { a: 'general.HolyFathers.matins.canons[0].odes.1.irmos', b: 'general.Prophet.matins.canons[0].odes.1.irmos', relation: 'identical',
    note: 'THE TONE VI CANON FAMILY CLOSES AT FIVE FILES — odes I-VIII byte-identical with Heirarch, HieroConfessor, MonasticMartyr and Prophet; ode IX joins the become-a-man quartet (Prophet\'s appear-to-mankind variant stands alone). The canon itself is the corpus\'s SECOND with a composer: Patriarch Germanus.' },
  { a: 'general.HolyFathers.matins.sessional_ode3_closer', b: 'general.Monastic.matins.sessional_1_closer', relation: 'variant',
    note: 'The divine-birthgiving Theotokion in a THIRD rendering (Monastic and Fools hold the others) — the translation-family pattern\'s final appearance.' },
  { a: 'general.HolyFathers.vespers.aposticha_closer', b: 'general.Fools.vespers.aposticha_closer', relation: 'identical',
    note: '"Mercifully regard" — SEVENTH file, closing that family\'s census.' },
  { a: 'general.HolyFathers.liturgy.alleluia_verse', b: 'general.HolyFathers.matins.praises[6]', relation: 'variant',
    note: 'One Gather-verse, two renderings in one file: the Praises print "Gather unto Him His righteous.", the Alleluia "Gather together unto Him His holy ones who have established His covenant upon sacrifices."' },
  { a: 'general.HolyFathers.liturgy.communion_verse', b: 'general.MonasticMartyr.liturgy.communion_verse', relation: 'identical',
    note: 'The semicolon righteous form — sixth file — labeled "for the saint", SINGULAR, in the Fathers\' own file; and the first file with TWO communion verses (the Resurrection\'s printed beside it).' },

  // ── Theotokos.pdf — THE LAST FILE ──────────────────────────────────────────
  { a: 'general.Theotokos.matins.canons[0].odes.3.items[0]', b: 'general.Theotokos.liturgy.beatitudes[0]', relation: 'identical', note: 'Ode III troparion 1 = Beatitude 1 — the first EIGHT-ROW Beatitude set: both odes contribute their FOUR troparia (the canon has no theotokia), no (Twice), no theotokion row.' },
  { a: 'general.Theotokos.matins.canons[0].odes.6.items[3]', b: 'general.Theotokos.liturgy.beatitudes[7]', relation: 'identical', note: 'Ode VI troparion 4 = Beatitude 8 (all eight byte-identical, the "thy feast. and" defect travelling intact; single rows for the set). FINAL TALLY: twenty-three files canon→Beatitudes, eleven variant rows.' },
  { a: 'general.Theotokos.troparion', b: 'general.Apostle.vespers.lic_closer', relation: 'identical',
    note: 'THE CLOSING FIND: the paraklesis troparion ("To the Theotokos we the sinful and lowly ones") already lived in the corpus AS THEOTOKIA — Apostle\'s LIC closer and MonasticMartyrs\' post-Ode-III closer, byte-for-byte. One text, three roles, three files.' },
  { a: 'general.Theotokos.vespers.troparion_closer', b: 'general.Theotokos.matins.troparion_closer', relation: 'identical',
    note: '"We shall never cease" printed IN FULL at both its sites — no incipit device where the Baptist would have used one.' },
  { a: 'general.Theotokos.matins.canons[0].odes.1.katavasia', b: 'general.Cross.matins.canons[0].odes.1.irmos', relation: 'identical',
    note: 'THE KATAVASIAS ARE THE CROSS\'S CANON IRMOI — all nine byte-identical (single row for the set): the festal I-shall-open-my-mouth canon serves as IRMOI in Cross (and partially in Martyresses) and as KATAVASIAS here. One canon, two roles, three files.' },
  { a: 'general.Theotokos.matins.canons[0].odes.1.irmos', b: 'general.Monastic.matins.canons[0].odes.1.irmos', relation: 'identical',
    note: 'The Tone VIII canon draws its irmoi from across the corpus — ode I = Monastic, III/IX = the Nun family, IV = the six-file family: the paraklesis canon as anthology.' },
  { a: 'general.Theotokos.matins.psalm50_sticheron', b: 'general.Theotokos.matins.psalm50_closer', relation: 'identical',
    note: 'In HER file the Psalm-50 Glory and Both-now COLLAPSE INTO ONE TEXT — "Through the prayers of the Theotokos" twice, byte-identical, joining the 23-file family: the only file where the pair is one sticheron.' },
  { a: 'general.Theotokos.matins.megalynarion_protection_verse', b: 'general.Theotokos.matins.megalynarion_general_verse', relation: 'variant',
    note: 'One Remember-David verse serves four megalynaria — printed WITHOUT its final stop three times and WITH it the fourth.' },
  { a: 'general.Theotokos.matins.praises_glory_both_now', b: 'general.Unmercenaries.vespers.dogmatikon_alternate', relation: 'identical',
    note: 'The chairetismos Glory-Both-now ("Rejoice, thou praise of the universe") = Unmercenaries\' dogmatikon alternate byte-for-byte — the wandering-slot pattern\'s last word: an eleven-Rejoice hymn serving as a small theotokion there and the Praises doxasticon here.' },
  { a: 'general.Theotokos.liturgy.alleluia', b: 'general.Theotokos.vespers.aposticha[3]', relation: 'variant',
    note: 'The file\'s own aposticha verse UNPOINTED as the Alleluia — the recirculation pattern, one last time.' },
];
