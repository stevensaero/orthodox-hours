...
const JUNE_MENAION = {
  ...
  "06-21": {
    ...
    stichera_lord_i_call: [
      { tone: 4, spec_mel: "As one valiant among the martyrs", text: "O blessed Martyr [Jul]ian, | we celebrate thy divine and light-bearing me[mor]ial. | We [know] thee as a [ra]diant sun, | shining on the whole world with the [bril]liance of thy mind, | casting out the night of disbe[lief] in the [true] God! // As we venerate thy relics, we gain [strength] of soul." },
      { tone: 4, spec_mel: "As one valiant among the martyrs", text: "Thou wast lashed with a whip, O [bless]ed one, | kicked frightfully and confined in [pris]on. | While in af[flic]tion, thou didst transcend thy sur[round]ings: | Thou wast encompassed by [wild] beasts; | thou didst enter the deep and wast [drowned] [by] the sea. | Thou didst receive thy holy end without denying the [Mas]ter of all. // Thou art greatly blessed, O glory of the [mar]tyrs." },
      { tone: 4, spec_mel: "As one valiant among the martyrs", text: "Thy most holy and beloved [moth]er | saw thee drift from the waves of the sea to [dry] land | by the di[rec]tion of the [Spir]it. | She faithfully welcomed thee, O Martyr [Jul]ian, | and she committed thy blameless and sorely-tried [bod]y to [bur]ial: // the body victorious through grace over the tyranny of the [dev]il." },
    ],
    stichera_glory: { tone: 6, text: "Having drawn the inexhaustible drink of the pure Faith, O [bless]ed one, | thou didst extinguish the worship of [id]ols, | and didst come triumphantly to the [con]test, | bright with dew like a never-[wan]ing star, | il[lum]ined by Christ, the Sun Who shines for[ev]er. | And having seen every [ci]ty, | thou didst receive the blessed end of a [mar]tyr’s death | by being [cast] into the sea, | and, wearing thy crown, thou camest into the [pre]sence of Christ. | Beseech Him, O most glorious [Jul]ian, // that He save those who celebrate thy [mem]ory with faith!" },
    ...
    aposticha_glory: { tone: 6, text: "Come, O lovers of the [mar]tyrs, | let us reverently venerate the glorious [Jul]ian, | the sufferer for Christ and fellow [cit]izen of Paul, | who appeared as a traveler and finished the [same] course. | For, thrown into the water with sea monsters and [poi]sonous snakes, | he sanctified the earth by his blood, and the sea by his [pass]age. | Having departed from things here to the eternal [dwell]ing, | he received the prize of his struggles from the right hand of the Al[might]y, // and asks for our souls purification and great [mer]cy." },
