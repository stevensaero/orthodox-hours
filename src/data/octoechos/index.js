...
export const RESURRECTIONAL_TROPARIA = {
  1: {
    tone: 1,
...
export const SUNDAY_PROKEIMENON = {
  1: { tone: 1,
...
// ── KATAVASIAE ─────────────────────────────────────────────────────────────────
// Period-based (not tone-based). Assembler selects set via getKatavasiaePeriod().
// Populated in Phase 4 (HTM Horologion source).
